...
- Justin Seitz: Author of Black Hat Python (https://github.com/jaredthecoder/awesome-vehicle-security/blob/master/No Starch Press).
...
- I Am The Cavalry: Global grassroots (https://github.com/jaredthecoder/awesome-vehicle-security/blob/master/eg. volunteer) initiative focused on the intersection of security and human life/public safety issues, such as cars.
...
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) first.me](https://github.com/sindresorhus/awesome)
  - [lists](https://github.com/jnv/lists)

...
15. [SPARTA](https://github.com/ashishb/android-security-awesome/blob/master/https://www.cs.washington.edu/sparta) - verifies (https://github.com/ashishb/android-security-awesome/blob/master/proves) that an app satisfies an information-flow security policy; built on the [Checker Framework](https://github.com/ashishb/android-security-awesome/blob/master/https://types.cs.washington.edu/checker-framework/)
...
3. [Android Malware Analysis Toolkit](https://github.com/ashishb/android-security-awesome/blob/master/http://www.mobilemalware.com.br/amat/download.html) - (https://github.com/ashishb/android-security-awesome/blob/master/linux distro) Earlier it use to be an [online analyzer](https://github.com/ashishb/android-security-awesome/blob/master/http://dunkelheit.com.br/amat/analysis/index_en.php)
4. [Mobile-Security-Framework MobSF](https://github.com/ashishb/android-security-awesome/blob/master/https://github.com/MobSF/Mobile-Security-Framework-MobSF) - Mobile Security Framework is an intelligent, all-in-one open source mobile application (https://github.com/ashishb/android-security-awesome/blob/master/Android/iOS) automated pen-testing framework capable of performing static, dynamic analysis and web API testing.
...
12. [Inspeckage](https://github.com/ashishb/android-security-awesome/blob/master/https://github.com/ac-pm/Inspeckage) - Android Package Inspector - dynamic analysis with api hooks, start unexported activities and more. (https://github.com/ashishb/android-security-awesome/blob/master/Xposed Module)
13. [Android Hooker](https://github.com/ashishb/android-security-awesome/blob/master/https://github.com/AndroidHooker/hooker) - Dynamic Java code instrumentation (https://github.com/ashishb/android-security-awesome/blob/master/requires the Substrate Framework)
...
16. [DECAF](https://github.com/ashishb/android-security-awesome/blob/master/https://github.com/sycurelab/DECAF) - Dynamic Executable Code Analysis Framework based on QEMU (https://github.com/ashishb/android-security-awesome/blob/master/DroidScope is now an extension to DECAF)
17. [CuckooDroid](https://github.com/idanr1986/cuckoo-droid) - Android extension for Cuckoo sandbox
18. [Mem](https://github.com/ashishb/android-security-awesome/blob/master/https://github.com/MobileForensicsResearch/mem) - Memory analysis of Android (https://github.com/ashishb/android-security-awesome/blob/master/root required)
...
22. [Android Reverse Engineering](https://github.com/ashishb/android-security-awesome/blob/master/https://redmine.honeynet.org/projects/are/wiki) – ARE (https://github.com/ashishb/android-security-awesome/blob/master/android reverse engineering) not under active development anymore
...
26. [StaDynA](https://github.com/ashishb/android-security-awesome/blob/master/https://github.com/zyrikby/StaDynA) - a system supporting security app analysis in the presence of dynamic code update features (https://github.com/ashishb/android-security-awesome/blob/master/dynamic class loading and reflection). This tool combines static and dynamic analysis of Android applications in order to reveal the hidden/updated behavior and extend static analysis results with this information.
...
6. [Apktool](https://github.com/ashishb/android-security-awesome/blob/master/https://ibotpeaches.github.io/Apktool/) – really useful for compilation/decompilation (https://github.com/ashishb/android-security-awesome/blob/master/uses smali)
...
9. [Android OpenDebug](https://github.com/ashishb/android-security-awesome/blob/master/https://github.com/iSECPartners/Android-OpenDebug) – make any application on device debuggable (https://github.com/ashishb/android-security-awesome/blob/master/using cydia substrate).
...
1. [Google play crawler (https://github.com/ashishb/android-security-awesome/blob/master/Java)](https://github.com/ashishb/android-security-awesome/blob/master/https://github.com/Akdeniz/google-play-crawler)
2. [Google play crawler (https://github.com/ashishb/android-security-awesome/blob/master/Python)](https://github.com/ashishb/android-security-awesome/blob/master/https://github.com/egirault/googleplay-api)
3. [Google play crawler (https://github.com/ashishb/android-security-awesome/blob/master/Node) ](https://github.com/ashishb/android-security-awesome/blob/master/https://github.com/dweinstein/node-google-play) - get app details and download apps from official Google Play Store.
4. [Aptoide downloader (https://github.com/ashishb/android-security-awesome/blob/master/Node)](https://github.com/ashishb/android-security-awesome/blob/master/https://github.com/dweinstein/node-aptoide) - download apps from Aptoide third-party Android market
5. [Appland downloader (https://github.com/ashishb/android-security-awesome/blob/master/Node)](https://github.com/ashishb/android-security-awesome/blob/master/https://github.com/dweinstein/node-appland) - download apps from Appland third-party Android market
...
8. [Google Android Security Team’s Classifications for Potentially Harmful Applications (https://github.com/ashishb/android-security-awesome/blob/master/Malware)](https://github.com/ashishb/android-security-awesome/blob/master/https://source.android.com/security/reports/Google_Android_Security_PHA_classifications.pdf)

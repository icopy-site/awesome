...
**[Fork and edit](https://github.com/dreikanter/sublime-bookmarks/blob/master/https://github.com/dreikanter/sublime-bookmarks/edit/master/README.md)** (https://github.com/dreikanter/sublime-bookmarks/blob/master/or [propose something](https://github.com/dreikanter/sublime-bookmarks/blob/master/https://github.com/dreikanter/sublime-bookmarks/issues/new) to add).
...
- [Mastering Sublime Text](https://github.com/dreikanter/sublime-bookmarks/blob/master/http://www.packtpub.com/application-development/mastering-sublime-text) by Dan Peleg (https://github.com/dreikanter/sublime-bookmarks/blob/master/PACKT).

## News and Tips

- [Sublime Blog](http://www.sublimetext.com/blog/) — official news.
- [Sublime Text Tips](https://github.com/dreikanter/sublime-bookmarks/blob/master/http://sublimetexttips.com) — tips and tricks for mastering Sublime Text (https://github.com/dreikanter/sublime-bookmarks/blob/master/[twitter](https://github.com/dreikanter/sublime-bookmarks/blob/master/https://twitter.com/SublimeTxtTips)).
...
- [The Complete Visual Guide to Sublime Text 3](https://github.com/dreikanter/sublime-bookmarks/blob/master/https://scotch.io/bar-talk/the-complete-visual-guide-to-sublime-text-3-getting-started-and-keyboard-shortcuts): Getting Started and Keyboard Shortcuts (https://github.com/dreikanter/sublime-bookmarks/blob/master/free course).
- [Sublime Text 3 From Scratch](https://github.com/dreikanter/sublime-bookmarks/blob/master/http://www.pluralsight.com/courses/sublime-text-3-from-scratch) by  Jesse Liberty (https://github.com/dreikanter/sublime-bookmarks/blob/master/Pluralsight).
- [Sublime Text 2](https://github.com/dreikanter/sublime-bookmarks/blob/master/https://pragprog.com/screencasts/v-mrst2/sublime-text-2) by Mike Riley (https://github.com/dreikanter/sublime-bookmarks/blob/master/Pragmatic Studio).
...
- [ApplySyntax](https://github.com/dreikanter/sublime-bookmarks/blob/master/https://github.com/facelessuser/ApplySyntax) — a plugin that allows to detect and apply the syntax of files that might not otherwise be detected properly. For example, files with the .rb extension are usually Ruby files, but when they are found in a Rails project, they could be RSpec spec files, Cucumber step files, Ruby on Rails files (https://github.com/dreikanter/sublime-bookmarks/blob/master/controllers, models, etc), or just plain Ruby files.
...
- [SublimeREPL](https://github.com/dreikanter/sublime-bookmarks/blob/master/https://github.com/wuub/SublimeREPL) — runs an interpreter inside ST2 (https://github.com/dreikanter/sublime-bookmarks/blob/master/Clojure, CoffeeScript, F#, Groovy, Haskell, Lua, MozRepl, NodeJS, Python, R, Ruby, Scala, shell or configure one yourself).
...
- [StyleToken](https://github.com/dreikanter/sublime-bookmarks/blob/master/https://github.com/vcharnahrebel/style-token) — allows to highlight certain pieces of text with different colors (https://github.com/dreikanter/sublime-bookmarks/blob/master/similar to Notepad++ "Style token" functionality).
...
- [ProductiveSnippetsRuby](https://github.com/dreikanter/sublime-bookmarks/blob/master/https://github.com/janlelis/productive-sublime-snippets-ruby/) — consistent set of alternative snippets, focusing on core and stdlib (https://github.com/dreikanter/sublime-bookmarks/blob/master/[Cheatsheet](https://github.com/dreikanter/sublime-bookmarks/blob/master/https://github.com/janlelis/productive-sublime-snippets-ruby/blob/master/CHEATSHEET.md))
...
- [SublimeLinter PEP 257](https://github.com/dreikanter/sublime-bookmarks/blob/master/https://github.com/SublimeLinter/SublimeLinter-pep257) — an interface to [PEP 257](https://github.com/dreikanter/sublime-bookmarks/blob/master/https://github.com/GreenSteam/pep257#pep-257-docstring-style-checker) (https://github.com/dreikanter/sublime-bookmarks/blob/master/docstring style checker).
...
- [JavaScript Enhancements](https://github.com/dreikanter/sublime-bookmarks/blob/master/https://github.com/pichillilorenzo/JavaScriptEnhancements) — plugin that offers smart javascript autocomplete, real-time errors and, also, a lot of features about creating, developing and managing javascript projects (https://github.com/dreikanter/sublime-bookmarks/blob/master/such as Cordova, Ionic, React, etc.). It uses [Flow](https://github.com/dreikanter/sublime-bookmarks/blob/master/https://github.com/facebook/flow) (https://github.com/dreikanter/sublime-bookmarks/blob/master/javascript static type checker from Facebook) under the hood.
...
- [Hayaku](https://github.com/dreikanter/sublime-bookmarks/blob/master/http://hayakubundle.com) — fuzzy abbreviations, support for preprocessors (https://github.com/dreikanter/sublime-bookmarks/blob/master/Sass, Less, Stylus) and a lot of other features in easily configurable set of tools for writing CSS faster.
...
- [Command line usage](https://github.com/dreikanter/sublime-bookmarks/blob/master/http://www.sublimetext.com/docs/2/osx_command_line.html) (https://github.com/dreikanter/sublime-bookmarks/blob/master/for OS X).
...
- [Themer](https://github.com/dreikanter/sublime-bookmarks/blob/master/https://themer.mjswensen.com) - tool for generating color schemes (https://github.com/dreikanter/sublime-bookmarks/blob/master/and matching themes for your other development tools, including wallpaper) from your favorite colors.
...
- [Consolas](https://github.com/dreikanter/sublime-bookmarks/blob/master/http://www.fonts.com/font/microsoft-corporation/consolas) (https://github.com/dreikanter/sublime-bookmarks/blob/master/goes with Microsoft Office)

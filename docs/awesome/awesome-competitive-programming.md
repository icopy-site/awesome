...
| ★★★ | [E-Maxx (https://github.com/lnishan/awesome-competitive-programming/blob/master/Russian)](https://github.com/lnishan/awesome-competitive-programming/blob/master/http://e-maxx.ru/algo/), [(https://github.com/lnishan/awesome-competitive-programming/blob/master/English)](https://github.com/lnishan/awesome-competitive-programming/blob/master/http://cp-algorithms.com/) | A tutorial website widely used and referenced in the Russian-speaking competitive programming community. Only a small fraction of the original site is translated into English, but Google Translate would work okay.
...
| ★★☆ | [USA Computing Olympiad (https://github.com/lnishan/awesome-competitive-programming/blob/master/USACO)](https://github.com/lnishan/awesome-competitive-programming/blob/master/http://www.usaco.org/) | Contains several training pages on its website which are designed to develop one's skills in programming solutions to difficult and varied algorithmic problems at one's own pace. |
...
| ★☆☆ | [algolist (https://github.com/lnishan/awesome-competitive-programming/blob/master/Russian)](https://github.com/lnishan/awesome-competitive-programming/blob/master/http://algolist.manual.ru/) | A Russian website devoted to algorithms of all sorts. Some topics listed on this website seems pretty interesting. |
| ★★☆ | [演算法筆記 (https://github.com/lnishan/awesome-competitive-programming/blob/master/Algorithm Notes) (https://github.com/lnishan/awesome-competitive-programming/blob/master/Chinese)](https://github.com/lnishan/awesome-competitive-programming/blob/master/http://www.csie.ntnu.edu.tw/~u91029/) | One of the most popular tutorial websites among the Taiwanese competitive programming community. The maintainer for this website spends immense efforts on researching algorithms. |
| ★★☆ | [国家集训队论文 1999-2015 (https://github.com/lnishan/awesome-competitive-programming/blob/master/Papers from Chinese IOI training camps) (https://github.com/lnishan/awesome-competitive-programming/blob/master/Chinese)](https://github.com/lnishan/awesome-competitive-programming/blob/master/http://download.csdn.net/album/detail/657/1/1) | Papers from the Chinese IOI training camps. It's interesting for the fact that one can tell different regions emphasize different things. |
...
| ★★☆ | [Reykjavik T-414-ÁFLV: A Competitive Programming Course](https://github.com/lnishan/awesome-competitive-programming/blob/master/https://algo.is/competitive-programming-course/) | An awesome course taught by [Bjarki Ágúst Guðmundsson (https://github.com/lnishan/awesome-competitive-programming/blob/master/SuprDewd)](https://github.com/lnishan/awesome-competitive-programming/blob/master/https://algo.is). These lectures feature neat slides and a nice list of problems to practice. |
...
| ★☆☆ | [Materials (https://github.com/lnishan/awesome-competitive-programming/blob/master/English)](https://github.com/lnishan/awesome-competitive-programming/blob/master/https://github.com/mostafa-saad/ArabicCompetitiveProgramming) from [Arabic Competitive Programming Youtube Channel](https://github.com/lnishan/awesome-competitive-programming/blob/master/https://www.youtube.com/user/nobody123497) | Some materials (https://github.com/lnishan/awesome-competitive-programming/blob/master/slides & source codes) covering a broad range of algorithmic topics by Mostafa Saad Ibrahim. |

### Open Courses for Algorithms and Data Structures

| ☆ | Name | Description |
| --- | --- | --- |
| ★★★ | [prakhar1989/awesome-courses#algorithms](https://github.com/lnishan/awesome-competitive-programming/blob/master/https://github.com/prakhar1989/awesome-courses#algorithms) | A fantastic list of open courses offered by notable institutions (https://github.com/lnishan/awesome-competitive-programming/blob/master/MIT, Stanford, UC Berkeley ... etc.). |
| ★★★ | [MIT SMA 5503: Introduction to Algorithms](https://github.com/lnishan/awesome-competitive-programming/blob/master/https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-046j-introduction-to-algorithms-sma-5503-fall-2005/) | Lectured by Prof. Charles Leiserson (https://github.com/lnishan/awesome-competitive-programming/blob/master/one of the coauthors of Introduction to Algorithms) and Prof. Erik Demaine (https://github.com/lnishan/awesome-competitive-programming/blob/master/a brilliant professor who has made remarkable breakthroughs in data science), the course offers great materials, accompanied by intuitive and comprehensive analyses. |
...
| ☆ | Name | Description |
| --- | --- | --- |
| ★★☆ | [Competitive Programming](https://github.com/lnishan/awesome-competitive-programming/blob/master/https://cpbook.net/), by Steven and Felix Halim | This book contains a collection of relevant data structures, algorithms, and programming tips. It's a well-received book. ... The first edition is free for [download (https://github.com/lnishan/awesome-competitive-programming/blob/master/pdf)](https://github.com/lnishan/awesome-competitive-programming/blob/master/http://www.comp.nus.edu.sg/~stevenha/myteaching/competitive_programming/cp1.pdf). |
...
| ★★☆ | [Competitive Programmer's Handbook](https://github.com/lnishan/awesome-competitive-programming/blob/master/https://cses.fi/book/index.html), by Antti Laaksonen | An introduction to competitive programming for aspiring IOI and ICPC contestants. Free to [download (https://github.com/lnishan/awesome-competitive-programming/blob/master/pdf)](https://github.com/lnishan/awesome-competitive-programming/blob/master/https://cses.fi/book/book.pdf). |
...
| ★☆☆ | [C++11 FAQ (https://github.com/lnishan/awesome-competitive-programming/blob/master/English, Chinese, Russian, Japanese, Korean)](https://github.com/lnishan/awesome-competitive-programming/blob/master/http://www.stroustrup.com/C++11FAQ.html) | A list of FAQs regarding C++11 collected and written by Bjarne Stroustrup, the creator of C++. |
...
| ★★☆ | [Eclipse](https://github.com/lnishan/awesome-competitive-programming/blob/master/https://www.eclipse.org/downloads/) | GUI / Cross-Platform | Eclipse is another good IDE for Java. It's an okay alternative to Intellij IDEA (https://github.com/lnishan/awesome-competitive-programming/blob/master/A tad inferior to IDEA by today's standards). Sometimes contests only provide Eclipse for some reason, so this might be a good incentive to try and use Eclipse. |
| ★★☆ | [CLion](https://github.com/lnishan/awesome-competitive-programming/blob/master/https://www.jetbrains.com/clion/download/) | GUI / Cross-Platform | CLion, produced by JetBrains - the same company who made Intellij IDEA, is a powerful IDE for C++. Free educational licenses are available OR you can try out their [EAP (https://github.com/lnishan/awesome-competitive-programming/blob/master/Early Access Program)](https://github.com/lnishan/awesome-competitive-programming/blob/master/https://confluence.jetbrains.com/display/CLION/Early+Access+Program) which is still free as of Apr, 2018. You may want to turn off its code inspection feature as it will cause quite a bit of lag. |
...
| Adam Bardashevich (https://github.com/lnishan/awesome-competitive-programming/blob/master/subscriber) | [Youtube](https://github.com/lnishan/awesome-competitive-programming/blob/master/https://www.youtube.com/channel/UCc4jWVeWjUfpUo8z4PHfopw) |

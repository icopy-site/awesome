...
- [`relay-decorator`](https://github.com/expede/awesome-relay/blob/master/https://github.com/4Catalyzer/relay-decorators) - Simply syntax for Relay containers with ES7 decorators (https://github.com/expede/awesome-relay/blob/master/`@` syntax)
...
Boilerplate + examples for React Native (https://github.com/expede/awesome-relay/blob/master/iOS, Android), React (https://github.com/expede/awesome-relay/blob/master/isomorphic, Material-UI), Relay, GraphQL, JWT, Node.js, Apache Cassandra.

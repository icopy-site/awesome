...
- [`relay-decorator`](https://github.com/4Catalyzer/relay-decorators) - Simply syntax for Relay containers with ES7 decorators (https://github.com/expede/awesome-relay/blob/master/`@` syntax)

...
+ **[Responsive Web Design (https://github.com/dypsilon/frontend-dev-bookmarks/blob/master/RWD)](https://github.com/dypsilon/frontend-dev-bookmarks/blob/master/compatibility/responsive-web-design-rwd.md)**: RWD responds to the needs of the users and the devices they’re using. The layout changes based on the size and capabilities of the device.
...
+ **[JavaScript Object Notation (https://github.com/dypsilon/frontend-dev-bookmarks/blob/master/JSON)](https://github.com/dypsilon/frontend-dev-bookmarks/blob/master/languages-protocols-browser-apis/javascript-object-notation-json.md)**: JSON (https://github.com/dypsilon/frontend-dev-bookmarks/blob/master/JavaScript Object Notation) is a lightweight data-interchange format. It is easy for humans to read and write. It is easy for machines to parse and generate. It is based on a subset of the JavaScript Programming Language.
+ **[Scalable Vector Graphics (https://github.com/dypsilon/frontend-dev-bookmarks/blob/master/SVG)](https://github.com/dypsilon/frontend-dev-bookmarks/blob/master/languages-protocols-browser-apis/scalable-vector-graphics-svg.md)**: An XML-based vector image format for two-dimensional graphics with support for interactivity and animation.

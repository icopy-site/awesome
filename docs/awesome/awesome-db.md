...
## Research Papers
* [db-readings](https://github.com/rxin/db-readings) - A list of papers essential to understanding databases and building new data systemst of papers essential to understanding databases and building new data systemst of papers essential to understanding databases and building new data systems
...
- [Kali](https://github.com/sbilly/awesome-security/blob/master/https://www.kali.org/) - Kali Linux is a Debian-derived Linux distribution designed for digital forensics and penetration testing. Kali Linux is preinstalled with numerous penetration-testing programs, including nmap (https://github.com/sbilly/awesome-security/blob/master/a port scanner), Wireshark (https://github.com/sbilly/awesome-security/blob/master/a packet analyzer), John the Ripper (https://github.com/sbilly/awesome-security/blob/master/a password cracker), and Aircrack-ng (https://github.com/sbilly/awesome-security/blob/master/a software suite for penetration-testing wireless LANs).
...
- [passivedns](https://github.com/sbilly/awesome-security/blob/master/https://github.com/gamelinux/passivedns) - A tool to collect DNS records passively to aid Incident handling, Network Security Monitoring (https://github.com/sbilly/awesome-security/blob/master/NSM) and general digital forensics. PassiveDNS sniffs traffic from an interface or reads a pcap-file and outputs the DNS-server answers to a log file. PassiveDNS can cache/aggregate duplicate DNS answers in-memory, limiting the amount of data in the logfile without loosing the essens in the DNS answer.
- [sagan](https://github.com/sbilly/awesome-security/blob/master/http://sagan.quadrantsec.com/) - Sagan uses a 'Snort like' engine and rules to analyze logs (https://github.com/sbilly/awesome-security/blob/master/syslog/event log/snmptrap/netflow/etc).
...
- [Snort](https://github.com/sbilly/awesome-security/blob/master/https://www.snort.org/) - Snort is a free and open source network intrusion prevention system (https://github.com/sbilly/awesome-security/blob/master/NIPS) and network intrusion detection system (https://github.com/sbilly/awesome-security/blob/master/NIDS)created by Martin Roesch in 1998. Snort is now developed by Sourcefire, of which Roesch is the founder and CTO. In 2009, Snort entered InfoWorld's Open Source Hall of Fame as one of the "greatest [pieces of] open source software of all time".
...
- [Suricata](https://github.com/sbilly/awesome-security/blob/master/http://suricata-ids.org/) - Suricata is a high performance Network IDS, IPS and Network Security Monitoring engine. Open Source and owned by a community run non-profit foundation, the Open Information Security Foundation (https://github.com/sbilly/awesome-security/blob/master/OISF). Suricata is developed by the OISF and its supporting vendors.
...
- [AIEngine](https://github.com/sbilly/awesome-security/blob/master/https://bitbucket.org/camp0/aiengine) - AIEngine is a next generation interactive/programmable Python/Ruby/Java/Lua packet inspection engine with capabilities of learning without any human intervention, NIDS(https://github.com/sbilly/awesome-security/blob/master/Network Intrusion Detection System) functionality, DNS domain classification, network collector, network forensics and many others.
...
- [HoneyDrive](https://github.com/sbilly/awesome-security/blob/master/http://bruteforce.gr/honeydrive) - HoneyDrive is the premier honeypot Linux distro. It is a virtual appliance (https://github.com/sbilly/awesome-security/blob/master/OVA) with Xubuntu Desktop 12.04.4 LTS edition installed. It contains over 10 pre-installed and pre-configured honeypot software packages such as Kippo SSH honeypot, Dionaea and Amun malware honeypots, Honeyd low-interaction honeypot, Glastopf web honeypot and Wordpot, Conpot SCADA/ICS honeypot, Thug and PhoneyC honeyclients and more. Additionally it includes many useful pre-configured scripts and utilities to analyze, visualize and process the data it can capture, such as Kippo-Graph, Honeyd-Viz, DionaeaFR, an ELK stack and much more. Lastly, almost 90 well-known malware analysis, forensics and network monitoring related tools are also present in the distribution.
...
- [T-Pot Honeypot Distro](https://github.com/sbilly/awesome-security/blob/master/http://dtag-dev-sec.github.io/mediator/feature/2017/11/07/t-pot-17.10.html) - T-Pot is based on the network installer of Ubuntu Server 16/17.x LTS. The honeypot daemons as well as other support components being used have been containerized using docker. This allows us to run multiple honeypot daemons on the same network interface while maintaining a small footprint and constrain each honeypot within its own environment. Installation over vanilla Ubuntu - [T-Pot Autoinstall](https://github.com/sbilly/awesome-security/blob/master/https://github.com/dtag-dev-sec/t-pot-autoinstall) - This script will install T-Pot 16.04/17.10 on a fresh Ubuntu 16.04.x LTS (https://github.com/sbilly/awesome-security/blob/master/64bit). It is intended to be used on hosted servers, where an Ubuntu base image is given and there is no ability to install custom ISO images. Successfully tested on vanilla Ubuntu 16.04.3 in VMware.

### Full Packet Capture / Forensic

- [tcpflow](https://github.com/sbilly/awesome-security/blob/master/https://github.com/simsong/tcpflow) - tcpflow is a program that captures data transmitted as part of TCP connections (https://github.com/sbilly/awesome-security/blob/master/flows), and stores the data in a way that is convenient for protocol analysis and debugging. Each TCP flow is stored in its own file. Thus, the typical TCP flow will be stored in two files, one for each direction. tcpflow can also process stored 'tcpdump' packet flows.
- [Xplico](https://github.com/sbilly/awesome-security/blob/master/http://www.xplico.org/) - The goal of Xplico is extract from an internet traffic capture the applications data contained. For example, from a pcap file Xplico extracts each email (https://github.com/sbilly/awesome-security/blob/master/POP, IMAP, and SMTP protocols), all HTTP contents, each VoIP call (https://github.com/sbilly/awesome-security/blob/master/SIP), FTP, TFTP, and so on. Xplico isn’t a network protocol analyzer. Xplico is an open source Network Forensic Analysis Tool (https://github.com/sbilly/awesome-security/blob/master/NFAT).
- [Moloch](https://github.com/sbilly/awesome-security/blob/master/https://github.com/aol/moloch) - Moloch is an open source, large scale IPv4 packet capturing (https://github.com/sbilly/awesome-security/blob/master/PCAP), indexing and database system. A simple web interface is provided for PCAP browsing, searching, and exporting. APIs are exposed that allow PCAP data and JSON-formatted session data to be downloaded directly. Simple security is implemented by using HTTPS and HTTP digest password support or by using apache in front. Moloch is not meant to replace IDS engines but instead work along side them to store and index all the network traffic in standard PCAP format, providing fast access. Moloch is built to be deployed across many systems and can scale to handle multiple gigabits/sec of traffic.
...
- [Prelude](https://github.com/sbilly/awesome-security/blob/master/https://www.prelude-siem.org/) - Prelude is a Universal "Security Information & Event Management" (https://github.com/sbilly/awesome-security/blob/master/SIEM) system. Prelude collects, normalizes, sorts, aggregates, correlates and reports all security-related events independently of the product brand or license giving rise to such events; Prelude is "agentless".
...
- [OpenVPN](https://github.com/sbilly/awesome-security/blob/master/https://openvpn.net/) - OpenVPN is an open source software application that implements virtual private network (https://github.com/sbilly/awesome-security/blob/master/VPN) techniques for creating secure point-to-point or site-to-site connections in routed or bridged configurations and remote access facilities. It uses a custom security protocol that utilizes SSL/TLS for key exchange.

### Fast Packet Processing

- [DPDK](http://dpdk.org/) - DPDK is a set of libraries and drivers for fast packet processing.
- [PFQ](https://github.com/sbilly/awesome-security/blob/master/https://github.com/pfq/PFQ) - PFQ is a functional networking framework designed for the Linux operating system that allows efficient packets capture/transmission (https://github.com/sbilly/awesome-security/blob/master/10G and beyond), in-kernel functional processing and packets steering across sockets/end-points.
...
- [PF_RING ZC (https://github.com/sbilly/awesome-security/blob/master/Zero Copy)](https://github.com/sbilly/awesome-security/blob/master/http://www.ntop.org/products/packet-capture/pf_ring/pf_ring-zc-zero-copy/) - PF_RING ZC (https://github.com/sbilly/awesome-security/blob/master/Zero Copy) is a flexible packet processing framework that  allows you to achieve 1/10 Gbit line rate packet processing (https://github.com/sbilly/awesome-security/blob/master/both RX and TX) at any packet size. It implements zero copy operations including patterns for inter-process and inter-VM (https://github.com/sbilly/awesome-security/blob/master/KVM) communications.
...
- `docker pull citizenstig/dvwa` - [Damn Vulnerable Web Application (https://github.com/sbilly/awesome-security/blob/master/DVWA)](https://github.com/sbilly/awesome-security/blob/master/https://hub.docker.com/r/citizenstig/dvwa/)
...
- [Rudder](https://github.com/sbilly/awesome-security/blob/master/http://www.rudder-project.org/) - Rudder is an easy to use, web-driven, role-based solution for IT Infrastructure Automation & Compliance. Automate common system administration tasks (https://github.com/sbilly/awesome-security/blob/master/installation, configuration); Enforce configuration over time (https://github.com/sbilly/awesome-security/blob/master/configuring once is good, ensuring that configuration is valid and automatically fixing it is better); Inventory of all managed nodes; Web interface to configure and manage nodes and their configuration; Compliance reporting, by configuration and/or by node.

### Authentication

- [google-authenticator](https://github.com/sbilly/awesome-security/blob/master/https://github.com/google/google-authenticator) - The Google Authenticator project includes implementations of one-time passcode generators for several mobile platforms, as well as a pluggable authentication module (https://github.com/sbilly/awesome-security/blob/master/PAM). One-time passcodes are generated using open standards developed by the Initiative for Open Authentication (https://github.com/sbilly/awesome-security/blob/master/OATH) (https://github.com/sbilly/awesome-security/blob/master/which is unrelated to OAuth). These implementations support the HMAC-Based One-time Password (https://github.com/sbilly/awesome-security/blob/master/HOTP) algorithm specified in RFC 4226 and the Time-based One-time Password (https://github.com/sbilly/awesome-security/blob/master/TOTP) algorithm specified in RFC 6238. [Tutorials: How to set up two-factor authentication for SSH login on Linux](https://github.com/sbilly/awesome-security/blob/master/http://xmodulo.com/two-factor-authentication-ssh-login-linux.html)
...
- [Themis](https://github.com/sbilly/awesome-security/blob/master/https://github.com/cossacklabs/themis) - High-level multi-platform cryptographic framework for protecting sensitive data: secure messaging with forward secrecy and secure data storage (https://github.com/sbilly/awesome-security/blob/master/AES256GCM), suits for building end-to-end encrypted applications.
...
- [AlienVault Open Threat Exchange](https://github.com/sbilly/awesome-security/blob/master/http://www.alienvault.com/open-threat-exchange/dashboard) - AlienVault Open Threat Exchange (https://github.com/sbilly/awesome-security/blob/master/OTX), to help you secure your networks from data loss, service disruption and system compromise caused by malicious IP addresses.
...
- [FireEye OpenIOCs](https://github.com/sbilly/awesome-security/blob/master/https://github.com/fireeye/iocs) - FireEye Publicly Shared Indicators of Compromise (https://github.com/sbilly/awesome-security/blob/master/IOCs)
- [OpenVAS NVT Feed](https://github.com/sbilly/awesome-security/blob/master/http://www.openvas.org/openvas-nvt-feed.html) - The public feed of Network Vulnerability Tests (https://github.com/sbilly/awesome-security/blob/master/NVTs). It contains more than 35,000 NVTs (https://github.com/sbilly/awesome-security/blob/master/as of April 2014), growing on a daily basis. This feed is configured as the default for OpenVAS.
...
- [IntelMQ](https://github.com/sbilly/awesome-security/blob/master/https://github.com/certtools/intelmq/) - IntelMQ is a solution for CERTs for collecting and processing security feeds, pastebins, tweets using a message queue protocol. It's a community driven initiative called IHAP (https://github.com/sbilly/awesome-security/blob/master/Incident Handling Automation Project) which was conceptually designed by European CERTs during several InfoSec events. Its main goal is to give to incident responders an easy way to collect & process threat intelligence thus improving the incident handling processes of CERTs. [ENSIA Homepage](https://github.com/sbilly/awesome-security/blob/master/https://www.enisa.europa.eu/activities/cert/support/incident-handling-automation).
- [CIFv2](https://github.com/sbilly/awesome-security/blob/master/https://github.com/csirtgadgets/massive-octo-spice) - CIF is a cyber threat intelligence management system. CIF allows you to combine known malicious threat information from many sources and use that information for identification (https://github.com/sbilly/awesome-security/blob/master/incident response), detection (https://github.com/sbilly/awesome-security/blob/master/IDS) and mitigation (https://github.com/sbilly/awesome-security/blob/master/null route).
...
- [MISP - Open Source Threat Intelligence Platform ](https://github.com/sbilly/awesome-security/blob/master/https://www.misp-project.org/) - MISP threat sharing platform is a free and open source software helping information sharing of threat intelligence including cyber security indicators.  A threat intelligence platform for gathering, sharing, storing and correlating Indicators of Compromise of targeted attacks, threat intelligence, financial fraud information, vulnerability information or even counter-terrorism information. The MISP project includes software, common libraries (https://github.com/sbilly/awesome-security/blob/master/[taxonomies](https://github.com/sbilly/awesome-security/blob/master/https://www.misp-project.org/taxonomies.html), [threat-actors and various malware](https://github.com/sbilly/awesome-security/blob/master/https://www.misp-project.org/galaxy.html)), an extensive data model to share new information using [objects](https://github.com/sbilly/awesome-security/blob/master/https://www.misp-project.org/objects.html) and default [feeds](https://github.com/sbilly/awesome-security/blob/master/https://www.misp-project.org/feeds/).
...
- [OWASP](https://github.com/sbilly/awesome-security/blob/master/http://www.owasp.org) - The Open Web Application Security Project (https://github.com/sbilly/awesome-security/blob/master/OWASP) is a 501(https://github.com/sbilly/awesome-security/blob/master/c)(https://github.com/sbilly/awesome-security/blob/master/3) worldwide not-for-profit charitable organization focused on improving the security of software.
...
- [ironbee](https://github.com/sbilly/awesome-security/blob/master/https://github.com/ironbee/ironbee) - IronBee is an open source project to build a universal web application security sensor. IronBee as a framework for developing a system for securing web applications - a framework for building a web application firewall (https://github.com/sbilly/awesome-security/blob/master/WAF).
...
- [ZAP](https://github.com/sbilly/awesome-security/blob/master/https://www.owasp.org/index.php/OWASP_Zed_Attack_Proxy_Project) - The Zed Attack Proxy (https://github.com/sbilly/awesome-security/blob/master/ZAP) is an easy to use integrated penetration testing tool for finding vulnerabilities in web applications. It is designed to be used by people with a wide range of security experience and as such is ideal for developers and functional testers who are new to penetration testing. ZAP provides automated scanners as well as a set of tools that allow you to find security vulnerabilities manually.
...
- [PTF](https://github.com/sbilly/awesome-security/blob/master/https://github.com/trustedsec/ptf) - The Penetration Testers Framework (https://github.com/sbilly/awesome-security/blob/master/PTF) is a way for modular support for up-to-date tools.
...
- [ACSTIS](https://github.com/sbilly/awesome-security/blob/master/https://github.com/tijme/angularjs-csti-scanner) - ACSTIS helps you to scan certain web applications for AngularJS Client-Side Template Injection (https://github.com/sbilly/awesome-security/blob/master/sometimes referred to as CSTI, sandbox escape or sandbox bypass). It supports scanning a single request but also crawling the entire web application for the AngularJS CSTI vulnerability.

### Runtime Application Self-Protection

- [Sqreen](https://github.com/sbilly/awesome-security/blob/master/https://www.sqreen.io/) - Sqreen is a Runtime Application Self-Protection (https://github.com/sbilly/awesome-security/blob/master/RASP) solution for software teams. An in-app agent instruments and monitors the app. Suspicious user activities are reported and attacks are blocked at runtime without code modification or traffic redirection.
...
- [Secure by Design](https://github.com/sbilly/awesome-security/blob/master/https://www.manning.com/books/secure-by-design?a_aid=danbjson&a_bid=0b3fac80) - Book that identifies design patterns and coding styles that make lots of security vulnerabilities less likely. (https://github.com/sbilly/awesome-security/blob/master/early access, published continuously, final release fall 2017)
- [Securing DevOps](https://github.com/sbilly/awesome-security/blob/master/https://www.manning.com/books/securing-devops) - Book that explores how the techniques of DevOps and Security should be applied together to make cloud services safer. (https://github.com/sbilly/awesome-security/blob/master/early access, published continuously, final release January 2018)
...
- [OWASP ZAP Node API](https://github.com/sbilly/awesome-security/blob/master/https://github.com/zaproxy/zap-api-nodejs) - Leverage the OWASP Zed Attack Proxy (https://github.com/sbilly/awesome-security/blob/master/ZAP) within your NodeJS applications with this official API.
...
- [hadoop-pcap](https://github.com/sbilly/awesome-security/blob/master/https://github.com/RIPE-NCC/hadoop-pcap) - Hadoop library to read packet capture (https://github.com/sbilly/awesome-security/blob/master/PCAP) files.
...
- [Apache Metron (https://github.com/sbilly/awesome-security/blob/master/incubating)](https://github.com/sbilly/awesome-security/blob/master/https://github.com/apache/incubator-metron) - Metron integrates a variety of open source big data technologies in order to offer a centralized tool for security monitoring and analysis.
- [Apache Spot (https://github.com/sbilly/awesome-security/blob/master/incubating)](https://github.com/sbilly/awesome-security/blob/master/https://github.com/apache/incubator-spot) - Apache Spot is open source software for leveraging insights from flow and packet analysis.
...
- [Docker Security - Quick Reference: For DevOps Engineers](https://github.com/sbilly/awesome-security/blob/master/https://binarymist.io/publication/docker-security/) - A book on understanding the Docker security defaults, how to improve them (https://github.com/sbilly/awesome-security/blob/master/theory and practical), along with many tools and techniques.  

...
* [Validates](https://github.com/kaize/validates) - Validates provides collection of useful custom validators for Rails applications, including:
  ...
  * ColorValidator
  * EanValidator (https://github.com/hothero/awesome-rails-gem/blob/master/EAN-8 & EAN-13)
...
* [Metric Fu](https://github.com/hothero/awesome-rails-gem/blob/master/ https://github.com/metricfu/metric_fu) - A fist full of code metrics

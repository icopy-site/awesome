...
- [Orika](https://github.com/akullpp/awesome-java/blob/master/https://github.com/orika-mapper/orika) - JavaBean-mapping framework that recursively copies (https://github.com/akullpp/awesome-java/blob/master/among other capabilities) data from one object to another.
...
- [Byteman](https://github.com/akullpp/awesome-java/blob/master/https://byteman.jboss.org) - Manipulate bytecode at runtime via DSL (https://github.com/akullpp/awesome-java/blob/master/rules); mainly for testing/troubleshooting.
...
- [Cobertura](https://github.com/akullpp/awesome-java/blob/master/https://cobertura.github.io/cobertura) - Relies on offline (https://github.com/akullpp/awesome-java/blob/master/or static) bytecode instrumentation and class loading to collect code coverage metrics.
...
- [Chronicle Map](https://github.com/akullpp/awesome-java/blob/master/https://github.com/OpenHFT/Chronicle-Map) - Efficient, in-memory (https://github.com/akullpp/awesome-java/blob/master/opt. persisted to disk), off-heap key-value store.
...
- [Jinq](https://github.com/akullpp/awesome-java/blob/master/https://github.com/my2iu/Jinq) - Typesafe database queries via symbolic execution of Java 8 Lambdas (https://github.com/akullpp/awesome-java/blob/master/on top of JPA or jOOQ).
...
- [Apache POI](https://github.com/akullpp/awesome-java/blob/master/https://poi.apache.org/) - Supports OOXML (https://github.com/akullpp/awesome-java/blob/master/XLSX, DOCX, PPTX) as well as OLE2 (https://github.com/akullpp/awesome-java/blob/master/XLS, DOC or PPT).
...
- [Java Path Finder (https://github.com/akullpp/awesome-java/blob/master/JPF)](https://github.com/akullpp/awesome-java/blob/master/https://babelfish.arc.nasa.gov/trac/jpf) - JVM formal verification tool containing a model checker and more. Created by NASA.
...
- [Multi-OS Engine](https://github.com/akullpp/awesome-java/blob/master/https://software.intel.com/en-us/multi-os-engine) - An open-source, cross-platform engine to develop native mobile (https://github.com/akullpp/awesome-java/blob/master/iOS, Android, etc.) apps.
...
- [TLS Channel](https://github.com/akullpp/awesome-java/blob/master/https://github.com/marianobarrios/tls-channel) - Implements a ByteChannel interface over SSLEngine, enabling easy-to-use (https://github.com/akullpp/awesome-java/blob/master/socket-like) TLS.
...
- [Codec](https://github.com/akullpp/awesome-java/blob/master/http://commons.apache.org/proper/commons-codec) - General encoding/decoding algorithms (https://github.com/akullpp/awesome-java/blob/master/for example phonetic, base64, URL).
...
- [Weaver](https://github.com/akullpp/awesome-java/blob/master/http://commons.apache.org/proper/commons-weaver) - Provides an easy way to enhance (https://github.com/akullpp/awesome-java/blob/master/weave) compiled bytecode.
...
- [JGraphX](https://github.com/akullpp/awesome-java/blob/master/https://github.com/jgraph/jgraphx) - Library for visualizing (https://github.com/akullpp/awesome-java/blob/master/mainly Swing) and interacting with node-edge graphs.
...
- [Kalium](https://github.com/akullpp/awesome-java/blob/master/https://github.com/abstractj/kalium) - Binding for the Networking and Cryptography (https://github.com/akullpp/awesome-java/blob/master/NaCl) library.
...
- [Themis](https://github.com/akullpp/awesome-java/blob/master/https://github.com/cossacklabs/themis) - Multi-platform high-level cryptographic library provides easy-to-use encryption for protecting sensitive data: secure messaging with forward secrecy, secure data storage (https://github.com/akullpp/awesome-java/blob/master/AES256GCM); suits for building end-to-end encrypted applications.
...
- [Jade4J](https://github.com/akullpp/awesome-java/blob/master/https://github.com/neuland/jade4j) - Implementation of Pug (https://github.com/akullpp/awesome-java/blob/master/formerly known as Jade).
...
- [Play](https://github.com/akullpp/awesome-java/blob/master/https://www.playframework.com) - Built on Akka, it provides predictable and minimal resource consumption (https://github.com/akullpp/awesome-java/blob/master/CPU, memory, threads) for highly-scalable applications in Java and Scala.
...
- [Effective Java (https://github.com/akullpp/awesome-java/blob/master/3rd Edition)](https://github.com/akullpp/awesome-java/blob/master/https://www.amazon.com/Effective-Java-3rd-Joshua-Bloch/dp/0134685997)
...
- [Lukas Eder](https://github.com/akullpp/awesome-java/blob/master/https://twitter.com/lukaseder) - Java Champion, speaker, JUG.ch co-leader, Founder and CEO Data Geekery (https://github.com/akullpp/awesome-java/blob/master/jOOQ).

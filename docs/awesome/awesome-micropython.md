...
* [micropython-bno055](https://github.com/mcauser/awesome-micropython/blob/master/micropython-IMU/micropython-bno055) - Bosch BNO055 driver for MicroPython. IMU with hardware sensor fusion.

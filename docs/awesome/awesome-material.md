...
==
  - JavaScript
    ...
    - [Material-Preloader](https://github.com/aarondo/Material-Preloader) — A jQuery plugin that recreates the Material Design pre-loader (https://github.com/sachin1092/awesome-material/blob/master/as seen on inbox).

...
For suggestions or questions, open an issue. To contribute, read [this](https://github.com/leomaurodesenv/game-datasets/blob/master/CONTRIBUTING.md) and submit a pull request.

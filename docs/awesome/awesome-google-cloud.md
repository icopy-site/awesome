<div class="github-widget" data-repo="GoogleCloudPlatform/awesome-google-cloud"></div>
...
If you have found or built something awesome that uses Google Cloud, please follow the instructions in [https://github.com/GoogleCloudPlatform/awesome-google-cloud/blob/master/CONTRIBUTING.md](https://github.com/GoogleCloudPlatform/awesome-google-cloud/blob/master/CONTRIBUTING.md) to get it included here.
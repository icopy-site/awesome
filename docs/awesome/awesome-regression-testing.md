...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (https://github.com/mojoaxel/awesome-regression-testing/blob/master/Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/mojoaxel/awesome-regression-testing/blob/master/https://github.com/TheJambo/awesome-testing).
...
- [Needle](https://github.com/mojoaxel/awesome-regression-testing/blob/master/https://github.com/python-needle/needle) - Needle is a tool for testing visuals with Selenium and nose (https://github.com/mojoaxel/awesome-regression-testing/blob/master/Python).
- [gatling](https://github.com/mojoaxel/awesome-regression-testing/blob/master/https://github.com/gabrielrotbart/gatling) - Integrated visual RSpec matcher which makes real visual testing easy (https://github.com/mojoaxel/awesome-regression-testing/blob/master/Ruby).
...
- [BackTrac](https://github.com/mojoaxel/awesome-regression-testing/blob/master/https://backtrac.io) - Cloud based visual regression tool. Uses headless firefox and proprietary comparison algorithm (https://github.com/mojoaxel/awesome-regression-testing/blob/master/detect layout shifts).

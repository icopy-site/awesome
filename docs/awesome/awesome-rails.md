...
- [Rails Official Guide](https://github.com/ekremkaraca/awesome-rails/blob/master/http://guides.rubyonrails.org) <small>[(https://github.com/ekremkaraca/awesome-rails/blob/master/Edge Guide)](https://github.com/ekremkaraca/awesome-rails/blob/master/http://edgeguides.rubyonrails.org)</small>
...
- [Learn Ruby on Rails (https://github.com/ekremkaraca/awesome-rails/blob/master/thoughtbot)](https://github.com/ekremkaraca/awesome-rails/blob/master/https://thoughtbot.com/upcase/rails)
...
- [expertiza](https://github.com/ekremkaraca/awesome-rails/blob/master/https://github.com/expertiza/expertiza) - web application where students can submit and peer-review learning objects (https://github.com/ekremkaraca/awesome-rails/blob/master/articles, code, web sites, etc). 
...
- [reservations](https://github.com/ekremkaraca/awesome-rails/blob/master/https://github.com/YaleSTC/reservations) - Manages reservations for equipment (https://github.com/ekremkaraca/awesome-rails/blob/master/allows student reservations) [Live](https://github.com/ekremkaraca/awesome-rails/blob/master/http://yalestc.github.io/reservations)
...
- [Nanobox](https://github.com/ekremkaraca/awesome-rails/blob/master/https://github.com/nanobox-io/nanobox) - A micro-PaaS (https://github.com/ekremkaraca/awesome-rails/blob/master/μPaaS) for creating consistent, isolated, development environments deployable anywhere [Live](https://github.com/ekremkaraca/awesome-rails/blob/master/https://nanobox.io).

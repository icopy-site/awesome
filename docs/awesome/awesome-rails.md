...
- [Stack Overflow](http://careers.stackoverflow.com/jobs/tag/ruby-on-rails)
...
- [actioncable](https://github.com/rails/rails/tree/master/actioncable) - A gem to integrate websocket with a Rails app - [rubygems](https://rubygems.org/gems/actioncable) - [Action Cable Overview](https://guides.rubyonrails.org/action_cable_overview.html)
- [actionmailbox](https://github.com/rails/rails/tree/master/actionmailbox) - A gem to handle incoming emails within a Rails app - [rubygems](https://rubygems.org/gems/actionmailbox) - [Action Mailbox Basics](https://guides.rubyonrails.org/action_mailbox_basics.html)
- [actionmailer](https://github.com/rails/rails/tree/master/actionmailer) - A gem to compose, deliver & test emails within a Rails app - [rubygems](https://rubygems.org/gems/actionmailer) - [Action Mailer Basics](https://guides.rubyonrails.org/action_mailer_basics.html)
- [actionpack](https://github.com/rails/rails/tree/master/actionpack) - A gem to manage requests & responses within a Rails app - [rubygems](https://rubygems.org/gems/actionpack)
- [actiontext](https://github.com/rails/rails/tree/master/actiontext) - A gem to integrate rich text editor into a Rails app - [rubygems](https://rubygems.org/gems/actiontext) - [Action Text Overview](https://guides.rubyonrails.org/action_text_overview.html)
- [actionview](https://github.com/rails/rails/tree/master/actionview) - A gem to handle view templates within a Rails app - [rubygems](https://rubygems.org/gems/actionview) - [Action View Overview](https://guides.rubyonrails.org/action_view_overview.html)
- [activejob](https://github.com/rails/rails/tree/master/activejob) - A gem to handle background jobs within a Rails app - [rubygems](https://rubygems.org/gems/activejob) - [Active Job Basics](https://guides.rubyonrails.org/active_job_basics.html)
- [activemodel](https://github.com/rails/rails/tree/master/activemodel) - A gem to define a set of interfaces to use in model classes within a Rails app - [rubygems](https://rubygems.org/gems/activemodel) - [Active Model Basics](https://guides.rubyonrails.org/active_model_basics.html)
- [activerecord](https://github.com/rails/rails/tree/master/activerecord) - A gem to connect model classes with relational databases within a Rails app - [rubygems](https://rubygems.org/gems/activerecord) - [Active Record Basics](https://guides.rubyonrails.org/active_record_basics.html)
- [activestorage](https://github.com/rails/rails/tree/master/activestorage) - A gem to handle file uploads to cloud storage providers within a Rails app - [rubygems](https://rubygems.org/gems/activestorage) - [Active Storage Overview](https://guides.rubyonrails.org/active_storage_overview.html)
- [activesupport](https://github.com/rails/rails/tree/master/activesupport) - A gem to provide some extensions to support a Rails app - [rubygems](https://rubygems.org/gems/activesupport) - [Active Support Core Extensions](https://guides.rubyonrails.org/active_support_core_extensions.html)
- [railties](https://github.com/rails/rails/tree/master/railties) - A gem to handle gems & engines used in a Rails app to work together - [rubygems](https://rubygems.org/gems/railties)

> Other gems that can be used with Rails

- [ace-rails-ap](https://github.com/codykrieger/ace-rails-ap) - A gem to integrate ajax.org cloud9 editor into Rails asset pipeline. - [rubygems](https://rubygems.org/gems/ace-rails-ap)
...
- [activeadmin](https://github.com/activeadmin/activeadmin) - A gem to provide admin panel. - [rubygems](https://rubygems.org/gems/activeadmin)
...
- [anycable-rails](https://github.com/anycable/anycable-rails) - A gem to handle websocket server. - [rubygems](https://rubygems.org/gems/anycable-rails)
...
- [better_errors](https://github.com/BetterErrors/better_errors) - A tool to provide better error page. - [rubygems](https://rubygems.org/gems/better_errors)
...
- [caxlsx_rails](https://github.com/caxlsx/caxlsx_rails) - A gem to generate entity-relationship diagram. - [rubygems](https://rubygems.org/gems/caxlsx_rails)
...
- [good_job](https://github.com/bensheldon/good_job) - A gem to provide Postgres-based ActiveJob backend. - [rubygems](https://rubygems.org/gems/good_job)
...
- [lograge](https://github.com/roidrage/lograge) - A gem to customize logger in Rails apps. - [rubygems](https://rubygems.org/gems/lograge)
...
- [pgcli-rails](https://github.com/mattbrictson/pgcli-rails) - A replacement of `rails:dbconsole` command to manage Postgresql. - [rubygems](https://rubygems.org/gems/pgcli-rails)
...
- [rails_admin](https://github.com/sferik/rails_admin) - A gem to create & manage admin panel for Rails app. - [rubygems](https://rubygems.org/gems/rails_admin)
- [rails_event_store](https://github.com/RailsEventStore/rails_event_store) - A gem to implement event store in Rails - [rubygems](https://rubygems.org/gems/rails_event_store)
- [rails_semantic_logger](https://github.com/rocketjob/rails_semantic_logger) - A gem to provide alternative logging approach for Rails app. - [rubygems](https://rubygems.org/gems/rails_semantic_logger)
- [ranked-model](https://github.com/mixonic/ranked-model) - A gem to handle sorting for rows. - [rubygems](https://rubygems.org/gems/ranked-model)
...
- [react-rails](https://github.com/reactjs/react-rails) - A gem to integrate React.js with Rails app. - [rubygems](https://rubygems.org/gems/react-rails)
- [redisWebManager](https://github.com/OpenGems/redis_web_manager) - Web interface that allows you to manage easily your Redis instance. - [rubygems](https://rubygems.org/gems/redis_web_manager)
- [reform-rails](https://github.com/trailblazer/reform-rails) - A gem to wrap Reform gem, a form validation tool, with Rails app. - [rubygems](https://rubygems.org/gems/reform-rails)
...
- [rubocop-rails](https://github.com/rubocop-hq/rubocop-rails) - A code style checking tool. - [rubygems](https://rubygems.org/gems/rubocop-rails)
...
- [spring](https://github.com/rails/spring) - A gem to preload Rails app. - [rubygems](https://rubygems.org/gems/spring)
...
- [trove](https://github.com/ankane/trove) - A gem to handle machine learning models deployment. - [rubygems](https://rubygems.org/gems/trove)
...
- [view_component](https://github.com/github/view_component) - A gem to introduce view components. - [rubygems](https://rubygems.org/gems/view_component)

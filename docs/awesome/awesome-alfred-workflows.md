...
- [Pandoctor](https://github.com/derimagia/awesome-alfred-workflows/blob/master/https://github.com/smargh/alfred_pandoctor) - Alfred interface to [pandoc](https://github.com/derimagia/awesome-alfred-workflows/blob/master/http://pandoc.org), a tool that allows to convert between text formats (https://github.com/derimagia/awesome-alfred-workflows/blob/master/Markdown, LaTeX, DOC, DOCX, ...).
- [Unicode Text Search](https://github.com/bevesce/unicode-symbols-search) - Search for Unicode Symbols.

## Scientific
- [Convert](https://github.com/derimagia/awesome-alfred-workflows/blob/master/https://github.com/deanishe/alfred-convert) - Offline conversion of units and (https://github.com/derimagia/awesome-alfred-workflows/blob/master/crypto)currencies.
...
- [Lorem Ipsum](https://github.com/derimagia/awesome-alfred-workflows/blob/master/https://github.com/raarellano/alfred-lorem-ipsum-workflow) - Generate lorem ipsum(https://github.com/derimagia/awesome-alfred-workflows/blob/master/...) text from Alfred.
...
- [Random MAC](https://github.com/derimagia/awesome-alfred-workflows/blob/master/http://www.packal.org/workflow/random-mac) - Assigns a random MAC address to `en0` (https://github.com/derimagia/awesome-alfred-workflows/blob/master/e.g. for free wifi).
...
- [Swift Windows Switcher](https://github.com/derimagia/awesome-alfred-workflows/blob/master/https://github.com/mandrigin/AlfredSwitchWindows) - Switches between open windows and a browser (https://github.com/derimagia/awesome-alfred-workflows/blob/master/Safari/Chrome) tabs.

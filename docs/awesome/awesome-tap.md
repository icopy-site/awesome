...
- [AVA](https://github.com/sindresorhus/awesome-tap/blob/master/https://github.com/sindresorhus/ava) - Futuristic test runner (https://github.com/sindresorhus/awesome-tap/blob/master/`$ ava --tap`).
...
- [ESLint](https://github.com/sindresorhus/awesome-tap/blob/master/http://eslint.org/docs/user-guide/formatters/#tap) - Pluggable JavaScript linter (https://github.com/sindresorhus/awesome-tap/blob/master/`$ eslint --format=tap`).
- [Mocha](https://github.com/sindresorhus/awesome-tap/blob/master/https://mochajs.org) - Feature-rich test framework for Node.js and browsers (https://github.com/sindresorhus/awesome-tap/blob/master/`$ mocha reporter=tap`).
...
- [mos](https://github.com/sindresorhus/awesome-tap/blob/master/https://github.com/zkochan/mos) - Markdown file generator and tester (https://github.com/sindresorhus/awesome-tap/blob/master/`$ mos test --tap`).
...
To the extent possible under law, [Sindre Sorhus](http://sindresorhus.com) has waived all copyright and related or neighboring rights to this work.aw, [Sindre Sorhus](http://sindresorhus.com) has waived all copyright and related or neighboring rights to this work.
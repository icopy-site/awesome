...
*  [NVIDIA](https://developer.nvidia.com/Vulkan)
    ...
    *  [Driver for Linux for Tegra (https://github.com/vinjn/awesome-vulkan/blob/master/L4T)](https://github.com/vinjn/awesome-vulkan/blob/master/https://developer.nvidia.com/embedded/vulkan)
...
* Samgsung
    ...
    * [Vulkan Usage Recommencation](https://github.com/vinjn/awesome-vulkan/blob/master/https://developer.samsung.com/game/usage) (https://github.com/vinjn/awesome-vulkan/blob/master/for mobile)
* Epic
...
*  [Moving to Vulkan (https://github.com/vinjn/awesome-vulkan/blob/master/Khronos UK May16)](https://github.com/vinjn/awesome-vulkan/blob/master/https://www.khronos.org/assets/uploads/developers/library/2016-uk-chapter-moving-to-vulkan/Moving-to-Vulkan_Khronos-UK_May16.pdf)
...
*  [Doom](https://github.com/vinjn/awesome-vulkan/blob/master/https://en.wikipedia.org/wiki/Doom_(https://github.com/vinjn/awesome-vulkan/blob/master/2016_video_game)) - by id Software.
*  [vkQuake](https://github.com/Novum/vkQuake) - Vulkan Quake port based on QuakeSpasm. [GPL]
*  [vkQuake2](https://github.com/vinjn/awesome-vulkan/blob/master/https://github.com/kondrak/vkQuake2) - id Software's Quake 2 v3.21 with Vulkan support (https://github.com/vinjn/awesome-vulkan/blob/master/Windows and Linux). [GPL]
...
*  [RadX](https://github.com/vinjn/awesome-vulkan/blob/master/https://github.com/world8th/RadX) - Dedicated example of radix sorting on GPU (https://github.com/vinjn/awesome-vulkan/blob/master/on NVIDIA RTX in particular).
...
*  [vRt](https://github.com/vinjn/awesome-vulkan/blob/master/https://github.com/world8th/vRt) - Vulkan API (https://github.com/vinjn/awesome-vulkan/blob/master/>=1.1) based unified ray tracing library. [LGPL-3.0]
...
*  [Open Capture and Analytics Tool (https://github.com/vinjn/awesome-vulkan/blob/master/OCAT)](https://github.com/vinjn/awesome-vulkan/blob/master/https://github.com/GPUOpen-Tools/OCAT) - rovides an FPS overlay and performance measurement for D3D11, D3D12, and Vulkan. [MIT]
...
*  [Conformance Tests (https://github.com/vinjn/awesome-vulkan/blob/master/CTS)](https://github.com/vinjn/awesome-vulkan/blob/master/https://github.com/KhronosGroup/Vulkan-CTS)

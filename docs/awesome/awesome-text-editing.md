...
* [Hallo](https://github.com/dok/awesome-text-editing/blob/master/https://github.com/bergie/hallo) - Simple rich text editor (https://github.com/dok/awesome-text-editing/blob/master/contentEditable) for jQuery UI

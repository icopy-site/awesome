...
>
> (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/I'm not talking about actual production services like EC2 and Heroku and whatnot. We can go over this in another thread.)
...
| [DebugMail](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://debugmail.io) | - | Free | Easy to use fake mail (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/SMTP) server for developers. |
...
| [Pinitto.me](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://pinitto.me) | - | - | Post It Notes on a virtual corkboard (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/OSS) |
...
| [HotJar](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://www.hotjar.com) | [@hotjar](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/hotjar) | Free - $29/mo (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/personal) | Records videos and collects heatmaps of your site visitor actions. |
| [Wisdom](https://getWisdom.io) | Free - $2000+/mo | Session Replay | Wisdom is the most accurate live visitor session recorder service available. Focusing only on session replay, Wisdom reconstructs a virtual desktop screen for every visitor, across all tabs, to capture the true feel of every visitor's experience. |
...
| [Buildkite (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/Buildbox)](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://buildkite.com) | [@buildkite](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/buildkite) | $15/dev/mo | Semi-hosted continuous integration and deployment. Buildkite uses your own infrastructure to run builds so you can test any language or run any deployment scripts. You can run as many parallel agents (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/and builds) as you want. |
...
| [Monkey Test It](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://monkeytest.it) | [@monkeytestit](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/monkeytestit) | $0/mo - $199/mo | Automated website checking tool to catch bugs on your website (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/broken links, missing images, JS errors, etc) before your users do. Integrates with Slack, most CI systems, webooks, and supports built-in scheduling. |
...
| [Grafana](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://grafana.com) | [@grafana](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/grafana) | $0 - $90/mo (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/+9/user/mo) | The analytics platform for all your metrics. Grafana allows you to query, visualize, alert on and understand your metrics no matter where they are stored. Create, explore, and share dashboards with your team and foster a data driven culture. |
...
| [Logstash](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://www.elastic.co/products/logstash) | [@logstash](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/logstash) | - | Ship logs from any source, parse them, get the right timestamp, index them, and search them. Logstash is a tool for managing events and logs. You can use it to collect logs, parse them, and store them for later use (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/like, for searching). Speaking of searching, Logstash comes with a web interface for searching and drilling into all of your logs. |
...
| [Tender](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/http://tenderapp.com) | [@tenderapp](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/tenderapp) | $9/mo - $99/mo | Better, Simpler, Customer Support Software. Support your customers in the open! With public forums, you can offer a public space to your users to discuss common issues and get feedback, while still keeping certain categories private (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/billing, orders, ...). Power users can subscribe to categories and new discussions, and help out other customers. |
...
| [Zammad](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://www.zammad.com) | [@zammadhq](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/zammadhq) | $0/mo - $24/mo | Zammad is a award winning open source helpdesk/customer support system with a beautiful UI and many features to manage customer communication via several channels like telephone, facebook, twitter, chat and e-mails. It is distributed under the GNU AFFERO General Public License (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/AGPL). |
...
| [Vero](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://www.getvero.com) | [@veroapp](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/veroapp) | $99/mo | Send emails based on what your customers do. Vero makes it easy to create segments of customers based on the attributes you capture (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/e.g. age, location, gender) and the actions your customers take (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/e.g. logged in, used feature x, checked out, etc.). |
...
| [Timing](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://timingapp.com/) | [@TimingApp](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/TimingApp) | $29 - $79 | Automatic time and productivity tracking for Mac. Helps you stay on track with your work and ensures no billable hours get lost (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/if you are billing hourly). |
...
| [Keynote](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://www.apple.com/keynote/) | - | $19.99 | Easily create gorgeous presentations with the all-new Keynote, featuring powerful yet easy-to-use tools and dazzling effects that will make you a very hard act to follow. Also checkout the [Keynotopia Themes](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/ https://keynotopia.com) to get all the common UI elements for iOS, Android etc. |
...
| [invision](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://www.invisionapp.com) | [@InVisionApp](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/InVisionApp) | $0/mo - $100+/mo | Free Web & Mobile (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/iOS, Android) Prototyping and UI Mockup Tool. Transform your Web & Mobile (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/iOS, Android) designs into clickable, interactive Prototypes and Mockups. Share and Collaborate on them with others. |
...
| [Promoter.io](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://www.promoter.io) | [@Promoter_io](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/promoter_io) | $50/mo - $500/mo | Helps companies quickly gain predictive customer intelligence & insights driven by NPS (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/Net Promoter) to increase revenue and reduce churn. |
...
| [Vertabelo](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/http://www.vertabelo.com) | [@vertabelo](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/Vertabelo) | - | Web-based tool for database design. Vertabelo allows you to visually design database models for PostgreSQL, MySQL, Oracle, SQL Server, SQLite, and IBM DB2. You can import the existing database structure from SQL, XML, or using reverse engineering tool. After you design a model, you can generate SQL script or ready-to-use code for various ORMs (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/Propel, jOOQ, SQLAlchemy, or [Vertabelo Mobile ORM](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/http://mobile-orm.vertabelo.com/)). |
...
| [Fast409A](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://Fast409A.io) | [@ltse](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/ltse) | $2000 (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/depending on startup funding stage) | The Fast409A.io process blends the best of software and human expertise. Each 409A valuation takes an hour or less of your time to submit, is delivered in days not weeks, and is customised to the nuances of your individual startup. |
...
| Service | Twitter | Pricing | Description |
|:--------|:--------|:--------|:------------|
| [AppNeta (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/Tracelytics)](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://www.appneta.com/) | - | - | - |
...
| Service | Twitter | Pricing | Description |
|:--------|:--------|:--------|:------------|
| [Linode](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/ https://www.linode.com/) | - | - | - |
...
| Service | Twitter | Pricing | Description |
|:--------|:--------|:--------|:------------|
| [HumongouS.io](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://www.humongous.io) | - | - | HumongouS.io is a web-based user interface (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/GUI) for MongoDB. |
| [mLab](https://mlab.com ) | - | - | - |
| [Compose](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://www.compose.com) | - | - | Compose is a fully-managed platform used by developers to deploy, host and scale databases (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/Elasticsearch and MongoDB.) |
...
| [Confluence Questions (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/Q&A for your team)](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://www.atlassian.com/software/confluence/questions) | - | - | - |
...
| [SpiderOak](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://spideroak.com) | [@spideroak](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/spideroak) | First 2gb Free - $100/100gb/year (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/check [twitter](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/spideroak) for deals) | Store. Sync. Share. Privately. |
...
| [Deployd](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/http://deployd.com) | [@deploydapp](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/deploydapp) | Free (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/OSS) | Design, build, and scale APIs for web and mobile apps in minutes instead of days. |
...
| [Zapier](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://zapier.com) | [Zapier](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/zapier) | $99/mo - $15/mo | Superpowers to get your work done. A Zap is a link between two apps (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/a "trigger" and an "action"). Zaps run automatically in the background every few minutes to move and manage data on your behalf. Only live Zaps count against your limit — you can have as many paused and unfinished Zaps as you'd like. For example, one Zap might be "Send me an SMS every time I get a new email". |
...
| [Dead Man's Snitch](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://deadmanssnitch.com) | [@DeadMansSnitch](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/https://twitter.com/deadmanssnitch) | Free - $49/mo | Monitoring for scheduled tasks (https://github.com/cjbarber/ToolsOfTheTrade/blob/master/like cron) and service heartbeats. Makes it easy to know when and why a particular job failed. |

...
* [Einführung in MQTT](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://www.youtube.com/watch?v=INYG4-xsa9c) - Dominik Obermaier & Jens Deters, [Building IoT](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://www.buildingiot.de/) conference 2016 (https://github.com/hobbyquaker/awesome-mqtt/blob/master/German).
...
* [mqtt-client](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://github.com/sdeancos/mqtt-client) - A Simple MQTT Client command line (https://github.com/hobbyquaker/awesome-mqtt/blob/master/Python) (https://github.com/hobbyquaker/awesome-mqtt/blob/master/use paho lib)
...
* [MQTTInspector](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://github.com/ckrey/MQTTInspector) - A general MQTT testing app for iOS (https://github.com/hobbyquaker/awesome-mqtt/blob/master/iPhone and iPad).
...
* [gmqtt](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://github.com/wialon/gmqtt) - Python MQTT v5.0 client (https://github.com/hobbyquaker/awesome-mqtt/blob/master/asyncio-based)
...
* [M2Mqtt](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://m2mqtt.wordpress.com/) - A MQTT client available for all .Net platforms (https://github.com/hobbyquaker/awesome-mqtt/blob/master/.Net Framework, .Net Compact Framework and .Net Micro Framework) and WinRT platforms (https://github.com/hobbyquaker/awesome-mqtt/blob/master/Windows 8.1, Windows Phone 8.1 and Windows 10).
...
* [mqtt-client](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://github.com/centamiv/mqtt-client) - A Polymer Web Component that implements a MQTT client (https://github.com/hobbyquaker/awesome-mqtt/blob/master/uses Paho mqttws31.js).
...
* [Paho](https://github.com/hobbyquaker/awesome-mqtt/blob/master/http://www.eclipse.org/paho/) - Open source client implementations (https://github.com/hobbyquaker/awesome-mqtt/blob/master/C/C++, Java, Python, Javascript, Go, C#).
...
* [Basecamp](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://github.com/merlinschumacher/Basecamp) - An Arduino library to ease the use of the ESP32 in IoT projects. See [c't Magazin 2'2018 (https://github.com/hobbyquaker/awesome-mqtt/blob/master/German)](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://www.heise.de/select/ct/2018/02/1515452111258448).
...
* [mqtt-with-micropython](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://docs.pycom.io/chapter/tutorials/all/mqtt.html) - Connect to MQTT with micropython and wipy/others (https://github.com/hobbyquaker/awesome-mqtt/blob/master/ESP32 inside)
...
* [OPC Router](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://www.opc-router.com/4_1-mqtt-client-opc-router-plug-in-en/) - MQTT Gateway (https://github.com/hobbyquaker/awesome-mqtt/blob/master/publisher/subscriber) with various plug-ins (https://github.com/hobbyquaker/awesome-mqtt/blob/master/OPC UA Bridge, SQL Bridge, REST Bridge, SAP Bridge)
...
* [aqara-mqtt](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://github.com/monster1025/aqara-mqtt) - Aqara (https://github.com/hobbyquaker/awesome-mqtt/blob/master/Xiaomi) Gateway to MQTT bridge.
* [aqara2mqtt](https://github.com/hobbyquaker/aqara2mqtt) - Attach [Aqara](https://www.aqara.com/en/products.html) Smart Hubs to MQTT.
* [cul2mqtt](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://github.com/hobbyquaker/cul2mqtt) - Interface between [Busware CUL](https://github.com/hobbyquaker/awesome-mqtt/blob/master/http://shop.busware.de/product_info.php/cPath/1/products_id/29) (https://github.com/hobbyquaker/awesome-mqtt/blob/master/868MHz RF-Devices like ELV FS20, HMS, EM, ...) and MQTT.
* [domiqtt](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://github.com/etobi/domiqtt) - Connects to a Domiq Base (https://github.com/hobbyquaker/awesome-mqtt/blob/master/LCN) and translate from and to MQTT.
* [eno2mqtt](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://github.com/owagner/eno2mqtt) - Interface between an Enocean USB300 (https://github.com/hobbyquaker/awesome-mqtt/blob/master/TCM310) adapter and MQTT.
...
* [mcsMQTT](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://shop.homeseer.com/products/mcsmqtt-software-plug-in-for-hs3) - Plug-in for HS3 (https://github.com/hobbyquaker/awesome-mqtt/blob/master/HomeSeer).
...
* [zigbee2mqtt](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://github.com/Koenkk/zigbee2mqtt) - Allows you to use your Zigbee devices without the vendors (https://github.com/hobbyquaker/awesome-mqtt/blob/master/Xiaomi/TRADFRI/Hue) bridge/gateway.
...
* [lirc2mqtt](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://github.com/hobbyquaker/lirc2mqtt) - Send and receive infrared via [LIRC](https://github.com/hobbyquaker/awesome-mqtt/blob/master/www.lirc.org).
...
* [mqttwarn](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://github.com/jpmens/mqttwarn) - Subscribe to MQTT topics (https://github.com/hobbyquaker/awesome-mqtt/blob/master/with wildcards) and notifiy pluggable services.
...
* [gBridge](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://github.com/kservices/gBridge) - gBridge allows you to control (https://github.com/hobbyquaker/awesome-mqtt/blob/master/almost) any smart home device, any smart home software, with Google Assistant. Therefore, it transforms actions received from Google by voice commands to MQTT messages.
...
* Tasker (https://github.com/hobbyquaker/awesome-mqtt/blob/master/Automation for Android) [MQTT Publisher Plugin](https://github.com/hobbyquaker/awesome-mqtt/blob/master/https://play.google.com/store/apps/details?id=net.nosybore.mqttpublishplugin).
...
[![CC0](http://i.creativecommons.org/p/zero/1.0/88x31.png)](http://creativecommons.org/publicdomain/zero/1.0/)er M2M protocols - Commercial solution.

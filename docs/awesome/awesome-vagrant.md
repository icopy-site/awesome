...
* [Vagrant Cloud](https://github.com/iJackUA/awesome-vagrant/blob/master/https://app.vagrantup.com/boxes/search) - config share, boxes distribution and discovery (https://github.com/iJackUA/awesome-vagrant/blob/master/also premium features of private collaboration and sharing).
...
* [Cloudsmith](https://github.com/iJackUA/awesome-vagrant/blob/master/https://cloudsmith.io) - A fully managed package management SaaS with support for Vagrant repositories (https://github.com/iJackUA/awesome-vagrant/blob/master/and many others).
...
* [vagrant-vbguest](https://github.com/iJackUA/awesome-vagrant/blob/master/https://github.com/dotless-de/vagrant-vbguest) - autoupdate VirtualBox guest additions (https://github.com/iJackUA/awesome-vagrant/blob/master/according to VB version).
...
* [vagrant-cachier](https://github.com/iJackUA/awesome-vagrant/blob/master/http://fgrehm.viewdocs.io/vagrant-cachier/) - share a common package (https://github.com/iJackUA/awesome-vagrant/blob/master/apt-get, npm, etc.) cache among similar VM instances.
...
* [sahara](https://github.com/iJackUA/awesome-vagrant/blob/master/https://github.com/jedi4ever/sahara) - easy manage VM state (https://github.com/iJackUA/awesome-vagrant/blob/master/commit/rollback while experimenting with software stack).
* [vagrant-registration](https://github.com/iJackUA/awesome-vagrant/blob/master/https://github.com/projectatomic/adb-vagrant-registration) - add "register" and "unregister" capabilities to Vagrant guests for updates on systems with a subscription model(https://github.com/iJackUA/awesome-vagrant/blob/master/like Red Hat Enterprise Linux).
* [vagrant-service-manager](https://github.com/iJackUA/awesome-vagrant/blob/master/https://github.com/projectatomic/vagrant-service-manager) - enable easier access to the features and services provided by the [Atomic Developer Bundle (https://github.com/iJackUA/awesome-vagrant/blob/master/ADB)](https://github.com/iJackUA/awesome-vagrant/blob/master/https://github.com/projectatomic/adb-atomic-developer-bundle).
...
* [Veewee](https://github.com/iJackUA/awesome-vagrant/blob/master/https://github.com/jedi4ever/veewee) - a tool for easily (https://github.com/iJackUA/awesome-vagrant/blob/master/and repeatedly) building custom Vagrant base boxes, KVMs, and virtual machine images.

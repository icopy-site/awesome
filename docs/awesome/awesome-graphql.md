...
Boilerplate + examples for React Native (https://github.com/chentsulin/awesome-graphql/blob/master/iOS, Android), React (https://github.com/chentsulin/awesome-graphql/blob/master/isomorphic, Material-UI), Relay, GraphQL, JWT, Node.js, Apache Cassandra.

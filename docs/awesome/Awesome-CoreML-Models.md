...
* **MNIST** - Predict handwritten (https://github.com/likedan/Awesome-CoreML-Models/blob/master/drawn) digits from images. [Download](https://github.com/ph1ps/MNIST-CoreML/raw/master/MNISTPrediction/MNIST.mlmodel) | [Demo](https://github.com/ph1ps/MNIST-CoreML) | [Reference](http://yann.lecun.com/exdb/mnist/)
...
* **Nudity** - Classifies an image either as NSFW (https://github.com/likedan/Awesome-CoreML-Models/blob/master/nude) or SFW (not https://github.com/likedan/Awesome-CoreML-Models/blob/master/nude)

...
* [framer-QueryInterface](https://github.com/podo/awesome-framer/blob/master/https://github.com/marckrenn/framer-QueryInterface) - Module that allows Framer prototypes to read variables from and write variables to the last part of their URL (https://github.com/podo/awesome-framer/blob/master/the query).
...
* [lottie-framer](https://github.com/podo/awesome-framer/blob/master/https://github.com/72/lottie-framer) - Framer module that uses AirBnb's Lottie-Web to render animations exported from After Effects (https://github.com/podo/awesome-framer/blob/master/JSON files).
...
* [Framer Device Rotator](https://github.com/podo/awesome-framer/blob/master/https://github.com/josephxbrick/DeviceRotator) - A Framer module that adds a rotation button to a phone/tablet when said is displayed in a desktop browser or in Framer Studio (https://github.com/podo/awesome-framer/blob/master/but not on device).

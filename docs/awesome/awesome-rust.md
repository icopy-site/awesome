...
See also [Rust — Production](https://github.com/rust-unofficial/awesome-rust/blob/master/https://www.rust-lang.org/production)(https://github.com/rust-unofficial/awesome-rust/blob/master/organizations running Rust in production).
...
* [indiscipline/zrtstr](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/indiscipline/zrtstr) — a command line utility for checking if stereo wav files are faux-stereo (https://github.com/rust-unofficial/awesome-rust/blob/master/i.e. have identical channels) and converting such files to mono. [<img src="https://api.travis-ci.org/indiscipline/zrtstr.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/indiscipline/zrtstr)
...
* [cardano-cli](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/input-output-hk/cardano-cli) — Cardano Command Line Interface (https://github.com/rust-unofficial/awesome-rust/blob/master/CLI)
...
* [Mentat](https://github.com/rust-unofficial/awesome-rust/blob/master/https://mozilla.github.io/mentat/) — Project Mentat is a persistent, embedded knowledge base. It draws heavily on DataScript and Datomic. Mentat is intended to be a flexible relational (https://github.com/rust-unofficial/awesome-rust/blob/master/not key-value, not document-oriented) store that makes it easy to describe, grow, and reuse your domain schema.
...
* [aleshaleksey/TGWM](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/aleshaleksey/TGWM) — An RPG with turned-based mechanics (https://github.com/rust-unofficial/awesome-rust/blob/master/work in progress) [<img src="https://api.travis-ci.org/aleshaleksey/TGWM.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/aleshaleksey/TGWM)
...
* [pop-os/system76-power](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/pop-os/system76-power/) — Linux power management daemon (https://github.com/rust-unofficial/awesome-rust/blob/master/DBus-interface) with CLI tool.
...
* [BurntSushi/xsv](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/BurntSushi/xsv) — a fast CSV command line tool (https://github.com/rust-unofficial/awesome-rust/blob/master/slicing, indexing, selecting, searching, sampling, etc.) [<img src="https://api.travis-ci.org/BurntSushi/xsv.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/BurntSushi/xsv)
...
* [brycx/checkpwn](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/brycx/checkpwn) — A Have I Been Pwned (https://github.com/rust-unofficial/awesome-rust/blob/master/HIBP) command-line utility tool that lets you easily check for compromised accounts and passwords.
* [evansmurithi/cloak](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/evansmurithi/cloak) — A Command Line OTP (https://github.com/rust-unofficial/awesome-rust/blob/master/One Time Password) Authenticator application. [<img src="https://api.travis-ci.com/evansmurithi/cloak.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.com/evansmurithi/cloak) [<img src="https://ci.appveyor.com/api/projects/status/9mlfpfru3ng4c689/branch/master?svg=true">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://ci.appveyor.com/project/evansmurithi/cloak)
...
* [way-cooler/way-cooler](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/way-cooler/way-cooler) — a customizable Wayland compositor (https://github.com/rust-unofficial/awesome-rust/blob/master/window manager) [<img src="https://api.travis-ci.org/way-cooler/way-cooler.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/way-cooler/way-cooler)
...
* [clog-tool/clog-cli](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/clog-tool/clog-cli) — generates a changelog from git metadata (https://github.com/rust-unofficial/awesome-rust/blob/master/[conventional changelog](https://github.com/rust-unofficial/awesome-rust/blob/master/https://blog.thoughtram.io/announcements/tools/2014/09/18/announcing-clog-a-conventional-changelog-generator-for-the-rest-of-us.html)) [<img src="https://api.travis-ci.org/clog-tool/clog-cli.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/clog-tool/clog-cli)
...
* Webpack
  * [Ralvke/rust-loader](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/Ralvke/rust-loader) — Webpack Rust loader (https://github.com/rust-unofficial/awesome-rust/blob/master/wasm)
...
* Docker
  ...
  * [liuchong/docker-rustup](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/liuchong/docker-rustup) — a multiple version (https://github.com/rust-unofficial/awesome-rust/blob/master/with musl tools) Rust Docker image
...
See also [Foreign Function Interface](https://github.com/rust-unofficial/awesome-rust/blob/master/https://doc.rust-lang.org/book/first-edition/ffi.html),  [The Rust FFI Omnibus](https://github.com/rust-unofficial/awesome-rust/blob/master/http://jakegoulding.com/rust-ffi-omnibus/) (https://github.com/rust-unofficial/awesome-rust/blob/master/a collection of examples of using code written in Rust from other languages) and [FFI examples written in Rust](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/alexcrichton/rust-ffi-examples).
...
See also [Are we (I)DE yet?](https://areweideyet.com/) and [Rust Tools](https://www.rust-lang.org/tools).
  ...
  * [Emacs](https://www.gnu.org/software/emacs/)
    ...
    * [emacs-racer](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/racer-rust/emacs-racer) — Autocompletion (https://github.com/rust-unofficial/awesome-rust/blob/master/see also [company](https://github.com/rust-unofficial/awesome-rust/blob/master/https://company-mode.github.io) and [auto-complete](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/auto-complete/auto-complete))
  ...
  * [Sublime Text](https://www.sublimetext.com/)
    ...
    * [sublimehq/packages](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/sublimehq/Packages/tree/master/Rust) — native Sublime support (https://github.com/rust-unofficial/awesome-rust/blob/master/already installed)
  ...
  * [Visual Studio Code](https://code.visualstudio.com/)
    ...
    * [saviorisdead/RustyCode](https://github.com/rust-unofficial/awesome-rust/blob/master/https://marketplace.visualstudio.com/items?itemName=saviorisdead.RustyCode) (https://github.com/rust-unofficial/awesome-rust/blob/master/unmaintained)
...
* [llogiq/mutagen](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/llogiq/mutagen) [[mutagen](https://github.com/rust-unofficial/awesome-rust/blob/master/https://crates.io/crates/mutagen)] — A source-level mutation testing framework (https://github.com/rust-unofficial/awesome-rust/blob/master/nightly only) [<img src="https://api.travis-ci.org/llogiq/mutagen.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/llogiq/mutagen)
...
* [innoave/genevo](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/innoave/genevo) — Execute genetic algorithm (https://github.com/rust-unofficial/awesome-rust/blob/master/GA) simulations in a customizable and extensible way.
* [willi-kappler/darwin-rs](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/willi-kappler/darwin-rs) — This library allows you to write evolutionary algorithms (https://github.com/rust-unofficial/awesome-rust/blob/master/EA) using the Rust programming language. Written by Willi Kappler, License: MIT — Version 0.4 (https://github.com/rust-unofficial/awesome-rust/blob/master/2017.06.26).
...
* [avinashshenoy97/RusticSOM](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/avinashshenoy97/RusticSOM) — Rust library for Self Organising Maps (https://github.com/rust-unofficial/awesome-rust/blob/master/SOM). [![Build Status](https://github.com/rust-unofficial/awesome-rust/blob/master/https://api.travis-ci.org/avinashshenoy97/RusticSOM.svg?branch=master)](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/avinashshenoy97/RusticSOM)
* [autumnai/leaf](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/autumnai/leaf) — Open Machine Intelligence framework. [![Build Status](https://github.com/rust-unofficial/awesome-rust/blob/master/https://api.travis-ci.org/autumnai/leaf.svg?branch=master)](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/autumnai/leaf). Abandoned project. The most updated fork is [spearow/juice](https://github.com/rust-unofficial/awesome-rust/blob/master/ https://github.com/spearow/juice).
...
* [JulianSchmid/dlt_parse](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/JulianSchmid/dlt-parse-rs) - Rust DLT (https://github.com/rust-unofficial/awesome-rust/blob/master/Diagnostic Log and Trace) packet parser [<img src="https://api.travis-ci.org/JulianSchmid/dlt-parse-rs.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/JulianSchmid/dlt-parse-rs)
* [JulianSchmid/someip_parse](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/JulianSchmid/someip-parse-rs) [[someip_parse](https://github.com/rust-unofficial/awesome-rust/blob/master/https://crates.io/crates/someip_parse)] - A library for parsing the SOME/IP network protocol (https://github.com/rust-unofficial/awesome-rust/blob/master/without payload interpretation) [<img src="https://api.travis-ci.org/JulianSchmid/someip-parse-rs.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/JulianSchmid/someip-parse-rs)
...
* Style
  ...
  * [vitiral/termstyle](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/vitiral/termstyle) [[termstyle](https://github.com/rust-unofficial/awesome-rust/blob/master/https://docs.rs/termstyle/0.1.2/termstyle/)] — build (https://github.com/rust-unofficial/awesome-rust/blob/master/and test) formatted and styled command line applications
...
* [mehcode/config-rs](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/mehcode/config-rs) [[config](https://github.com/rust-unofficial/awesome-rust/blob/master/https://crates.io/crates/config)] — Layered configuration system for Rust applications (https://github.com/rust-unofficial/awesome-rust/blob/master/with strong support for 12-factor applications). [<img src="https://api.travis-ci.org/mehcode/config-rs.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/mehcode/config-rs)
...
* [kornelski/rust-security-framework](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/kornelski/rust-security-framework) — Bindings for Security Framework (https://github.com/rust-unofficial/awesome-rust/blob/master/OSX native crypto)
* [steffengy/schannel-rs](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/steffengy/schannel-rs) — Bindings for Schannel (https://github.com/rust-unofficial/awesome-rust/blob/master/Windows native TLS)
* [zebradil/rustotpony](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/zebradil/rustotpony) — CLI manager of one-time password generators aka Google Authenticator (https://github.com/rust-unofficial/awesome-rust/blob/master/TOTP)
...
* [GildedHonour/atarashii_imap](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/GildedHonour/atarashii_imap) — 新しい (https://github.com/rust-unofficial/awesome-rust/blob/master/atarashii/new) IMAP client in Rust. It supports plain and secure connections [<img src="https://api.travis-ci.org/GildedHonour/atarashii_imap.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/GildedHonour/atarashii_imap)
...
* ASN.1
  * [alex/rust-asn1](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/alex/rust-asn1) — a Rust ASN.1 (https://github.com/rust-unofficial/awesome-rust/blob/master/DER) serializer [<img src="https://api.travis-ci.org/alex/rust-asn1.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/alex/rust-asn1)
* Bencode
...
* [FlatBuffers](https://google.github.io/flatbuffers/)
  * [frol/flatc-rust](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/frol/flatc-rust) — FlatBuffers compiler (https://github.com/rust-unofficial/awesome-rust/blob/master/flatc) integration for Cargo build scripts [<img src="https://api.travis-ci.org/frol/flatc-rust.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/frol/flatc-rust)
* HAR
  * [mandrean/har-rs](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/mandrean/har-rs) — A HTTP Archive Format (https://github.com/rust-unofficial/awesome-rust/blob/master/HAR) serialization & deserialization library [![Build Status](https://github.com/rust-unofficial/awesome-rust/blob/master/https://api.travis-ci.org/mandrean/har-rs.svg?branch=master)](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/mandrean/har-rs)
* HTML
...
* Game Engines
  ...
  * [Unrust](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/unrust/unrust) — unrust — A pure rust based (https://github.com/rust-unofficial/awesome-rust/blob/master/webgl 2.0 / native) game engine
...
* [DaveKram/coord_transforms](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/DaveKram/coord_transforms) [[coord_transforms](https://github.com/rust-unofficial/awesome-rust/blob/master/https://crates.io/crates/coord_transforms)] — coordinate transformations (https://github.com/rust-unofficial/awesome-rust/blob/master/2-d, 3-d, and geospatial) [<img src="https://api.travis-ci.org/DaveKram/coord_transforms.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/DaveKram/coord_transforms)
...
* uTP
  * [meqif/rust-utp](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/meqif/rust-utp) — a [uTP](https://github.com/rust-unofficial/awesome-rust/blob/master/http://www.bittorrent.org/beps/bep_0029.html) (https://github.com/rust-unofficial/awesome-rust/blob/master/Micro Transport Protocol) library for Rust. [<img src="https://api.travis-ci.org/meqif/rust-utp.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/meqif/rust-utp)
* ZeroMQ
...
* CoAP
  * [Covertness/coap-rs](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/Covertness/coap-rs) — A [Constrained Application Protocol(https://github.com/rust-unofficial/awesome-rust/blob/master/CoAP)](https://github.com/rust-unofficial/awesome-rust/blob/master/https://tools.ietf.org/html/rfc7252) library for Rust. [<img src="https://api.travis-ci.org/Covertness/coap-rs.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/Covertness/coap-rs)
...
### Parser
  ...
  * [kevinmehall/rust-peg](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/kevinmehall/rust-peg) — Parsing Expression Grammar (https://github.com/rust-unofficial/awesome-rust/blob/master/PEG) parser generator
  ...
  * [ptal/oak](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/ptal/oak) — a typed PEG parser generator (https://github.com/rust-unofficial/awesome-rust/blob/master/compiler plugin)
...
* Linux
  * [frol/cgroups-fs](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/frol/cgroups-fs) — Rust bindings to Linux Control Groups (https://github.com/rust-unofficial/awesome-rust/blob/master/cgroups) [<img src="https://api.travis-ci.org/frol/cgroups-fs.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/frol/cgroups-fs)
  * [pop-os/dbus-udisks2](https://github.com/pop-os/dbus-udisks2) — UDisks2 DBus API
...
* [BurntSushi/suffix](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/BurntSushi/suffix) — Linear time suffix array construction (https://github.com/rust-unofficial/awesome-rust/blob/master/with Unicode support) [<img src="https://api.travis-ci.org/BurntSushi/suffix.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/BurntSushi/suffix)
* [BurntSushi/tabwriter](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/BurntSushi/tabwriter) — Elastic tab stops (https://github.com/rust-unofficial/awesome-rust/blob/master/i.e., text column alignment) [<img src="https://api.travis-ci.org/BurntSushi/tabwriter.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/BurntSushi/tabwriter)
...
* [mgeisler/textwrap](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/mgeisler/textwrap) [[textwrap](https://github.com/rust-unofficial/awesome-rust/blob/master/https://crates.io/crates/textwrap)] — Word wrap text (https://github.com/rust-unofficial/awesome-rust/blob/master/with support for hyphenation) [<img src="https://api.travis-ci.org/mgeisler/textwrap.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/mgeisler/textwrap)
...
* [rust-lang/regex](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/rust-lang/regex) — Regular expressions (https://github.com/rust-unofficial/awesome-rust/blob/master/RE2 style) [<img src="https://api.travis-ci.org/rust-lang/regex.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/rust-lang/regex)
...
* HTTP Server
  ...
  * [Rocket](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/SergioBenitez/Rocket) — Rocket is web framework for Rust (https://github.com/rust-unofficial/awesome-rust/blob/master/nightly) with a focus on ease-of-use, expressability, and speed [<img src="https://api.travis-ci.org/SergioBenitez/Rocket.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/SergioBenitez/Rocket)
  ...
  * [danclive/sincere](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/danclive/sincere) — A micro web framework for Rust(https://github.com/rust-unofficial/awesome-rust/blob/master/stable) based on hyper and multithreading. [<img src="https://api.travis-ci.org/danclive/sincere.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/danclive/sincere)
...
* [WebSocket](https://datatracker.ietf.org/doc/rfc6455/)
  * [cyderize/rust-websocket](https://github.com/rust-unofficial/awesome-rust/blob/master/https://github.com/cyderize/rust-websocket) — a framework for dealing with WebSocket connections (https://github.com/rust-unofficial/awesome-rust/blob/master/both clients and servers) [<img src="https://api.travis-ci.org/cyderize/rust-websocket.svg?branch=master">](https://github.com/rust-unofficial/awesome-rust/blob/master/https://travis-ci.org/cyderize/rust-websocket)

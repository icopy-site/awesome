...
* [kadira:blaze-layout](https://github.com/Urigo/awesome-meteor/blob/master/https://github.com/kadirahq/blaze-layout) - Layout Manager for Blaze (https://github.com/Urigo/awesome-meteor/blob/master/works well with Meteor FlowRouter)
...
* [ostrio:spiderable-middleware](https://github.com/Urigo/awesome-meteor/blob/master/https://github.com/VeliovGroup/spiderable-middleware/) - Prerendering (https://github.com/Urigo/awesome-meteor/blob/master/*a.k.a. Spiderable*) with support of ES6 (https://github.com/Urigo/awesome-meteor/blob/master/ECMAScript2015) - Meteor app crawled perfectly by search engines.
...
* [netanelgilad:excel](https://github.com/Urigo/awesome-meteor/blob/master/https://github.com/netanelgilad/meteor-excel) - Parsing and generating excel files (https://github.com/Urigo/awesome-meteor/blob/master/xlsx, xls).
...
* [matteodem:easy-search](https://github.com/Urigo/awesome-meteor/blob/master/https://github.com/matteodem/meteor-easy-search) - Easy-to-use search with Blaze Components (https://github.com/Urigo/awesome-meteor/blob/master/+ Elastic Search Support)
...
* [raix:push](https://github.com/Urigo/awesome-meteor/blob/master/https://github.com/raix/push) - Push notifications for cordova (https://github.com/Urigo/awesome-meteor/blob/master/ios, android) browser (https://github.com/Urigo/awesome-meteor/blob/master/Chrome, Safari, Firefox).
...
* [okgrow:analytics](https://github.com/Urigo/awesome-meteor/blob/master/https://github.com/okgrow/analytics/) - Google Analytics, Mixpanel, KISSmetrics (https://github.com/Urigo/awesome-meteor/blob/master/and more) integration for meteor.
...
* [ostrio:cron-jobs](https://github.com/Urigo/awesome-meteor/blob/master/https://github.com/VeliovGroup/Meteor-CRON-jobs) - Package with similar API to native `setTimeout` and `setInterval` methods, but synced between all running Meteor (https://github.com/Urigo/awesome-meteor/blob/master/NodeJS) instances.
...
* [Vue](https://github.com/Urigo/awesome-meteor/blob/master/https://github.com/Akryum/meteor-vue-component) - Working with Vue and Meteor (https://github.com/Urigo/awesome-meteor/blob/master/plus single-file components & apollo support)

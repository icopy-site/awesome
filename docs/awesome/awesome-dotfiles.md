...
* [Getting started with dotfiles](https://github.com/webpro/awesome-dotfiles/blob/master/https://medium.com/@webprolific/getting-started-with-dotfiles-43c3602fd789) (https://github.com/webpro/awesome-dotfiles/blob/master/[L. Kappert](https://github.com/webpro/awesome-dotfiles/blob/master/https://github.com/webpro))
* [Getting started with dotfiles](https://github.com/webpro/awesome-dotfiles/blob/master/https://medium.com/@driesvints/getting-started-with-dotfiles-76bf046d035c) (https://github.com/webpro/awesome-dotfiles/blob/master/[D. Vints](https://github.com/webpro/awesome-dotfiles/blob/master/https://github.com/driesvints))
...
* [Setting up a new (https://github.com/webpro/awesome-dotfiles/blob/master/OS X) development machine: Part 3 - Dotfiles and custom SSH config](https://github.com/webpro/awesome-dotfiles/blob/master/https://mattstauffer.com/blog/setting-up-a-new-os-x-development-machine-part-3-dotfiles-rc-files-and-ssh-config/)
...
[oh-my-zsh](https://github.com/webpro/awesome-dotfiles/blob/master/https://ohmyz.sh) | Community-driven framework for managing your zsh configuration. | Includes 200+ optional plugins (https://github.com/webpro/awesome-dotfiles/blob/master/rails, git, OSX, hub, capistrano, brew, ant, php, python, etc), over 140 themes to spice up your morning, and an auto-update tool.
...
[antigen](https://github.com/webpro/awesome-dotfiles/blob/master/http://antigen.sharats.me) | Plugin manager for zsh, inspired by oh-my-zsh and vundle. | Antigen is a small set of functions that help you easily manage your shell (https://github.com/webpro/awesome-dotfiles/blob/master/zsh) plugins. Antigen is to zsh, what Vundle is to vim.
...
* [fresh](https://github.com/webpro/awesome-dotfiles/blob/master/https://freshshell.com) - Keep your dotfiles fresh. Fresh is a tool to source shell configuration (https://github.com/webpro/awesome-dotfiles/blob/master/aliases, functions, etc) from others into your own configuration files.
...
* [homesick](https://github.com/webpro/awesome-dotfiles/blob/master/https://github.com/technicalpickles/homesick) - Your home directory is your castle. Don't leave your dotfiles behind (https://github.com/webpro/awesome-dotfiles/blob/master/[article](https://github.com/webpro/awesome-dotfiles/blob/master/https://technicalpickles.com/posts/never-leave-your-dotfiles-behind-again-with-homesick)).
* [mackup](https://github.com/webpro/awesome-dotfiles/blob/master/https://github.com/lra/mackup) - Keep your application settings in sync (https://github.com/webpro/awesome-dotfiles/blob/master/OS X/Linux).
* [rcm](https://github.com/webpro/awesome-dotfiles/blob/master/https://github.com/thoughtbot/rcm) - rc file (https://github.com/webpro/awesome-dotfiles/blob/master/dotfile) management
* [SaltStack](https://github.com/webpro/awesome-dotfiles/blob/master/https://www.saltstack.com) - Intelligent orchestration for the software-defined data center (https://github.com/webpro/awesome-dotfiles/blob/master/[article](https://github.com/webpro/awesome-dotfiles/blob/master/https://medium.com/@rawkode/managing-dotfiles-with-saltstack-eb600867073e)).
...
To the extent possible under law, [Lars Kappert](https://www.webpro.nl) has waived all copyright and related or neighboring rights to this work.extent possible under law, [Lars Kappert](https://www.webpro.nl) has waived all copyright and related or neighboring rights to this work.
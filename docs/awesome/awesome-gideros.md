...
## Resources
*A collection of resources (https://github.com/stetso/awesome-gideros/blob/master/blog and forum entries, websites, packages etc) for Gideros*
...
[![CC0](http://mirrors.creativecommons.org/presskit/buttons/88x31/svg/cc-zero.svg)](https://creativecommons.org/publicdomain/zero/1.0/)//mirrors.creativecommons.org/presskit/buttons/88x31/svg/cc-zero.svg)](https://creativecommons.org/publicdomain/zero/1.0/)
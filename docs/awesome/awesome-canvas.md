...
* [Cloth 3D Effect](https://github.com/raphamorim/awesome-canvas/blob/master/http://gyu.que.jp/jscloth/) (https://github.com/raphamorim/awesome-canvas/blob/master/Google Chrome strongly recommended) • Thid demo renders a 3d model of Apple iPod with sphere environmental mapping technique.
...
* [Distance Field Waves](https://github.com/raphamorim/awesome-canvas/blob/master/http://www.kevs3d.co.uk/dev/shaders/distancefield3.html) [[show me the code](https://github.com/raphamorim/awesome-canvas/blob/master/https://github.com/kevinroast/webglshaders/blob/master/distancefield3.html)] • A example about GPU rendering shader experiments with procedural 3D scene generation using ray marching and distance field (https://github.com/raphamorim/awesome-canvas/blob/master/also known as 'sphere tracing') rendering techniques.
...
- [d3](https://github.com/raphamorim/awesome-canvas/blob/master/https://github.com/d3/d3) (https://github.com/raphamorim/awesome-canvas/blob/master/or D3.js) is a JavaScript library for visualizing data using web standards. D3 helps you bring data to life using SVG, Canvas and HTML.
...
The content of this project itself is licensed under the [Creative Commons Attribution 3.0 license](http://creativecommons.org/licenses/by/3.0/us/deed.en_US).he content of this project itself is licensed under the [Creative Commons Attribution 3.0 license](http://creativecommons.org/licenses/by/3.0/us/deed.en_US).
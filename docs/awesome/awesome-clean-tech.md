...
```
- [Company Name](https://github.com/nglgzz/awesome-clean-tech/blob/master/URL) | Based in | Founded Year
...
This work and all contributions to it are released into the public domain under the terms of the [CC0 1.0](https://github.com/nglgzz/awesome-clean-tech/blob/master/./LICENSE).
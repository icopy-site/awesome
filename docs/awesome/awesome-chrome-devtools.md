...
### CPU profile
- [call-trace](https://github.com/brendankenny/call-trace) - Can instrument your JS with hooks, and then generate a `.cpuprofile`  of the of the complete (https://github.com/ChromeDevTools/awesome-chrome-devtools/blob/master/non-sampled) execution. View either time or call counts.
...
- Kotlin: [chrome-reactive-kotlin](https://github.com/wendigo/chrome-reactive-kotlin) - reactive (https://github.com/ChromeDevTools/awesome-chrome-devtools/blob/master/rxjava 2.x), low-level client library in Kotlin
...
- [headless-devtools](https://github.com/cowchimp/headless-devtools) - Perform various DevTools actions from code (https://github.com/ChromeDevTools/awesome-chrome-devtools/blob/master/e.g. get CSS Coverage, JS Heap snapshot). Uses Puppeteer + frontend as lib.
...
- [devtool](https://github.com/Jam3/devtool) - Debug & profile Node.js apps with Chrome DevTools (https://github.com/ChromeDevTools/awesome-chrome-devtools/blob/master/using Electron).

...
* __[bioSyntax](http://www.bioSyntax.org/)__ - Syntax Highlighting for Computational Biology file formats (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/SAM, VCF, GTF, FASTA, PDB, etc...) in vim/less/gedit/sublime.
...
* __[Common Workflow Language](http://www.commonwl.org/)__ - a specification for describing analysis workflows and tools that are portable and scalable across a variety of software and hardware environments, from workstations to cluster, cloud, and high performance computing (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/HPC) environments.
...
* __[vcftools](https://github.com/vcftools/vcftools)__ - VCF manipulation and statistics (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/e.g. linkage disequilibrium, allele frequency, Fst).
...
* [Next-Generation Sequencing Technologies - Elaine Mardis (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/2014)](https://youtu.be/6Is3W7JkFp8) [1:34:35] - Excellent (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/technical) overview of next-generation and third-generation sequencing technologies, along with some applications in cancer research.
...
* [For all you seq... (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/PDF)](http://www.illumina.com/content/dam/illumina-marketing/documents/applications/ngs-library-prep/ForAllYouSeqMethods.pdf) (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/3456x5471) - Massive infographic by Illumina on illustrating how many sequencing techniques work. Techniques cover protein-protein interactions, RNA transcription, RNA-protein interactions, RNA low-level detection, RNA modifications, RNA structure, DNA rearrangements and markers, DNA low-level detection, epigenetics, and DNA-protein interactions. References included.

### RNA-Seq

* [Review papers on RNA-seq (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/Biostars)](https://www.biostars.org/p/52152/) - Includes lots of seminal papers on RNA-seq and analysis methods.
...
* [Leading Strand](https://www.youtube.com/user/LeadingStrand) - Keynote lectures from Cold Spring Harbor Laboratory (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/CSHL) Meetings. More on [The Leading Strand](http://theleadingstrand.cshl.edu/).
...
* [The Leek group guide to genomics papers](https://github.com/jtleek/genomicspapers/) - Expertly curated genomics papers to get up to speed on genomics, RNA-seq, statistics (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/used in genomics), software development, and more.

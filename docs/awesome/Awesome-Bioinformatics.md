...
* __[Bioconda](https://github.com/danielecook/Awesome-Bioinformatics/blob/master/https://bioconda.github.io/)__ - A channel for the [conda package manager](https://github.com/danielecook/Awesome-Bioinformatics/blob/master/http://conda.pydata.org/docs/intro.html) specializing in bioinformatics software. Includes a repository with 3000+ ready-to-install (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/with `conda install`) bioinformatics packages.
...
* __[bioSyntax](https://github.com/danielecook/Awesome-Bioinformatics/blob/master/http://www.bioSyntax.org/)__ - Syntax Highlighting for Computational Biology file formats (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/SAM, VCF, GTF, FASTA, PDB, etc...) in vim/less/gedit/sublime.
...
* __[Common Workflow Language](https://github.com/danielecook/Awesome-Bioinformatics/blob/master/http://www.commonwl.org/)__ - a specification for describing analysis workflows and tools that are portable and scalable across a variety of software and hardware environments, from workstations to cluster, cloud, and high performance computing (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/HPC) environments.
...
* __[vcftools](https://github.com/danielecook/Awesome-Bioinformatics/blob/master/https://github.com/vcftools/vcftools)__ - VCF manipulation and statistics (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/e.g. linkage disequilibrium, allele frequency, Fst).
...
* [A History Of Bioinformatics (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/In The Year 2039)](https://github.com/danielecook/Awesome-Bioinformatics/blob/master/https://www.youtube.com/watch?v=uwsjwMO-TEA) - A talk by C. Titus Brown on his take of looking back at bioinformatics from the year 2039. His notes for this talk can be found [here](https://github.com/danielecook/Awesome-Bioinformatics/blob/master/http://ivory.idyll.org/blog/2014-bosc-keynote.html).
...
* [Review papers on RNA-seq (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/Biostars)](https://github.com/danielecook/Awesome-Bioinformatics/blob/master/https://www.biostars.org/p/52152/) - Includes lots of seminal papers on RNA-seq and analysis methods.
...
* [Leading Strand](https://github.com/danielecook/Awesome-Bioinformatics/blob/master/https://www.youtube.com/user/LeadingStrand) - Keynote lectures from Cold Spring Harbor Laboratory (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/CSHL) Meetings. More on [The Leading Strand](https://github.com/danielecook/Awesome-Bioinformatics/blob/master/http://theleadingstrand.cshl.edu/).
...
* [The Leek group guide to genomics papers](https://github.com/danielecook/Awesome-Bioinformatics/blob/master/https://github.com/jtleek/genomicspapers/) - Expertly curated genomics papers to get up to speed on genomics, RNA-seq, statistics (https://github.com/danielecook/Awesome-Bioinformatics/blob/master/used in genomics), software development, and more.

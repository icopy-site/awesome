...
* [simple_bridge](https://github.com/drobakowski/awesome-erlang/blob/master/https://github.com/nitrogen/simple_bridge) - An abstraction layer providing a unified interface to popular Erlang web servers (https://github.com/drobakowski/awesome-erlang/blob/master/Cowboy, Inets, Mochiweb, Webmachine, and Yaws).
 ...
 * [Typhoon](https://github.com/drobakowski/awesome-erlang/blob/master/https://github.com/fogfish/typhoon) - Stress and load testing tool for distributed systems that simulates traffic from a test cluster toward a system-under-test (https://github.com/drobakowski/awesome-erlang/blob/master/SUT) and visualizes related latencies.
## Code Analysis
...
* [oauth2c](https://github.com/drobakowski/awesome-erlang/blob/master/https://github.com/kivra/oauth2_client) - An Erlang oAuth 2 client (https://github.com/drobakowski/awesome-erlang/blob/master/uses restc)

...
* [#postgresql on Freenode](https://github.com/dhamaniasad/awesome-postgres/blob/master/ttps://webchat.freenode.net/#postgresql) - The most popular IRC channel about Postgres on Freenode with close to 1000 users 

...
There are many axes along which one can organize such a list, such as the level of expertise of the intended audience (https://github.com/ligurio/awesome-software-quality/blob/master/from experts to the public at large) or disciplinary orientation (https://github.com/ligurio/awesome-software-quality/blob/master/computer science, mathematics, mathematical logic, etc.). Here I have chosen to classify the material by type of subject matter.
...
To the extent possible under law, [Sergey Bronnikov](https://bronevichok.ru) has
waived all copyright and related or neighboring rights to this work.ty assessments, collected in one place.
- [Awesome Falsehood](https://github.com/kdeldycke/awesome-falsehood)

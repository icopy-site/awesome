...
+ [DevOps.md](https://github.com/svaksha/Julia.jl/blob/master/DevOps.md) :: DevOps tools for infrastructure management, continuous integration (https://github.com/svaksha/Julia.jl/blob/master/CI), continuous delivery (https://github.com/svaksha/Julia.jl/blob/master/CD), package management, release engineering (https://github.com/svaksha/Julia.jl/blob/master/RE), release management (https://github.com/svaksha/Julia.jl/blob/master/RM), software configuration management (https://github.com/svaksha/Julia.jl/blob/master/SCM), Test Driven Development, Sandbox, Functional/ Unit testing,... Quality-related tools, et al..
...
+ [FileIO.md](https://github.com/svaksha/Julia.jl/blob/master/FileIO.md) :: File IO (https://github.com/svaksha/Julia.jl/blob/master/Input/Output) functionality and support for various data types and file formats.
...
+ [https://github.com/svaksha/Julia.jl/blob/master/i18n-https://github.com/svaksha/Julia.jl/blob/master/L10n.md](https://github.com/svaksha/Julia.jl/blob/master/https://github.com/svaksha/Julia.jl/blob/master/i18n-https://github.com/svaksha/Julia.jl/blob/master/L10n.md) :: Transliteration, Internationalisation (https://github.com/svaksha/Julia.jl/blob/master/i18n) and Localisation (https://github.com/svaksha/Julia.jl/blob/master/L10n)
...
+ [Publications.md](https://github.com/svaksha/Julia.jl/blob/master/Publications.md) :: Research Papers (https://github.com/svaksha/Julia.jl/blob/master/journal and conference publications).
+ [Resources.md](https://github.com/svaksha/Julia.jl/blob/master/Resources.md) :: List of commhttps://github.com/svaksha/Julia.jl/blob/master/unity resources, development links, including events, (https://github.com/svaksha/Julia.jl/blob/master/un)conferences, forums/ meetup groups, NEWS, blogs, cookbooks, cheatsheets, IJulia NoteBooks, and other useful resources.
...
**DISCLAIMER :** As a new language in the scientific computing scene it is frequently in a state of flux due to the addition of new libraries, resulting in frequent changes and page reordering. Since the **Julia.jl** repo only provides a list (https://github.com/svaksha/Julia.jl/blob/master/of links) of Julia packages out in the wild, it should not be considered an endorsment of any particular package for software quality, technical features, coding style/organization, etc...

----

## LICENSE
+ COPYRIGHT © 2012-Now [SVAKSHA](http://svaksha.com/pages/Bio), herewith dual-licensed for the data (https://github.com/svaksha/Julia.jl/blob/master/ODbL-v1.0+) and the software (https://github.com/svaksha/Julia.jl/blob/master/AGPLv3+), respectively. 

## [ODbL](https://opendatacommons.org/licenses/odbl/1-0/) and [AGPLv3](http://www.gnu.org/licenses/agpl-3.0.html)
+ The __data__ (https://github.com/svaksha/Julia.jl/blob/master/aggregated and curated decibans of knowledge resources for Julia language) in this repository (https://github.com/svaksha/Julia.jl/blob/master/`Julia.jl`) is released under the [Open Database License](https://opendatacommons.org/licenses/odbl/1-0/) (https://github.com/svaksha/Julia.jl/blob/master/https://github.com/svaksha/Julia.jl/blob/master/ODbL-v1.0). The Open Database License (https://github.com/svaksha/Julia.jl/blob/master/ODbL) grants anyone the freedom to share, create and adapt the data or database with proper __credit attribution__ as specified in the license and __offer any new work under the same terms__, and __release a public copy if using the new work for commercial purposes__.
...
+ ALL copies and forks of this work must retain the Copyright, respective Licence files for program code (https://github.com/svaksha/Julia.jl/blob/master/AGPLv3) and data (https://github.com/svaksha/Julia.jl/blob/master/ODbL) along with this permission notice in all copies or substantial portions of the new work.
...
## CONTRIBUTE
[Contributions](https://github.com/svaksha/Julia.jl/graphs/contributors) to `Julia.jl` are welcome in the form of pull requests (https://github.com/svaksha/Julia.jl/blob/master/PR). Here are some guidelines and tips on how to submit a Bug Report (https://github.com/svaksha/Julia.jl/blob/master/BR) and/or [https://github.com/svaksha/Julia.jl/blob/master/PR](https://github.com/svaksha/Julia.jl/pulls):

## Guidelines
The Julia community has [ethical guidelines](http://julialang.org/community/standards/) aimed at respecting Copyright, Licenses and attribution standards<sup>{1} and {2}</sup> which you are requested to follow while submitting materials to be listed. Additionally, if you find any material (https://github.com/svaksha/Julia.jl/blob/master/or code repos) that violates these ethical standards, please file a bug report for their removal from `Julia.jl`.
+ References :
...
1. Add your link ahttps://github.com/svaksha/Julia.jl/blob/master/s per the top-level Category page within the topic https://github.com/svaksha/Julia.jl/blob/master/sub-https://github.com/svaksha/Julia.jl/blob/master/section(https://github.com/svaksha/Julia.jl/blob/master/s), in _alphabetical order_, with notehttps://github.com/svaksha/Julia.jl/blob/master/s (https://github.com/svaksha/Julia.jl/blob/master/if any) in the markdown filehttps://github.com/svaksha/Julia.jl/blob/master/s. Before creating a new top-level tag within the variouhttps://github.com/svaksha/Julia.jl/blob/master/s categoriehttps://github.com/svaksha/Julia.jl/blob/master/s, pleahttps://github.com/svaksha/Julia.jl/blob/master/se check wikipedia or other rehttps://github.com/svaksha/Julia.jl/blob/master/sourcehttps://github.com/svaksha/Julia.jl/blob/master/s firhttps://github.com/svaksha/Julia.jl/blob/master/st. If you are unable to decide, dihttps://github.com/svaksha/Julia.jl/blob/master/scuhttps://github.com/svaksha/Julia.jl/blob/master/shttps://github.com/svaksha/Julia.jl/blob/master/s it (https://github.com/svaksha/Julia.jl/blob/master/via a BR, not a PR ;-)). 
...
3. For broken links or outdated information, submit a bug report (https://github.com/svaksha/Julia.jl/blob/master/BR), or make the necessary changes and submit a PR. Both are welcome. Please submit separate PR's for each link or change added.
...
On a scale of 1 to 5 (https://github.com/svaksha/Julia.jl/blob/master/1=lowest,..5=highest), please rank your package for,

+ `Usability` : Does the package do what it says it does? is it easy to figure out? Is the package production-ready and actively maintained (https://github.com/svaksha/Julia.jl/blob/master/issues/PRs are responded and resolved in a timely manner, and maintenance and testing is at par with Julia release cycles).

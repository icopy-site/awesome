...
+ [DevOps.md](https://github.com/svaksha/Julia.jl/blob/master/https://github.com/svaksha/Julia.jl/blob/master/DevOps.md) :: DevOps tools for infrastructure management, continuous integration (https://github.com/svaksha/Julia.jl/blob/master/CI), continuous delivery (https://github.com/svaksha/Julia.jl/blob/master/CD), package management, release engineering (https://github.com/svaksha/Julia.jl/blob/master/RE), release management (https://github.com/svaksha/Julia.jl/blob/master/RM), software configuration management (https://github.com/svaksha/Julia.jl/blob/master/SCM), Test Driven Development, Sandbox, Functional/ Unit testing,... Quality-related tools, et al..
...
+ [FileIO.md](https://github.com/svaksha/Julia.jl/blob/master/https://github.com/svaksha/Julia.jl/blob/master/FileIO.md) :: File IO (https://github.com/svaksha/Julia.jl/blob/master/Input/Output) functionality and support for various data types and file formats.
...
+ [i18n-L10n.md](https://github.com/svaksha/Julia.jl/blob/master/https://github.com/svaksha/Julia.jl/blob/master/i18n-L10n.md) :: Transliteration, Internationalisation (https://github.com/svaksha/Julia.jl/blob/master/i18n) and Localisation (https://github.com/svaksha/Julia.jl/blob/master/L10n)
...
+ [Publications.md](https://github.com/svaksha/Julia.jl/blob/master/https://github.com/svaksha/Julia.jl/blob/master/Publications.md) :: Research Papers (https://github.com/svaksha/Julia.jl/blob/master/journal and conference publications).
+ [Resources.md](https://github.com/svaksha/Julia.jl/blob/master/https://github.com/svaksha/Julia.jl/blob/master/Resources.md) :: List of community resources, development links, including events, (https://github.com/svaksha/Julia.jl/blob/master/un)conferences, forums/ meetup groups, NEWS, blogs, cookbooks, cheatsheets, IJulia NoteBooks, and other useful resources.
...
+ The __data__ (https://github.com/svaksha/Julia.jl/blob/master/aggregated and curated decibans of knowledge resources for Julia language) in this repository (https://github.com/svaksha/Julia.jl/blob/master/`Julia.jl`) is released under the [Open Database License](https://github.com/svaksha/Julia.jl/blob/master/https://opendatacommons.org/licenses/odbl/1-0/) (https://github.com/svaksha/Julia.jl/blob/master/ODbL-v1.0). The Open Database License (https://github.com/svaksha/Julia.jl/blob/master/ODbL) grants anyone the freedom to share, create and adapt the data or database with proper __credit attribution__ as specified in the license and __offer any new work under the same terms__, and __release a public copy if using the new work for commercial purposes__.
...
1. Add your link as per the top-level Category page within the topic sub-section(https://github.com/svaksha/Julia.jl/blob/master/s), in _alphabetical order_, with notes (https://github.com/svaksha/Julia.jl/blob/master/if any) in the markdown files. Before creating a new top-level tag within the various categories, please check wikipedia or other resources first. If you are unable to decide, discuss it (https://github.com/svaksha/Julia.jl/blob/master/via a BR, not a PR ;-)). 
...
+ `License` : Which software license do you use? If you dont have a license, please state `None`. pect prompt security patches?
+ `Activity` : Should a 3rd party user bother to use your library, or is it really only intended to be used by the package author? Let's say, an experimental "throw-away toy repo" whose development has now been abandoned.
+ `License` : Which software license do you use? If you dont have a license, please state `None`. License` : Which software license do you use? If you dont have a license, please state `None`. 
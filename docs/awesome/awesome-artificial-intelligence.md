# Awesome Artificial Intelligence (https://github.com/owainlewis/awesome-artificial-intelligence/blob/master/AI) [![Awesome](https://github.com/owainlewis/awesome-artificial-intelligence/blob/master/https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/owainlewis/awesome-artificial-intelligence/blob/master/https://github.com/sindresorhus/awesome)

A curated list of Artificial Intelligence (https://github.com/owainlewis/awesome-artificial-intelligence/blob/master/AI) courses, books, video lectures and papers.
...
* [Stanford Statistical Learning](https://github.com/owainlewis/awesome-artificial-intelligence/blob/master/http://online.stanford.edu/course/statistical-learning-winter-2014) - Introductory course on machine learning focusing on: linear and polynomial regression, logistic regression and linear discriminant analysis; cross-validation and the bootstrap, model selection and regularization methods (https://github.com/owainlewis/awesome-artificial-intelligence/blob/master/ridge and lasso); nonlinear models, splines and generalized additive models; tree-based methods, random forests and boosting; support-vector machines.
...
* [The Elements of Statistical Learning: Data Mining, Inference, and Prediction](https://github.com/owainlewis/awesome-artificial-intelligence/blob/master/https://web.stanford.edu/~hastie/ElemStatLearn/) - Hastie and Tibshirani cover a broad range of topics, from supervised learning (https://github.com/owainlewis/awesome-artificial-intelligence/blob/master/prediction) to unsupervised learning including neural networks, support vector machines, classification trees and boosting---the first comprehensive treatment of this topic in any book.
...
* [Deep Learning](https://github.com/owainlewis/awesome-artificial-intelligence/blob/master/http://www.iro.umontreal.ca/~bengioy/dlbook/) - Yoshua Bengio, Ian Goodfellow and Aaron Courville put together this currently free (https://github.com/owainlewis/awesome-artificial-intelligence/blob/master/and draft version) book on deep learning.  The book is kept up-to-date and covers a wide range of topics in depth (https://github.com/owainlewis/awesome-artificial-intelligence/blob/master/up to and including sequence-to-sequence learning).

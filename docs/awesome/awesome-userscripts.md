...
- [Tampermonkey](https://github.com/brunocvcunha/awesome-userscripts/blob/master/https://tampermonkey.net/) - Chrome, Microsoft Edge, Safari, Opera, Firefox (https://github.com/brunocvcunha/awesome-userscripts/blob/master/also with support for mobile Dolphin Browser and UC Browser)
...
* [Github Commit Diff](https://github.com/brunocvcunha/awesome-userscripts/blob/master/https://github.com/jerone/UserScripts/tree/master/Github_Commit_Diff#readme) - Adds button to show diff (https://github.com/brunocvcunha/awesome-userscripts/blob/master/or patch) file for commit.
...
* [GitHub Diff File Toggle](https://github.com/brunocvcunha/awesome-userscripts/blob/master/https://greasyfork.org/en/scripts/18788-github-diff-file-toggle) - Add a toggle to each diff file (https://github.com/brunocvcunha/awesome-userscripts/blob/master/shift-click toggles all files).
...
* [GitHub code show whitespace](https://github.com/brunocvcunha/awesome-userscripts/blob/master/https://github.com/Mottie/GitHub-userscripts/wiki/GitHub-code-show-whitespace) - Show whitespace (https://github.com/brunocvcunha/awesome-userscripts/blob/master/spaces/tabs/carriage returns) in files.
...
* [Github Pages Linker](https://github.com/brunocvcunha/awesome-userscripts/blob/master/https://github.com/jerone/UserScripts/tree/master/Github_Pages_Linker#readme) - Add a link to Github Pages (https://github.com/brunocvcunha/awesome-userscripts/blob/master/gh-pages) when available.
...
* [UserScripts Mirror](https://github.com/brunocvcunha/awesome-userscripts/blob/master/http://userscripts-mirror.org/) - Mirror of the original Userscripts.org repository (https://github.com/brunocvcunha/awesome-userscripts/blob/master/that is currently down).

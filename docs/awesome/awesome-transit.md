...
- [TransAM](https://github.com/CUTR-at-USF/awesome-transit/blob/master/[http://camsys.software/products/transam](https://github.com/camsys/transam_core)) - An open-source asset management platform for public transportation agencies.
...
- [1-Click](https://github.com/CUTR-at-USF/awesome-transit/blob/master/[http://camsys.software/products/1-click](https://github.com/camsys/oneclick)) - A virtual “trip aggregator” that assembles information on a wide variety of available modes: public transit, private, rail, rideshare, carpool, volunteer, paratransit, and walking and biking.
...
- [Simple Transit Map](https://github.com/CUTR-at-USF/awesome-transit/blob/master/[https://transit.chat/simple-transit-map](https://github.com/ioTransit/simple-transit-map)) - An online example of how to host and update a webmap.

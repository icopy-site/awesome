...
* [browserify](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/substack/node-browserify) - Browserify lets you require(https://github.com/sorrycc/awesome-javascript/blob/master/'modules') in the browser by bundling up all of your dependencies.
...
* [mithril.js](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/lhorie/mithril.js) - Mithril is a client-side MVC framework (https://github.com/sorrycc/awesome-javascript/blob/master/Light-weight, Robust, Fast).
...
* [Pug](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/pugjs/pug) - Robust, elegant, feature rich template engine for nodejs. (https://github.com/sorrycc/awesome-javascript/blob/master/formerly known as Jade)
...
* [fabric.js](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/kangax/fabric.js) - Javascript Canvas Library, SVG-to-Canvas (https://github.com/sorrycc/awesome-javascript/blob/master/& canvas-to-SVG) Parser.
...
* [ace](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/ajaxorg/ace) - Ace (https://github.com/sorrycc/awesome-javascript/blob/master/Ajax.org Cloud9 Editor).
...
* [pen](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/sofish/pen) - enjoy live editing (https://github.com/sorrycc/awesome-javascript/blob/master/+markdown).
...
* [jBinary](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/jDataView/jBinary) - High-level I/O (https://github.com/sorrycc/awesome-javascript/blob/master/loading, parsing, manipulating, serializing, saving) for binary files with declarative syntax for describing file types and data structures.
...
* [Bacon](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/baconjs/bacon.js) - FRP (https://github.com/sorrycc/awesome-javascript/blob/master/functional reactive programming) library for Javascript.
...
* [jquery-timeago](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/rmm5t/jquery-timeago) - A jQuery plugin that makes it easy to support automatically updating fuzzy timestamps (https://github.com/sorrycc/awesome-javascript/blob/master/e.g. "4 minutes ago").
...
* [timeago.js](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/hustcc/timeago.js) - Simple library (https://github.com/sorrycc/awesome-javascript/blob/master/less then 2kb) used to format date with `*** time ago` statement.
* [fecha](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/taylorhakes/fecha) - Lightweight date formatting and parsing (https://github.com/sorrycc/awesome-javascript/blob/master/~2KB). Meant to replace parsing and formatting functionality of moment.js.
...
* [money.js](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/josscrowcroft/money.js) - A tiny (https://github.com/sorrycc/awesome-javascript/blob/master/1kb) javascript currency conversion library, for web & nodeJS.
...
## I18n And L10n
*Localization (https://github.com/sorrycc/awesome-javascript/blob/master/l10n) and internationalization (https://github.com/sorrycc/awesome-javascript/blob/master/i18n) JavaScript libraries.*

* [i18next](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/i18next/i18next) - internationalisation (https://github.com/sorrycc/awesome-javascript/blob/master/i18n) with javascript the easy way.
...
* [ObjectEventTarget](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/gartz/ObjectEventTarget) - Provide a prototype that add support to event listeners (https://github.com/sorrycc/awesome-javascript/blob/master/with same behavior of EventTarget from DOMElements available on browsers).


## Routing

* [director](https://github.com/flatiron/director) - A tiny and isomorphic URL router for JavaScript.
* [page.js](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/visionmedia/page.js) - Micro client-side router inspired by the Express router (https://github.com/sorrycc/awesome-javascript/blob/master/~1200 bytes).
...
* [js-xss](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/leizongmin/js-xss) - Sanitize untrusted HTML (https://github.com/sorrycc/awesome-javascript/blob/master/to prevent XSS) with a configuration specified by a Whitelist.
...
* [ConvNetJS](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/karpathy/convnetjs) - Deep Learning in Javascript. Train Convolutional Neural Networks (https://github.com/sorrycc/awesome-javascript/blob/master/or ordinary ones) in your browser.
...
* [slidesJs](https://github.com/sorrycc/awesome-javascript/blob/master/http://www.slidesjs.com) - Is a ressponsive slideshow plug-in for JQuery(https://github.com/sorrycc/awesome-javascript/blob/master/1.7.1+) with features like touch and CSS3 transitions
...
* [bootstrap-datepicker](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/eternicode/bootstrap-datepicker) - A datepicker for @twitter bootstrap forked from Stefan Petre's (https://github.com/sorrycc/awesome-javascript/blob/master/of eyecon.ro), improvements by @eternicode.
* [Pikaday](https://github.com/dbushell/Pikaday) - A refreshing JavaScript Datepicker — lightweight, no dependencies, modular CSS.
* [fullcalendar](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/fullcalendar/fullcalendar) - Full-sized drag & drop event calendar (https://github.com/sorrycc/awesome-javascript/blob/master/jQuery plugin).
* [rome](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/bevacqua/rome) - A customizable date (https://github.com/sorrycc/awesome-javascript/blob/master/and time) picker. Dependency free, opt-in UI.
...
* [onepage-scroll](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/peachananr/onepage-scroll) - Create an Apple-like one page scroller website (https://github.com/sorrycc/awesome-javascript/blob/master/iPhone 5S website) with One Page Scroll plugin.
...
* [skrollr](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/Prinzhorn/skrollr) - Stand-alone parallax scrolling library for mobile (https://github.com/sorrycc/awesome-javascript/blob/master/Android + iOS) and desktop. No jQuery.
...
* [fullPage](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/alvarotrigo/fullPage.js) - A simple and easy to use plugin to create fullscreen scrolling websites (https://github.com/sorrycc/awesome-javascript/blob/master/also known as single page websites).
...
* [DataTables](https://github.com/sorrycc/awesome-javascript/blob/master/https://www.datatables.net/) - (https://github.com/sorrycc/awesome-javascript/blob/master/jQuery plug-in) It is a highly flexible tool, based upon the foundations of progressive enhancement, and will add advanced interaction controls to any HTML table.
* [Tabulator](https://github.com/sorrycc/awesome-javascript/blob/master/http://olifolkerd.github.io/tabulator/) - (https://github.com/sorrycc/awesome-javascript/blob/master/jQuery plug-in) An extremely flexible library that create tables with a range of interactive features from any JSON data source or existing HTML table.
...
* [floatThead](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/mkoryak/floatThead) - (https://github.com/sorrycc/awesome-javascript/blob/master/jQuery plug-in) lock any table's header while scrolling within the body. Works on any table and requires no custom html or css.
...
* [pica](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/nodeca/pica) - High quality image resize (https://github.com/sorrycc/awesome-javascript/blob/master/with fast Lanczos filter, implemented in pure JS).
...
* [Babel (https://github.com/sorrycc/awesome-javascript/blob/master/Formerly 6to5)](https://github.com/sorrycc/awesome-javascript/blob/master/https://github.com/babel/babel) - Turn ES6+ code into vanilla ES5 with no runtime.

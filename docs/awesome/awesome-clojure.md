...
*Utilities and libraries for (https://github.com/razum2um/awesome-clojure/blob/master/non-LP) code and project documentation*
...
## Project Management
  ...
  * [milestones](https://github.com/turbopape/milestones)lj)

...
* **You know Python.** (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/At least the basics! If you want to learn more Python, [try this](https://github.com/hangtwenty/python-is-for-lovers))
...
- [IPython and the Jupyter Notebook](http://ipython.org/). (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/FKA IPython and IPython Notebook.)
...
(https://github.com/hangtwenty/dive-into-machine-learning/blob/master/Chart inspired by a slide from [Alex Pinto's talk, "Secure Because Math: A Deep-Dive on ML-Based Monitoring"](https://www.youtube.com/watch?v=TYVCVzEJhhQ).)
...
First, download [an interview with Prof. Domingos on the _Data Skeptic_ podcast](https://dataskeptic.com/blog/episodes/https://github.com/hangtwenty/dive-into-machine-learning/blob/master/2018/the-master-algorithm) (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/2018). Prof. Domingos wrote [the paper we read earlier](http://homes.cs.washington.edu/~pedrod/papers/cacm12.pdf). You might also start reading his book, [_The Master Algorithm_ by Prof. Pedro Domingos](https://www.goodreads.com/book/show/24612233-the-master-algorithm), a clear and accessible overview of machine learning. 
...
- ClickSecurity's "data hacking" series (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/thanks [hummus](https://github.com/hummus)!)
...
* [A Gallery of Interesting IPython notebooks (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/wiki page on GitHub): Statistics, Machine Learning and Data Science](https://github.com/ipython/ipython/wiki/A-gallery-of-interesting-IPython-Notebooks#statistics-machine-learning-and-data-science)
...
* [UC Berkeley's Data 8: The Foundations of Data Science](http://data8.org/) course and the textbook [Computational and Inferential Thinking](https://www.inferentialthinking.com/) teaches critical concepts in Data Science.
    ...
    * [Prof. Michael I. Jordan](https://people.eecs.berkeley.edu/~jordan/) (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/associated with Spark) talks about the design of the course in this [video](https://youtu.be/ggq7HiDO0OU?t=1227)
* Data science courses as IPython Notebooks:
	* [Practical Data Science](http://radimrehurek.com/data_science_python/)
	* [Learn Data Science (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/an entire self-directed course!)](http://learnds.com/)
...
* Prof. Mark A. Girolami's [Machine Learning Module (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/GitHub Mirror).](https://github.com/josephmisiti/machine-learning-module) Good for people with a strong mathematics background.
...
* [Advanced Statistical Computing (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/Vanderbilt BIOS8366)](http://stronginference.com/Bios8366/lectures.html). Interactive (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/lots of IPython Notebook material)
* [Data Science (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/Harvard CS109)](http://cs109.github.io/2014/)
...
* **Essential**: [Things in Pandas I Wish I'd Had Known Earlier](http://nbviewer.jupyter.org/github/rasbt/python_reference/blob/master/tutorials/things_in_pandas.ipynb) (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/IPython Notebook)
...
* [Video series from Data School, about Pandas](https://www.youtube.com/playlist?list=PL5-da3qGB5ICCsgW1MxlZ0Hq8LL5U3u9y). "Reference guide to 30 common pandas tasks (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/plus 6 hours of supporting video)."
...
* Here are some docs I found especially helpful as I continued learning:
	...
	* [Group By (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/split, apply, and combine DataFrames)](http://pandas.pydata.org/pandas-docs/stable/groupby.html)
...
Some good cheat sheets I've come across. (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/Please [submit a Pull Request](https://github.com/hangtwenty/dive-into-machine-learning/pulls) to add other useful cheat sheets.)
...
* [Data Science Workflow: Overview and Challenges](https://cacm.acm.org/blogs/blog-cacm/169199-data-science-workflow-overview-and-challenges/fulltext) (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/read the article *and also* the comment by Joseph McCarthy)
...
* **[_Designing Data-Intensive Applications_](http://dataintensive.net)** by Martin Kleppman. (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/You can start reading it online, free, via Safari Books.) It's not specific to Machine Learning, but you can bridge that gap yourself.
...
* ["Talking Machines" #12](http://www.thetalkingmachines.com/blog/2015/6/4/the-economic-impact-of-machine-learning-and-using-the-kernel-trick-to-dig-in-to-big-data): Interviews Prof. Andrew Ng (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/from [our main course, which has its own module on big data](https://www.coursera.org/learn/machine-learning)); this episode covers some problems relevant to _high-dimensional_ data
...
* [TensorFlow](https://www.tensorflow.org/) has been a [really big deal.](https://news.ycombinator.com/item?id=10532957) People like you will do exciting things with TensorFlow. It's a framework. Frameworks can help you manage complexity. Just remember this rule of thumb: **"More data beats a cleverer algorithm"** (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/Domingos), no matter how cool your tools are. Also note, TensorFlow is not the only machine learning framework of its kind: **[Check this great, detailed comparison of TensorFlow, Torch, and Theano.](https://github.com/zer0n/deepframeworks)** See also [Newmu/Theano-Tutorials](https://github.com/Newmu/Theano-Tutorials) and  [nlintz/TensorFlow-Tutorials](https://github.com/nlintz/TensorFlow-Tutorials). See also the section on Deep Learning above.
...
* For Machine-Learning libraries that might not be on PyPI, GitHub, etc., there's [MLOSS (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/Machine Learning Open Source Software)](http://mloss.org/software/). Seems to feature many academic libraries.

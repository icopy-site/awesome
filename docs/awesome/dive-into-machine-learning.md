...
* **You know Python.** (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/At least the basics! If you want to learn more Python, [try this](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://github.com/hangtwenty/python-is-for-lovers))
...
- [IPython and the Jupyter Notebook](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://ipython.org/). (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/FKA IPython and IPython Notebook.)
...
**[Learn how to use IPython Notebook](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://opentechschool.github.io/python-data-intro/core/notebook.html) (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/5-10 minutes).** (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/You can [learn by screencast](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://www.youtube.com/watch?v=qb7FT68tcA8) instead.)

Now, follow along with this brief exercise (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/10 minutes): **[An introduction to machine learning with scikit-learn](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://scikit-learn.org/stable/tutorial/basic/tutorial.html)**. Do it in `ipython` or IPython Notebook. It'll really boost your confidence.
...
- **More data beats a cleverer algorithm.** Listen up, programmers. We like cool tools. Resist the temptation to reinvent the wheel, or to over-engineer solutions. Your starting point is to [Do the Simplest Thing that Could _Possibly_ Work](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://www.artima.com/intv/simplest3.html). Quoting Domingos: "Suppose you’ve constructed the best set of features you can, but the classifiers you’re getting are still not accurate enough. What can you do now? There are two main choices: design a better learning algorithm, or gather more data. [...] As a rule of thumb, a dumb algorithm with lots and lots of data beats a clever one with modest amounts of it. (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/After all, machine learning is all about letting data do the heavy lifting.)"
...
(https://github.com/hangtwenty/dive-into-machine-learning/blob/master/Chart inspired by a slide from [Alex Pinto's talk, "Secure Because Math: A Deep-Dive on ML-Based Monitoring"](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://www.youtube.com/watch?v=TYVCVzEJhhQ).)
...
First, download [an interview with Prof. Domingos on the _Data Skeptic_ podcast](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://dataskeptic.com/blog/episodes/2018/the-master-algorithm) (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/2018). Prof. Domingos wrote [the paper we read earlier](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://homes.cs.washington.edu/~pedrod/papers/cacm12.pdf). You might also start reading his book, [_The Master Algorithm_ by Prof. Pedro Domingos](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://www.goodreads.com/book/show/24612233-the-master-algorithm), a clear and accessible overview of machine learning. 
...
* Then, over time, you can listen to the entire podcast series (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/start from the beginning).
...
- [An example Machine Learning notebook](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://github.com/rhiever/Data-Analysis-and-Machine-Learning-Projects/blob/master/example-data-science-notebook/Example%20Machine%20Learning%20Notebook.ipynb): "let's pretend we're working for a startup that just got funded to create a smartphone app that automatically identifies species of flowers from pictures taken on the smartphone.  We've been tasked by our head of data science to create a demo machine learning model that takes four measurements from the flowers (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/sepal length, sepal width, petal length, and petal width) and identifies the species based on those measurements alone."
- ClickSecurity's "data hacking" series (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/thanks [hummus](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://github.com/hummus)!)
...
* [A Gallery of Interesting IPython notebooks (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/wiki page on GitHub): Statistics, Machine Learning and Data Science](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://github.com/ipython/ipython/wiki/A-gallery-of-interesting-IPython-Notebooks#statistics-machine-learning-and-data-science)
...
Here are some other free online courses I've seen recommended. (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/Machine Learning, Data Science, and related topics.)
...
* [UC Berkeley's Data 8: The Foundations of Data Science](http://data8.org/) course and the textbook [Computational and Inferential Thinking](https://www.inferentialthinking.com/) teaches critical concepts in Data Science.
    ...
    * [Prof. Michael I. Jordan](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://people.eecs.berkeley.edu/~jordan/) (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/associated with Spark) talks about the design of the course in this [video](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://youtu.be/ggq7HiDO0OU?t=1227)
* Data science courses as IPython Notebooks:
	* [Practical Data Science](http://radimrehurek.com/data_science_python/)
	* [Learn Data Science (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/an entire self-directed course!)](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://learnds.com/)
...
* Prof. Mark A. Girolami's [Machine Learning Module (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/GitHub Mirror).](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://github.com/josephmisiti/machine-learning-module) Good for people with a strong mathematics background.
* Surveys of Data Science courseware (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/a bit more Choose Your Own Adventure)
...
* [Advanced Statistical Computing (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/Vanderbilt BIOS8366)](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://stronginference.com/Bios8366/lectures.html). Interactive (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/lots of IPython Notebook material)
* [Data Science (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/Harvard CS109)](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://cs109.github.io/2014/)
...
* **Essential**: [Things in Pandas I Wish I'd Had Known Earlier](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://nbviewer.jupyter.org/github/rasbt/python_reference/blob/master/tutorials/things_in_pandas.ipynb) (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/IPython Notebook)
...
* [Video series from Data School, about Pandas](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://www.youtube.com/playlist?list=PL5-da3qGB5ICCsgW1MxlZ0Hq8LL5U3u9y). "Reference guide to 30 common pandas tasks (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/plus 6 hours of supporting video)."
...
* Here are some docs I found especially helpful as I continued learning:
	...
	* [Group By (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/split, apply, and combine DataFrames)](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://pandas.pydata.org/pandas-docs/stable/groupby.html)
...
Some good cheat sheets I've come across. (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/Please [submit a Pull Request](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://github.com/hangtwenty/dive-into-machine-learning/pulls) to add other useful cheat sheets.)
...
* [Data Science Workflow: Overview and Challenges](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://cacm.acm.org/blogs/blog-cacm/169199-data-science-workflow-overview-and-challenges/fulltext) (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/read the article *and also* the comment by Joseph McCarthy)
...
So you are dabbling with Machine Learning. You've got Hacking Skills. Maybe you've got some "knowledge" in Domingos' sense (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/some "Substantive Expertise" or "Domain Knowledge"). This diagram is modified slightly from Drew Conway's "Data Science Venn Diagram." It isn't a _perfect_ fit for us, but it may get the point across:
...
1. **Ask a question. Start your own study.** The ["most important thing in data science is the question"](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://github.com/DataScienceSpecialization/courses/blob/master/01_DataScientistToolbox/03_02_whatIsData/index.Rmd#the-data-is-the-second-most-important-thing) (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/[Dr. Jeff T. Leek](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://github.com/jtleek)). So start with a question. Then, find [real data](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://github.com/caesar0301/awesome-public-datasets). Analyze it. Then ...
2. **Communicate results.** When you have a novel finding, reach out for peer review.
3. **Fix issues.** Learn. Share what you learn.

And repeat. Re-phrasing this, it fits with the [scientific method](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://en.wikipedia.org/wiki/Scientific_method): formulate a question (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/or problem statement), create a hypothesis, gather data, analyze the data, and communicate results. (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/You should [watch this video about the scientific method in data science](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://101.datascience.community/2012/06/27/the-data-scientific-method/), and/or [read this article](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://customerthink.com/getting-insights-using-data-science-skills-and-the-scientific-method/).)
...
Whenever you apply Machine Learning to solve a problem, you are going to be working in some specific problem domain. To get good results, you or your team will need "substantive expertise" AKA "domain knowledge." Learn what you can, for yourself... But you should also **collaborate.** You'll have better results if you collaborate with domain experts. (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/What's a domain expert? See the [Wikipedia entry](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://en.wikipedia.org/wiki/Subject-matter_expert), or [c2 wiki's rather subjective but useful blurb](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://wiki.c2.com/?DomainExpert).)

### :bow: A note about Machine Learning and User Experience (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/UX)
...
### :bow: A note about Machine Learning and Security (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/InfoSec, AppSec)
...
* [Quora: "What are the best ways to pick up Deep Learning skills as an engineer?"](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://www.quora.com/What-are-the-best-ways-to-pick-up-Deep-Learning-skills-as-an-engineer) — answered by Greg Brockman (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/Co-Founder & CTO at OpenAI, previously CTO at Stripe)
...
* **[_Designing Data-Intensive Applications_](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://dataintensive.net)** by Martin Kleppman. (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/You can start reading it online, free, via Safari Books.) It's not specific to Machine Learning, but you can bridge that gap yourself.

Lastly, here are some other useful links regarding Big Data and ML.

* [10 things statistics taught us about big data analysis](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://simplystatistics.org/2014/05/22/10-things-statistics-taught-us-about-big-data-analysis/) (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/and some more food for thought: ["What Statisticians think about Data Scientists"](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://www.datasciencecentral.com/profiles/blogs/what-statisticians-think-about-data-scientists))
* ["Talking Machines" #12](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://www.thetalkingmachines.com/blog/2015/6/4/the-economic-impact-of-machine-learning-and-using-the-kernel-trick-to-dig-in-to-big-data): Interviews Prof. Andrew Ng (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/from [our main course, which has its own module on big data](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://www.coursera.org/learn/machine-learning)); this episode covers some problems relevant to _high-dimensional_ data
...
* [TensorFlow](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://www.tensorflow.org/) has been a [really big deal.](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://news.ycombinator.com/item?id=10532957) People like you will do exciting things with TensorFlow. It's a framework. Frameworks can help you manage complexity. Just remember this rule of thumb: **"More data beats a cleverer algorithm"** (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/Domingos), no matter how cool your tools are. Also note, TensorFlow is not the only machine learning framework of its kind: **[Check this great, detailed comparison of TensorFlow, Torch, and Theano.](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://github.com/zer0n/deepframeworks)** See also [Newmu/Theano-Tutorials](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://github.com/Newmu/Theano-Tutorials) and  [nlintz/TensorFlow-Tutorials](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://github.com/nlintz/TensorFlow-Tutorials). See also the section on Deep Learning above.
...
* For Machine-Learning libraries that might not be on PyPI, GitHub, etc., there's [MLOSS (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/Machine Learning Open Source Software)](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/http://mloss.org/software/). Seems to feature many academic libraries.
...
* ["How would your curriculum for a machine learning beginner look like?"](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://sebastianraschka.com/faq/docs/ml-curriculum.html) by Sebastian Raschka. A selection of the core online courses and books for getting started with machine learning and gaining expert knowledge. It contextualizes Raschka's own book, [_Python Machine Learning_](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://github.com/rasbt/python-machine-learning-book) (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/which I would have linked to anyway!) See also [`pattern_classification` GitHub repository](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://github.com/rasbt/pattern_classification) maintained by the author, which contains IPython notebooks about various machine learning algorithms and various data science related resources.
...
* [Example Machine Learning notebook, exercise, and guide](https://github.com/hangtwenty/dive-into-machine-learning/blob/master/https://github.com/rhiever/Data-Analysis-and-Machine-Learning-Projects/blob/master/example-data-science-notebook/Example%20Machine%20Learning%20Notebook.ipynb) by Dr. Randal S. Olson. Mentioned in Notebooks section as well, but it has a similar goal to this guide (https://github.com/hangtwenty/dive-into-machine-learning/blob/master/introduce you, and show you where to go next). Rich "Further Reading" section.
...
* [Your guide here] check out [Sam DeBrule's list](https://machinelearnings.co/a-humans-guide-to-machine-learning-e179f43b67a0) here.
* [Distill](https://distill.pub/about/) is a journal devoted to clear and interactive explanations of the lastest research in machine learning. They offer an alternative to traditional academic publishing that promotes accessibility and transparency in the field.
* [Your guide here] check out [Sam DeBrule's list](https://machinelearnings.co/a-humans-guide-to-machine-learning-e179f43b67a0) here.
* [Distill](https://distill.pub/about/) is a journal devoted to clear and interactive explanations of the lastest research in machine learning. They offer an alternative to traditional academic publishing that promotes accessibility and transparency in the field.
* [Your guide here]
...
- [GPaste](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://github.com/Keruspe/GPaste) - Clipboard manager for GNOME (https://github.com/Kazhnuz/awesome-gnome/blob/master/composed of an applicaiton and an extension).
...
- [Oomox](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://github.com/themix-project/oomox) - Generates different color variations of Numix and Materia themes (https://github.com/Kazhnuz/awesome-gnome/blob/master/GTK2, GTK3), Gnome-Colors and Archdroid icons, and matching terminal colorschemes for them.

### Adwaita-based

- [Minwaita](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://github.com/godlyranchdressing/Minwaita) - Compact fork of Adwaita. (https://github.com/Kazhnuz/awesome-gnome/blob/master/GTK, Shell)
- [Adwaita Tweaks](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://github.com/Jazqa/adwaita-tweaks) - Compact version of Adwaita, more faithful than minwaita but less compact. (https://github.com/Kazhnuz/awesome-gnome/blob/master/GTK, Shell)

### Material

- [Materia](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://github.com/nana-4/materia-theme) - Material Design-like theme for GNOME/GTK+ based desktop environments. (https://github.com/Kazhnuz/awesome-gnome/blob/master/GTK, Shell)
- [Adapta](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://github.com/adapta-project/adapta-gtk-theme) - Adaptive GTK+ theme based on Material Design Guidelines. (https://github.com/Kazhnuz/awesome-gnome/blob/master/GTK, Shell)
- [Vimix](https://github.com/vinceliuice/vimix-gtk-themes) - A flat Material Design theme for GTK 3, GTK 2 and Gnome-Shell.

### Flat

- [Arc](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://github.com/NicoHood/arc-theme) - Flat theme with transparent elements. (https://github.com/Kazhnuz/awesome-gnome/blob/master/GTK, Shell)
- [Pop](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://github.com/system76/pop-gtk-theme/) - Official theme of Pop!_OS by System76, using a two-color blue and orange scheme. (https://github.com/Kazhnuz/awesome-gnome/blob/master/GTK, Shell)
- [United](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://github.com/godlyranchdressing/United-GNOME/) - Unity8-inspired theme for GNOME. (https://github.com/Kazhnuz/awesome-gnome/blob/master/GTK, Shell)
- [Numix](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://github.com/numixproject/numix-gtk-theme) - Popular flat semi-dark theme with an orange touch. (https://github.com/Kazhnuz/awesome-gnome/blob/master/GTK)
- [Zukitre](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://github.com/lassekongo83/zuki-themes) - Flat grey theme, part of the zuki-theme suite. (https://github.com/Kazhnuz/awesome-gnome/blob/master/GTK, works with Zuki-Shell for the shell theme)
- [Yaru](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://github.com/ubuntu/yaru) - Ubuntu community theme (https://github.com/Kazhnuz/awesome-gnome/blob/master/GTK, Shell)

### Metallic

- [Greybird](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://github.com/shimmerproject/Greybird/) - Official Xubuntu theme. (https://github.com/Kazhnuz/awesome-gnome/blob/master/GTK)
- [Vertex](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://github.com/horst3180/Vertex-theme) - Metallic theme created by horst3180, the creator of Arc. (https://github.com/Kazhnuz/awesome-gnome/blob/master/GTK, Shell)
- [GNOME OSC](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://github.com/paullinuxthemer/gnome-osc-themes) - Theme that mimics the look and feel of macOS. (https://github.com/Kazhnuz/awesome-gnome/blob/master/GTK, Shell)
- [Zukitwo](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://github.com/lassekongo83/zuki-themes) - Skeumorphic grey theme, part of the zuki-theme suite. (https://github.com/Kazhnuz/awesome-gnome/blob/master/GTK, works with Zuki-Shell for the shell theme).
...
### Cursors
 - [ComixCursors](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://www.gnome-look.org/p/999996/) - X11 mouse theme with a comics feeling. Available in six colors and three variants (https://github.com/Kazhnuz/awesome-gnome/blob/master/regular, slim and opaque).
...
- [`#gnome` on GIMPNet](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://kiwiirc.com/client/irc.gnome.org#gnome) - General-purpose GNOME IRC channel (https://github.com/Kazhnuz/awesome-gnome/blob/master/[complete list of channels](https://github.com/Kazhnuz/awesome-gnome/blob/master/https://wiki.gnome.org/Community/GettingInTouch/IRC))

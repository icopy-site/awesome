...
* [terraform-aws-key-pair](https://github.com/shuaibiyy/awesome-terraform/blob/master/https://github.com/cloudposse/terraform-aws-key-pair) - Automatically Generate SSH Key Pairs (https://github.com/shuaibiyy/awesome-terraform/blob/master/Public/Private Keys).
...
* [tf_aws_vpc_only](https://github.com/shuaibiyy/awesome-terraform/blob/master/https://github.com/terraform-community-modules/tf_aws_vpc_only) - Provides only VPC (https://github.com/shuaibiyy/awesome-terraform/blob/master/without subnets) in AWS.
...
* [terrafile](https://github.com/shuaibiyy/awesome-terraform/blob/master/https://github.com/coretech/terrafile) - Systematically manage external modules from Github for use in Terraform (https://github.com/shuaibiyy/awesome-terraform/blob/master/written in Go).
* [terrafile](https://github.com/shuaibiyy/awesome-terraform/blob/master/https://github.com/dxw/terrafile) - Systematically manage external modules from Github for use in Terraform (https://github.com/shuaibiyy/awesome-terraform/blob/master/written in Ruby).
...
* [How to Build Reusable, Composable, Battle tested Terraform Modules](https://github.com/shuaibiyy/awesome-terraform/blob/master/https://www.youtube.com/watch?v=LVgP63BkhKQ) - Yevgeniy Brikman talks about how to write Terraform code so that it is reusable, composable and testable. The presentation focuses on Terraform modules, but also provides a brief and clear explanation of what problem Terraform was created to solve and a short demo of Terraform basics (https://github.com/shuaibiyy/awesome-terraform/blob/master/~39 min, October 2017)

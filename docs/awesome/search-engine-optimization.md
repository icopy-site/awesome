...
A helpful checklist / collection of Search Engine Optimization (https://github.com/marcobiedermann/search-engine-optimization/blob/master/SEO) tips and techniques.

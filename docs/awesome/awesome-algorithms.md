...
* [Algorithm Visualizer](https://github.com/tayllan/awesome-algorithms/blob/master/http://algo-visualizer.jasonpark.me/) - Dozens of animated algorithms (https://github.com/tayllan/awesome-algorithms/blob/master/with code), and you can also create your own.
...
* [Code-Drills](https://github.com/tayllan/awesome-algorithms/blob/master/https://code-drills.com/tools/comparator) - Practice problems recommender (https://github.com/tayllan/awesome-algorithms/blob/master/includes Codeforces, Codechef and Spoj).
...
* [LavidaOnlineJudge](https://github.com/tayllan/awesome-algorithms/blob/master/http://judge.lavida.us) - Korean Online Judge(https://github.com/tayllan/awesome-algorithms/blob/master/Half English). 1300+ problems.
...
* [ProjectEuler](https://github.com/tayllan/awesome-algorithms/blob/master/https://projecteuler.net/) - Mathematical problems that can be solved using algorithms (https://github.com/tayllan/awesome-algorithms/blob/master/or just a pencil, depends on how much you already know).
...
* [Snakify](https://github.com/tayllan/awesome-algorithms/blob/master/https://snakify.org/) - An introductory Python course with 100+ algorithmic problems and a step-by-step debugger (https://github.com/tayllan/awesome-algorithms/blob/master/from Russia).
...
* [UVA](https://github.com/tayllan/awesome-algorithms/blob/master/https://uva.onlinejudge.org/) - Hundreds of problems (https://github.com/tayllan/awesome-algorithms/blob/master/from previous ACM-ICPC Regionals, World Finals and others).

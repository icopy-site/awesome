...
* [TCC](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://bellard.org/tcc/) - Tiny C Compiler; a small, fast C compiler. Supports C99 (https://github.com/aleksandar-todorovic/awesome-c/blob/master/except complex types). [`GNU LGPL2.1`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html)
...
* [libgcrypt](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://gnupg.org/related_software/libgcrypt/) - General-purpose cryptography library, with a range of available ciphers. [`GNU LGPL2.1or later (https://github.com/aleksandar-todorovic/awesome-c/blob/master/code)`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html) and [`GNU GPL2.1 or later (https://github.com/aleksandar-todorovic/awesome-c/blob/master/manual and tools)`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
...
* [GTK-Doc](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://www.gtk.org/gtk-doc/) - Tool for generating C documentation from annotated sources. Has support for the Autotools. [`GNU GPL2.1 (https://github.com/aleksandar-todorovic/awesome-c/blob/master/code)`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html) or [`GNU FDL1.1`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://www.gnu.org/licenses/old-licenses/fdl-1.1.html)
...
* [ChibiOS](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.chibios.org/dokuwiki/doku.php) - RTOS with complete development environment (https://github.com/aleksandar-todorovic/awesome-c/blob/master/HAL, drivers, support files, and tools). [`Various Licenses`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.chibios.org/dokuwiki/doku.php?id=chibios:licensing:start)
...
* [PBL](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.mission-base.com/peter/source/) - Large library of utilities, featuring data structures, among other things. [`GNU LGPL2.1 or later (https://github.com/aleksandar-todorovic/awesome-c/blob/master/library)`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html) or [`GNU GPL2.1 or later (https://github.com/aleksandar-todorovic/awesome-c/blob/master/test code)`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
* [qlibc](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://wolkykim.github.io/qlibc/) - Simple and powerful C library, designed as a replacement for GLib while focusing on being small and light. [`qLib license`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://github.com/wolkykim/qlibc/blob/master/LICENSE) (https://github.com/aleksandar-todorovic/awesome-c/blob/master/similar to [`FreeBSD`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://directory.fsf.org/wiki?title=License:FreeBSD))
...
* [libui](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://github.com/andlabs/libui) - Simple and portable (https://github.com/aleksandar-todorovic/awesome-c/blob/master/but not inflexible) GUI library. [`MIT`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://github.com/andlabs/libui/blob/master/LICENSE)
...
##### Language Standards #####
* [Draft ANSI C (https://github.com/aleksandar-todorovic/awesome-c/blob/master/C89) standard](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://port70.net/~nsz/c/c89/c89-draft.txt)
...
* [POSIX Threads Programming tutorial](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://computing.llnl.gov/tutorials/pthreads/) (https://github.com/aleksandar-todorovic/awesome-c/blob/master/a little dated, but most of it is still valid and useful)
* [The GNU C Programming Tutorial](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.crasseux.com/books/ctut.pdf) (https://github.com/aleksandar-todorovic/awesome-c/blob/master/online PDF)
...
* [Introduction to OpenMP](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://www.youtube.com/playlist?list=PLLX-Q6B8xqZ8n8bwjGdzBJ25X2utwnoEG) (https://github.com/aleksandar-todorovic/awesome-c/blob/master/video)
* [OpenMP tutorial](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://computing.llnl.gov/tutorials/openMP/) (https://github.com/aleksandar-todorovic/awesome-c/blob/master/for the OpenMP3 standard)
...
* [P99](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://p99.gforge.inria.fr/) - Suite of macros to implement advanced features like default function arguments, scope-bound resources, etc. (https://github.com/aleksandar-todorovic/awesome-c/blob/master/Requires C99) [`Q Public License`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://tldrlegal.com/license/q-public-license-1.0-(https://github.com/aleksandar-todorovic/awesome-c/blob/master/qpl-1.0)#summary)
...
* [FFMPEG](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://www.ffmpeg.org/) - Complete, cross-platform solution to record, convert and stream audio and video. [`GNU LGPL2.1 or later`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html) or [`GNU GPL2.1 or later (https://github.com/aleksandar-todorovic/awesome-c/blob/master/some parts)`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
...
* [GNU MPFR](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://www.mpfr.org/index.html) - Library for arbitrary-precision floating-point arithmetic. [`GNU LGPL3 or later`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/lgpl.html) or [`GNU LGPL2.1 or later (https://github.com/aleksandar-todorovic/awesome-c/blob/master/until version 2.4.x)`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html)
...
* [libdjb](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.fefe.de/djb/) - Collection of libraries doing various things. [`(https://github.com/aleksandar-todorovic/awesome-c/blob/master/Apparently) Public Domain`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://creativecommons.org/share-your-work/public-domain/)
...
* [libgiconv](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://www.gnu.org/software/libiconv/) - Text conversion library. [`GNU LGPL2.1 (https://github.com/aleksandar-todorovic/awesome-c/blob/master/library)`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html) or [`GNU GPL3 (https://github.com/aleksandar-todorovic/awesome-c/blob/master/*iconv* program)`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/gpl.html)
...
* [cinclude2dot](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://www.flourish.org/cinclude2dot/) - Graphs include dependencies in a C project using Graphviz. [`Any GNU GPL version (https://github.com/aleksandar-todorovic/awesome-c/blob/master/due to underspecification in the file)`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://directory.fsf.org/wiki/Cinclude2dot#tab=Details)
...
* [include-what-you-use](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://github.com/include-what-you-use/include-what-you-use) - Helps find unecessary inclusions and make suggestions for fixing them. Based on LLVM/Clang (https://github.com/aleksandar-todorovic/awesome-c/blob/master/and only works with it). [`NCSA`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://directory.fsf.org/wiki/License:NCSA)
...
* [cf4ocl](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://fakenmc.github.io/cf4ocl/) - The C Framework for OpenCL; a cross-platform object-oriented framework for developing and benchmarking  [OpenCL](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://www.khronos.org/opencl/) projects. [`GNU LGPL3 (https://github.com/aleksandar-todorovic/awesome-c/blob/master/library)`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/lgpl.html) or [`GNU GPL3 (https://github.com/aleksandar-todorovic/awesome-c/blob/master/project code)`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/gpl.html)
...
* [libimobiledevice](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://github.com/libimobiledevice/libimobiledevice) - Cross-platform protocol library to communicate with iThings. [`GNU LGPLv2.1 or later (https://github.com/aleksandar-todorovic/awesome-c/blob/master/library)`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html) or [`GNU GPL2.1 or later (https://github.com/aleksandar-todorovic/awesome-c/blob/master/tools)`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
...
* [nope.c](https://github.com/aleksandar-todorovic/awesome-c/blob/master/https://github.com/riolet/WAFer) - C-language-based, ultra-light software platform for scalable server-side and networking applications (https://github.com/aleksandar-todorovic/awesome-c/blob/master/think node.js for C programmers). [`GNU GPL2.1`](https://github.com/aleksandar-todorovic/awesome-c/blob/master/http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)

...
- [Antd Init](https://github.com/websemantics/awesome-ant-design/blob/master/https://github.com/ant-design/antd-init) - Ant Design boilerplate generator (https://github.com/websemantics/awesome-ant-design/blob/master/for demo only, use dva-cli).
...
- [Grammar of Graphics](https://github.com/websemantics/awesome-ant-design/blob/master/https://g2.alipay.com/) - Pure javascript, powerful semantic graph generation tool for big data which provides a set of graphical syntax that lets users build with simple syntax a myriad of charts and integrates a large number of statistical tools, (https://github.com/websemantics/awesome-ant-design/blob/master/[Read more](https://github.com/websemantics/awesome-ant-design/blob/master/https://github.com/antvis/feedback)).
- [Ant Visualization](https://github.com/websemantics/awesome-ant-design/blob/master/https://antv.alipay.com/) - Professional data visualization specification that aims to put several years of valuable data pattern group work in the process of exploring data visualization to share with all people who need data visualization theory. AntV consists of few parts, data, design specifications and rules for use of the chart, (https://github.com/websemantics/awesome-ant-design/blob/master/[Read more](https://github.com/websemantics/awesome-ant-design/blob/master/https://github.com/antvis/feedback)).
...
- [React Admin](https://github.com/websemantics/awesome-ant-design/blob/master/https://github.com/fireyy/react-antd-admin) - React Admin UI built on Ant Design (https://github.com/websemantics/awesome-ant-design/blob/master/username: admin, password: 123456).
- [React Redux](https://github.com/websemantics/awesome-ant-design/blob/master/https://github.com/Justin-lu/react-redux-antd) - React Redux for CMS/Enterprise class apps (https://github.com/websemantics/awesome-ant-design/blob/master/ERP/Admin) built with Ant Design.
...
- [CRA-TS-Antd](https://github.com/websemantics/awesome-ant-design/blob/master/https://github.com/comerc/cra-ts-antd) - Create-React-App + TypeScript + Ant-Design (https://github.com/websemantics/awesome-ant-design/blob/master/without Eject).
- [Ng-Alain](https://github.com/websemantics/awesome-ant-design/blob/master/https://github.com/cipchk/ng-alain) - Angular Admin UI built on Ant Design (https://github.com/websemantics/awesome-ant-design/blob/master/with ng-zorro-antd).

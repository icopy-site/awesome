...
[![All Contributors](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://img.shields.io/badge/all_contributors-43-orange.svg)](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/./CONTRIBUTORS.md)
...
The complete collection of (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/consumer) Raspberry Pi models consist of:

- Raspberry Pi 1, Model A & Model B (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/2012, discontinued)
- [Raspberry Pi 1, Model B+](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://www.raspberrypi.org/products/raspberry-pi-1-model-b-plus/) (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/July, 2014)
- [Raspberry Pi 1, Model A+](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://www.raspberrypi.org/products/raspberry-pi-1-model-a-plus/) (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/November, 2014)
- [Raspberry Pi 2, Model B](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://www.raspberrypi.org/products/raspberry-pi-2-model-b/) (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/February, 2015)
- [Raspberry Pi Zero](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://www.raspberrypi.org/products/raspberry-pi-zero/) (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/November, 2015)
- [Raspberry Pi 3, Model B](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://www.raspberrypi.org/products/raspberry-pi-3-model-b/) (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/March, 2016)
- [Raspberry Pi Zero W](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://www.raspberrypi.org/products/raspberry-pi-zero-w/) (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/February, 2017)
- [Raspberry Pi 3, Model B+](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://www.raspberrypi.org/products/raspberry-pi-3-model-b-plus/) (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/March, 2018)
- [Raspberry Pi 3, Model A+](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://www.raspberrypi.org/products/raspberry-pi-3-model-a-plus/) (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/November, 2018)
...
- [Ubuntu MATE](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://ubuntu-mate.org/raspberry-pi/) - Ubuntu distribution for the Raspberry Pi based on MATE desktop. ![Supports Raspberry Pi 2+](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-2+.png)
- [Snappy Ubuntu Core](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://developer.ubuntu.com/core/get-started/raspberry-pi-2-3) - Official (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/minimal) Ubuntu distribution for IoT. ![Supports Raspberry Pi 2+](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-2+.png)
- [Windows 10 IoT Core](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://docs.microsoft.com/nl-nl/windows/iot-core/downloads) - Windows 10 distribution for IoT. ![Supports Raspberry Pi 2+](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-2+.png)
...
- [chilipie-kiosk](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://github.com/futurice/chilipie-kiosk) - Image which boots directly into full-screen Chrome, perfect for dashboards and build monitors. ![Supports Raspberry Pi 2+](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-2+.png)
...
- [CentOS](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://wiki.centos.org/SpecialInterestGroup/AltArch/Arm32/RaspberryPi3) - CentOS on the Raspberry Pi. ![Supports Raspberry Pi 2+](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-2+.png)
- [Minibian](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://minibianpi.wordpress.com/) - Minimal Raspbian (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/lighter than Jessie Lite).
...
- [Fedora](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://fedoraproject.org/wiki/Raspberry_Pi#Preparing_the_SD_card) - Linux Fedora distribution built for the Pi. ![Supports Raspberry Pi 2+](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-2+.png)
...
- [Android Things](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://developer.android.com/things/hardware/raspberrypi.html) - Build connected devices for a wide variety of consumer, retail, and industrial applications. ![Supports Raspberry Pi 3](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-3.png)
- [Gladys Project](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://gladysproject.com/en/) - Gladys, Your home assistant. ![Supports Raspberry Pi 3](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-3.png)
- [OpenMediaVault](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://www.openmediavault.org/) - OpenMediaVault is the next generation network attached storage (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/NAS) solution based on Debian Linux containing services like SSH, (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/S)FTP, SMB/CIFS, DAAP media server, RSync, BitTorrent client and many more. ![Supports Raspberry Pi 3](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-3.png)
- [EZ-WifiBroadcast](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://github.com/bortek/EZ-WifiBroadcast/wiki) - Affordable Wireless Digital HD Video Transmission made easy. ![Supports Raspberry Pi 3](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-3.png) ![Supports Raspberry Pi Zero](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-0.png)
- [DroneBridge](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://github.com/seeul8er/DroneBridge) - A WifiBroadcast extension to make for a real alternative to DJI Lightbridge and other similar systems. ![Supports Raspberry Pi 3](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-3.png)
- [TrueOS](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://www.trueos.org/handbook/pico.html) - FreeBSD-based thin client solution. ![Supports Raspberry Pi 2+](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-2+.png)
- [OpenHABian](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://docs.openhab.org/installation/openhabian.html) - A preconfigured version of the OpenHAB home automation software. ![Supports Raspberry Pi 2+](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-2+.png)
- [FabScanPi](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://mariolukas.github.io/FabScanPi-Server/) - FabScanPi is an open source 3D laser scanner using the Raspberry Pi Camera Module. ![Supports Raspberry Pi 2+](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-2+.png)
- [Rocket Show](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://rocketshow.net) - Play synced backing tracks, videos and DMX light-sequences live on stage. ![Supports Raspberry Pi 3](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-3.png)
...
- [MoodleBox](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://moodlebox.net/) - The MoodleBox provides a Moodle learning management system on Raspberry Pi. ![Supports Raspberry Pi 3](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-3.png)
...
- [Resin Bridge](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://github.com/resin-io-playground/resin-bridge) - Simple application/repo to bridge a Raspberry Pi's wlan0 interface to devices plugged into it over ethernet (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/eth0).
...
- [HealthyPi](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://github.com/Protocentral/HealthyPi) - HAT which includes vital health monitoring like ECG, respiration, pulse oximetry and optional blood pressure & body temperature sensing. ![Supports Raspberry Pi 2+](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-2+.png)
- [PoisonTap](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://github.com/samyk/poisontap) - Exploits locked/password protected computers over USB, drops persistent WebSocket-based backdoor, exposes internal router, and siphons cookies using Raspberry Pi Zero & Node.js. ![Supports Raspberry Pi Zero](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-0.png)
- [P4wnP1](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://github.com/mame82/P4wnP1) - P4wnP1 is a highly customizable USB attack platform, based on a low cost Raspberry Pi Zero or Raspberry Pi Zero W (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/required for HID backdoor). ![Supports Raspberry Pi Zero](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-0.png)
...
- [iotwifi](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://github.com/cjimti/iotwifi) - Wifi AP + Client management in 8MB [Docker Container](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://hub.docker.com/r/cjimti/iotwifi/), with REST API for controlling wifi client and station modes simultaneously. ![Supports Raspberry Pi 3](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-3.png)
...
- [Smart Mirror](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://github.com/evancohen/smart-mirror) - Voice controlled smart mirror with IoT integration. ![Supports Raspberry Pi 2+](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-2+.png)
- [Magic Mirror](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/http://magicmirror.builders) - The original open source modular smart mirror platform. ![Supports Raspberry Pi 2+](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-2+.png)
...
- [PiFanTuner](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://github.com/winkidney/PIFanTuner) - CPU-fan-tuner daemon, just enables your fan as necessary. ![Supports Raspberry Pi 3](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-3.png)
...
- [Planning lunch with a Slackbot on resin.io](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://resin.io/blog/planning-lunch-with-a-slackbot-on-resin-io/) - Node.js Slackbot (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/lunchbot), hosted on Resin.
- [Sonus](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://github.com/evancohen/sonus) - Node.js voice control for your Pi (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/and everything else) with customizable offline hotword detection.
...
- [PiE-Ink](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/http://www.htxt.co.za/2017/02/07/pie-ink-is-a-raspberry-pi-name-tag-that-uses-an-e-ink-display/) - E-ink nametag display running on a Pi Zero. ![Supports Raspberry Pi Zero](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-0.png)
...
- [Lumos](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://www.instructables.com/id/LUMOS-Smart-Lamp-for-Better-Health/) - Smart Lamp for Better Sleep. ![Supports Raspberry Pi 3](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-3.png) ![Supports Raspberry Pi Zero](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-0.png)
...
- [Hearing aid prototoype](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://github.com/m-r-s/hearingaid-prototype) - A Raspberry Pi powered prototype of a hearing aid. ![Supports Raspberry Pi 3](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-3.png)
...
- [Bitcoin Tracker](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://github.com/jonathanrjpereira/Bitcoin-Bar) - A Physical Dashboard that displays Bitcoin stats in real time. ![Supports Raspberry Pi 3](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-3.png) ![Supports Raspberry Pi Zero](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-0.png)
...
- [Raspberry Pi Zero: Programming over USB](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/http://blog.gbaman.info/?p=791) - Guide to boot and access a Raspberry Pi Zero over a USB cable without need of an ethernet/wifi connection, keyboard or screen. ![Supports Raspberry Pi Zero](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-0.png)
...
- [Turn the Raspberry Pi Zero into a mini dongle computer](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://n-o-d-e.net/pi_zero_dongle.html) - Setup a pi0 to be able to ssh & vnc over USB. ![Supports Raspberry Pi Zero](https://github.com/thibmaek/awesome-raspberry-pi/blob/master//media/badges/rpi-0.png)
...
- [DC++ Hub](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://medium.com/@anshul.ahu/guide-to-setup-an-adc-dc-hub-on-raspberry-pi-4dbf86ca8547) - Guide to setup an ADC (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/DC++) Hub on Raspberry Pi.
- [Raspbereum](https://github.com/jim380/Raspbereum) - Run your own Ethereum node on a Raspberry Pi.

### Swift programming
- [Setup Swift environment on Raspbian](https://github.com/thibmaek/awesome-raspberry-pi/blob/master/https://swiftreviewer.com/2018/12/21/swift-programming-on-raspberry-pi-part-2-3/) - Quick guide to help setup Swift enviroment on Raspbian Strech (https://github.com/thibmaek/awesome-raspberry-pi/blob/master/lite).

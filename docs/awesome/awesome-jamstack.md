...
- [Coisas](https://github.com/automata/awesome-jamstack/blob/master/https://github.com/fiatjaf/coisas) - A client-side CMS for editing GitHub Markdown (https://github.com/automata/awesome-jamstack/blob/master/and other) files.
...
- [Lunr](https://github.com/automata/awesome-jamstack/blob/master/https://lunrjs.com/) - Search made simple (https://github.com/automata/awesome-jamstack/blob/master/on frontend).
...
- Google Cloud
  ...
  - [Cloud ML Engine](https://github.com/automata/awesome-jamstack/blob/master/https://cloud.google.com/ml-engine/) - Serverless machine learning services that automatically scales built on custom Google hardware (https://github.com/automata/awesome-jamstack/blob/master/Tensor Processing Units).

...
- [Flask-Praetorian](https://github.com/humiaozuzu/awesome-flask/blob/master/https://github.com/dusktreader/flask-praetorian) - Strong, Simple, and Precise security for Flask APIs (https://github.com/humiaozuzu/awesome-flask/blob/master/using jwt)
...
- [Authomatic](https://github.com/humiaozuzu/awesome-flask/blob/master/https://github.com/authomatic/authomatic) - Authomatic provides out of the box support for a number of providers using OAuth 1.0a (https://github.com/humiaozuzu/awesome-flask/blob/master/Twitter, Tumblr and more) and OAuth 2.0 (https://github.com/humiaozuzu/awesome-flask/blob/master/Facebook, Foursquare, GitHub, Google, LinkedIn, PayPal and more)
...
- [SQLAlchemy-Searchable](https://github.com/humiaozuzu/awesome-flask/blob/master/https://github.com/kvesteri/sqlalchemy-searchable) - Full-text searching for Flask-SQLAlchemy (https://github.com/humiaozuzu/awesome-flask/blob/master/Postgres only)
...
- [Flask-RQ](https://github.com/humiaozuzu/awesome-flask/blob/master/https://github.com/mattupstate/flask-rq) - RQ (https://github.com/humiaozuzu/awesome-flask/blob/master/Redis Queue) integration for Flask applications
...
- [Flask-CORS](https://github.com/humiaozuzu/awesome-flask/blob/master/https://github.com/corydolphin/flask-cors) - A Flask extension for handling Cross Origin Resource Sharing (https://github.com/humiaozuzu/awesome-flask/blob/master/CORS), making cross-origin AJAX possible
...
- [Domain Driven Design (https://github.com/humiaozuzu/awesome-flask/blob/master/... with Flask)](https://github.com/humiaozuzu/awesome-flask/blob/master/https://speakerdeck.com/mikedebo/domain-driven-design-dot-dot-dot-with-flask)
...
- [chat](https://github.com/humiaozuzu/awesome-flask/blob/master/https://github.com/lzyy/chat) - a live chat built with python (https://github.com/humiaozuzu/awesome-flask/blob/master/flask + gevent + apscheduler) + redis

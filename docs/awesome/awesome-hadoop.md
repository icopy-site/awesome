...
* [Apache Kylin](https://github.com/youngwookim/awesome-hadoop/blob/master/http://kylin.incubator.apache.org/) - Apache Kylin is an open source Distributed Analytics Engine from eBay Inc. that provides SQL interface and multi-dimensional analysis (https://github.com/youngwookim/awesome-hadoop/blob/master/OLAP) on Hadoop supporting extremely large datasets
...
* [Apache Phoenix](http://phoenix.apache.org) A SQL skin over HBase supporting secondary indices
* [Apache HAWQ (https://github.com/youngwookim/awesome-hadoop/blob/master/incubating)](https://github.com/youngwookim/awesome-hadoop/blob/master/http://hawq.incubator.apache.org/) - Apache HAWQ is a Hadoop native SQL query engine that combines the key technological advantages of MPP database with the scalability and convenience of Hadoop
* [Lingual](https://github.com/youngwookim/awesome-hadoop/blob/master/http://www.cascading.org/projects/lingual/) - SQL interface for Cascading (https://github.com/youngwookim/awesome-hadoop/blob/master/MR/Tez job generator)
* [Apache Impala](https://github.com/youngwookim/awesome-hadoop/blob/master/https://impala.apache.org/) - Apache Impala is an open source massively parallel processing (https://github.com/youngwookim/awesome-hadoop/blob/master/MPP) SQL query engine for data stored in a computer cluster running Apache Hadoop. Impala has been described as the open-source equivalent of Google F1, which inspired its development in 2012.
...
* [seqpig](https://github.com/youngwookim/awesome-hadoop/blob/master/http://seqpig.sourceforge.net/) - Simple and scalable scripting for large sequencing data set(https://github.com/youngwookim/awesome-hadoop/blob/master/ex: bioinfomation) in Hadoop 
* [Lipstick](https://github.com/youngwookim/awesome-hadoop/blob/master/https://github.com/Netflix/Lipstick) - Pig workflow visualization tool. [Introducing Lipstick on A(https://github.com/youngwookim/awesome-hadoop/blob/master/pache) Pig](https://github.com/youngwookim/awesome-hadoop/blob/master/http://techblog.netflix.com/2013/06/introducing-lipstick-on-apache-pig.html)
...
* [Apache Superset (https://github.com/youngwookim/awesome-hadoop/blob/master/incubating)](https://github.com/youngwookim/awesome-hadoop/blob/master/https://superset.incubator.apache.org/) - Apache Superset (https://github.com/youngwookim/awesome-hadoop/blob/master/incubating) is a modern, enterprise-ready business intelligence web application
...
* [Apache Pulsar (https://github.com/youngwookim/awesome-hadoop/blob/master/incubating)](https://github.com/youngwookim/awesome-hadoop/blob/master/http://pulsar.incubator.apache.org/) - Apache Pulsar (https://github.com/youngwookim/awesome-hadoop/blob/master/incubating) is a highly scalable, low latency messaging platform running on commodity hardware. It provides simple pub-sub semantics over topics, guaranteed at-least-once delivery of messages, automatic cursor management for subscribers, and cross-datacenter replication.
* [Apache Druid (https://github.com/youngwookim/awesome-hadoop/blob/master/incubating)](https://github.com/youngwookim/awesome-hadoop/blob/master/http://druid.incubator.apache.org/) - A high-performance, column-oriented, distributed data store.
...
* [Apache Apex (https://github.com/youngwookim/awesome-hadoop/blob/master/incubating)](https://github.com/youngwookim/awesome-hadoop/blob/master/http://apex.incubator.apache.org/) - Enterprise-grade unified stream and batch processing engine.
* [Apache Livy (https://github.com/youngwookim/awesome-hadoop/blob/master/incubating)](https://github.com/youngwookim/awesome-hadoop/blob/master/https://livy.incubator.apache.org/) - Apache Livy (https://github.com/youngwookim/awesome-hadoop/blob/master/incubating) is web service that exposes a REST interface for managing long running Apache Spark contexts in your cluster. With Livy, new applications can be built on top of Apache Spark that require fine grained interaction with many Spark contexts.
...
* [YCSB](https://github.com/youngwookim/awesome-hadoop/blob/master/https://github.com/brianfrankcooper/YCSB) - The Yahoo! Cloud Serving Benchmark (https://github.com/youngwookim/awesome-hadoop/blob/master/YCSB) is an open-source specification and program suite for evaluating retrieval and maintenance capabilities of computer programs. It is often used to compare relative performance of NoSQL database management systems.
...
* [Apache SINGA (https://github.com/youngwookim/awesome-hadoop/blob/master/incubating)](https://github.com/youngwookim/awesome-hadoop/blob/master/https://singa.incubator.apache.org/) - SINGA is a general distributed deep learning platform for training big deep learning models over large datasets
...
* [Apache Hivemall (https://github.com/youngwookim/awesome-hadoop/blob/master/incubating)](https://github.com/youngwookim/awesome-hadoop/blob/master/http://hivemall.incubator.apache.org/) - Apache Hivemall is a scalable machine learning library that runs on Apache Hive, Spark and Pig.
...
# Other Awesome Lists
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) and [awesome](https://github.com/sindresorhus/awesome) list.mmit.com/)
* [Spark Summit](https://databricks.com/sparkaisummit)

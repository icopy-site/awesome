...
* [SDKMAN](https://github.com/kdabir/awesome-groovy/blob/master/https://sdkman.io) - The Software Development Kit Manager (https://github.com/kdabir/awesome-groovy/blob/master/Previously known as GVM)
...
* [gServ](https://github.com/kdabir/awesome-groovy/blob/master/https://github.com/javaConductor/gserv) - A Groovy toolkit for creating SPAs and REST based micro-services without the need for a container (https://github.com/kdabir/awesome-groovy/blob/master/Tomcat, JBoss, etc.).
...
* [Effigy](https://github.com/kdabir/awesome-groovy/blob/master/https://github.com/cjstehno/effigy) - Groovy annotation-driven JDBC row mapping framework (https://github.com/kdabir/awesome-groovy/blob/master/abandoned)
...
* [Groovy-stream](https://github.com/kdabir/awesome-groovy/blob/master/https://github.com/timyates/groovy-stream) - A collection of classes to give a fluent builder for Streams (https://github.com/kdabir/awesome-groovy/blob/master/Lazy Groovy Generators)
...
* [spreadsheet-builder](https://github.com/kdabir/awesome-groovy/blob/master/http://spreadsheet.dsl.builders/) - Spreadsheet builder provides convenient way how to create MS Excel OfficeOpenXML Documents (https://github.com/kdabir/awesome-groovy/blob/master/XSLX)
...
To all the awesome-* repos out there and their aggreators like [this](https://github.com/erichs/awesome-awesome) and [this](https://github.com/bayandin/awesome-awesomeness).e

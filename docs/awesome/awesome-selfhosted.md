...
- [Screensy](https://github.com/screensy/screensy) - Simple peer-to-peer screen sharing solution for sharing your screen with WebRTC. ([Demo](https://github.com/awesome-selfhosted/awesome-selfhosted/blob/master/screensy.stef.link)) `GPL-3.0` `Nodejs`

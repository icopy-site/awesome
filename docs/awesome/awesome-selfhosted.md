...
- [VivumLab](https://github.com/awesome-selfhosted/awesome-selfhosted/blob/master/vivumlab.com) - An open-source data-center, owned by you, the user. VivumLab deploys web services to a server. ([Source Code](https://github.com/VivumLab/VivumLab)) `MIT` `Docker/Shell`

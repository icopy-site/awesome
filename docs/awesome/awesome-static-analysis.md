...
* [include-gardener](https://github.com/mre/awesome-static-analysis/blob/master/https://github.com/feddischson/include_gardener) - a static analyzer for C/C++/Obj-C to create a graph (https://github.com/mre/awesome-static-analysis/blob/master/in dot or graphml format) which shows all `#include` relations of a given set of files.
...
* [.NET Analyzers](https://github.com/mre/awesome-static-analysis/blob/master/https://github.com/DotNetAnalyzers) - An organization for the development of analyzers (https://github.com/mre/awesome-static-analysis/blob/master/diagnostics and code fixes) using the .NET Compiler Platform.
...
* [Gendarme](https://github.com/mre/awesome-static-analysis/blob/master/http://www.mono-project.com/docs/tools+libraries/tools/gendarme/) - Gendarme inspects programs and libraries that contain code in ECMA CIL format (https://github.com/mre/awesome-static-analysis/blob/master/Mono and .NET).
...
* [Puma Scan](https://github.com/mre/awesome-static-analysis/blob/master/https://github.com/pumasecurity/puma-scan) - Puma Scan provides real time secure code analysis for common vulnerabilities (https://github.com/mre/awesome-static-analysis/blob/master/XSS, SQLi, CSRF, LDAPi, crypto, deserialization, etc.) as development teams write code in Visual Studio.
...
* [Roslyn Security Guard](https://github.com/mre/awesome-static-analysis/blob/master/https://dotnet-security-guard.github.io/) - Project that focuses on the identification of potential vulnerabilities such as SQL injection, cross-site scripting (https://github.com/mre/awesome-static-analysis/blob/master/XSS), CSRF, cryptography weaknesses, hardcoded passwords and many more.
...
* [Wintellect.Analyzers](https://github.com/mre/awesome-static-analysis/blob/master/https://github.com/Wintellect/Wintellect.Analyzers) - .NET Compiler Platform (https://github.com/mre/awesome-static-analysis/blob/master/"Roslyn") diagnostic analyzers and code fixes.
...
* [checkstyle](https://github.com/mre/awesome-static-analysis/blob/master/https://github.com/checkstyle/checkstyle) - checking Java source code for adherence to a Code Standard or set of validation rules (https://github.com/mre/awesome-static-analysis/blob/master/best practices)
...
* [JBMC](https://github.com/mre/awesome-static-analysis/blob/master/http://www.cprover.org/jbmc/) - bounded model-checker for Java (https://github.com/mre/awesome-static-analysis/blob/master/bytecode), verifies user-defined assertions, standard assertions, several coverage metric analyses
...
* [deprecation-detector](https://github.com/mre/awesome-static-analysis/blob/master/https://github.com/sensiolabs-de/deprecation-detector) - Finds usages of deprecated (https://github.com/mre/awesome-static-analysis/blob/master/Symfony) code
...
* [Php Inspections (https://github.com/mre/awesome-static-analysis/blob/master/EA Extended)](https://github.com/mre/awesome-static-analysis/blob/master/https://github.com/kalessil/phpinspectionsea) - A Static Code Analyzer for PHP.
...
* [phpdcd](https://github.com/mre/awesome-static-analysis/blob/master/https://github.com/sebastianbergmann/phpdcd) - Dead Code Detector (https://github.com/mre/awesome-static-analysis/blob/master/DCD) for PHP code.
...
* [PHPQA](https://github.com/mre/awesome-static-analysis/blob/master/https://github.com/EdgedesignCZ/phpqa) - A tool for running QA tools (https://github.com/mre/awesome-static-analysis/blob/master/phploc, phpcpd, phpcs, pdepend, phpmd, phpmetrics)
...
* [WAP](https://github.com/mre/awesome-static-analysis/blob/master/https://www.owasp.org/index.php/OWASP_WAP-Web_Application_Protection) - Tool to detect and correct input validation vulnerabilities in PHP (https://github.com/mre/awesome-static-analysis/blob/master/4.0 or higher) web applications and predicts false positives by combining static analysis and data mining.
...
* [pycodestyle](https://github.com/mre/awesome-static-analysis/blob/master/https://github.com/PyCQA/pycodestyle) - (https://github.com/mre/awesome-static-analysis/blob/master/formerly `pep8`) check Python code against some of the style conventions in PEP 8
...
* [pylint](https://github.com/mre/awesome-static-analysis/blob/master/https://github.com/PyCQA/pylint) - looks for programming errors, helps enforcing a coding standard and sniffs for some code smells. It additionally includes `pyreverse` (https://github.com/mre/awesome-static-analysis/blob/master/an UML diagram generator) and `symilar` (https://github.com/mre/awesome-static-analysis/blob/master/a similarities checker).
...
* [SourceMeter](https://github.com/mre/awesome-static-analysis/blob/master/https://www.sourcemeter.com/resources/rpg/) :copyright: - Static Code Analysis for RPG III and RPG IV versions (https://github.com/mre/awesome-static-analysis/blob/master/including free-form)
...
* [rustfix](https://github.com/mre/awesome-static-analysis/blob/master/https://github.com/killercup/rustfix) - read and apply the suggestions made by rustc (https://github.com/mre/awesome-static-analysis/blob/master/and third-party lints, like those offered by clippy).
...
* [i-Code CNES for Shell](https://github.com/mre/awesome-static-analysis/blob/master/https://github.com/lequal/i-CodeCNES) - An open source static code analysis tool for Shell and Fortran (https://github.com/mre/awesome-static-analysis/blob/master/77 and 90).
...
* [Checkmarx](https://github.com/mre/awesome-static-analysis/blob/master/https://www.checkmarx.com/technology/supported-coding-languages/) :copyright: - Commercial Static Code Analysis which doesn't require pre-compilation. Supports: Android (https://github.com/mre/awesome-static-analysis/blob/master/Java), Apex and VisualForce, ASP, C#, C/C++, Go, Groovy, HTML5, Java, JavaScript, Node.js, Objective C, Perl, PhoneGap, PHP, Python, Ruby, Scala, Swift, VB.NET, VB6, VBScript
...
* [CodeIt.Right](https://github.com/mre/awesome-static-analysis/blob/master/https://submain.com/products/codeit.right.aspx) :copyright: - CodeIt.Right&trade; provides a fast, automated way to ensure that your source code adheres to (https://github.com/mre/awesome-static-analysis/blob/master/your) predefined design and style guidelines as well as best coding practices. Supported languages: C#, VB.NET.
...
* [Fortify](https://github.com/mre/awesome-static-analysis/blob/master/https://software.microfocus.com/en-us/products/static-code-analysis-sast/overview) :copyright: A commercial static analysis platform that supports the scanning of C/C++, C#, VB.NET, VB6, ABAP/BSP, ActionScript, Apex, ASP.NET, Classic ASP, VB Script, Cobol, ColdFusion, HTML, Java, JS, JSP, MXML/Flex, Objective-C, PHP, PL/SQL, T-SQL, Python (https://github.com/mre/awesome-static-analysis/blob/master/2.6, 2.7), Ruby (https://github.com/mre/awesome-static-analysis/blob/master/1.9.3), Swift, Scala, VB, and XML.
...
* [PVS-Studio](https://github.com/mre/awesome-static-analysis/blob/master/https://www.viva64.com/en/pvs-studio/) :copyright: - a (https://github.com/mre/awesome-static-analysis/blob/master/[conditionally free](https://github.com/mre/awesome-static-analysis/blob/master/https://www.viva64.com/en/b/0457/) for FOSS) static analysis of C/C++ and C# code. For advertising purposes [you can propose a large FOSS project for analysis by PVS employees](https://github.com/mre/awesome-static-analysis/blob/master/https://github.com/viva64/pvs-studio-check-list).
...
* [Synopsys](https://github.com/mre/awesome-static-analysis/blob/master/https://www.synopsys.com/software-integrity/security-testing/static-analysis-sast.html) :copyright: - A commercial static analysis platform that allows for scanning of multiple languages (https://github.com/mre/awesome-static-analysis/blob/master/C/C++, Android, C#, Java, JS, PHP, Python, Node.JS, Ruby, Fortran, and Swift)
...
* [DevSkim](https://github.com/mre/awesome-static-analysis/blob/master/https://github.com/Microsoft/DevSkim) - Inline, realtime security analysis. Works with multiple programming languages and IDEs (https://github.com/mre/awesome-static-analysis/blob/master/VS, VS Code, Sublime Text, ...).
* [Puma Scan](https://github.com/mre/awesome-static-analysis/blob/master/https://github.com/pumasecurity/puma-scan) - Puma Scan provides real time secure code analysis for common vulnerabilities (https://github.com/mre/awesome-static-analysis/blob/master/XSS, SQLi, CSRF, LDAPi, crypto, deserialization, etc.) as development teams write code in Visual Studio.
...
* [CodeFlow](https://github.com/mre/awesome-static-analysis/blob/master/https://www.getcodeflow.com) :copyright: - Automated code analysis tool to deal with technical depth. Integrates with Bitbucket and Gitlab. (https://github.com/mre/awesome-static-analysis/blob/master/free for Open Source Projects)
...
* [LGTM.com](https://github.com/mre/awesome-static-analysis/blob/master/https://lgtm.com/) :copyright: - Deep code analysis for GitHub and Bitbucket to find security vulnerabilities and critical code quality issues (https://github.com/mre/awesome-static-analysis/blob/master/using Semmle QL). Automatic code review for pull requests; free for public repositories.

...
* [fnuc](https://github.com/stoeffel/awesome-fp-js/blob/master/https://github.com/algesten/fnuc) – A functional library for CoffeeScript (https://github.com/stoeffel/awesome-fp-js/blob/master/and JavaScript) to facilitate functional composition and higher order functions.
* [barely-functional](https://github.com/stoeffel/awesome-fp-js/blob/master/https://github.com/cullophid/barely-functional) – A tiny (https://github.com/stoeffel/awesome-fp-js/blob/master/2.7kb) functional programming library using native ES5/6 operations.
...
* [FPO.js](https://github.com/stoeffel/awesome-fp-js/blob/master/https://github.com/getify/fpo) – FP library for JavaScript by Kyle Simpson (https://github.com/stoeffel/awesome-fp-js/blob/master/aka getify). Supports named-argument style methods.
...
* [TSTL](https://github.com/stoeffel/awesome-fp-js/blob/master/https://github.com/samchon/tstl) - C++ STL (https://github.com/stoeffel/awesome-fp-js/blob/master/Standard Template Library) is implemented in TypeScript. STL Containers, iterators, algorithms and functors, that following functional programming rule, are provided.
...
* [optics](https://github.com/stoeffel/awesome-fp-js/blob/master/https://github.com/flunc/optics) – Profunctor optics (https://github.com/stoeffel/awesome-fp-js/blob/master/Lens, Prism, iso).
* [ramda-lens](https://github.com/ramda/ramda-lens) – :ram: :mag_right: Lens library built on Ramda.
* [fantasy-lenses](https://github.com/stoeffel/awesome-fp-js/blob/master/https://github.com/fantasyland/fantasy-lenses) – Composable, immutable getters and setters. (https://github.com/stoeffel/awesome-fp-js/blob/master/Profunctor lenses WIP)
...
* [Professor Frisby’s Mostly Adequate Guide to Functional Programming](https://github.com/stoeffel/awesome-fp-js/blob/master/https://github.com/MostlyAdequate/mostly-adequate-guide) – This is a book on the functional paradigm in general using the world’s most popular functional programming language: JavaScript. It’s a practical introduction that builds up intuition through real-world examples. Strongly recommended. By [Brian Lonsdorf](https://github.com/stoeffel/awesome-fp-js/blob/master/https://twitter.com/drboolean) (https://github.com/stoeffel/awesome-fp-js/blob/master/2016)
* [Functional-Light JavaScript](https://github.com/stoeffel/awesome-fp-js/blob/master/https://github.com/getify/functional-light-js) – This book explores the core principles of functional programming (https://github.com/stoeffel/awesome-fp-js/blob/master/FP) that can be applied to JavaScript. But what makes this book different is that it approaches these principles without all the heavy terminology.
* [JavaScript Allongé](https://github.com/stoeffel/awesome-fp-js/blob/master/https://leanpub.com/javascriptallongesix), the “Six” edition. Starts with as little as possible about functions – but no less! – and builds up towards powerful combinators and decorators. A foundational book. By [Reginald  Braithwaite](https://github.com/stoeffel/awesome-fp-js/blob/master/https://github.com/raganwald) (https://github.com/stoeffel/awesome-fp-js/blob/master/2016)
* [Functional Programming in JavaScript](https://github.com/stoeffel/awesome-fp-js/blob/master/https://www.manning.com/books/functional-programming-in-javascript) teaches JavaScript developers functional techniques that will improve extensibility, modularity, reusability, testability, and performance. Through concrete examples and jargon-free explanations, this book teaches you how to apply functional programming to real-life development tasks. By Luis Atencio (https://github.com/stoeffel/awesome-fp-js/blob/master/2016)
* [Eloquent JavaScript](https://github.com/stoeffel/awesome-fp-js/blob/master/http://eloquentjavascript.net/). A modern introduction to programming using JavaScript. By Marijn Haverbeke (https://github.com/stoeffel/awesome-fp-js/blob/master/2014)
* [Functional JavaScript](https://github.com/stoeffel/awesome-fp-js/blob/master/http://shop.oreilly.com/product/0636920028857.do) teaches how to create code that’s beautiful, safe, and simple to understand and test by using JavaScript’s functional programming support. By [Michael Fogus](https://github.com/stoeffel/awesome-fp-js/blob/master/https://github.com/fogus) (https://github.com/stoeffel/awesome-fp-js/blob/master/2013)
...
* [JavaScript Programmers Should Learn Algebraic Data Types -- May 2018 -- UtahJS Lehi](https://github.com/stoeffel/awesome-fp-js/blob/master/https://www.youtube.com/watch?v=B0VoyujJWIE) - Seth House explains how ADTs (https://github.com/stoeffel/awesome-fp-js/blob/master/Algebraic Data Types) can be useful to JavaScript developers.
...
* [Hardcore Functional Programming in JavaScript](https://github.com/stoeffel/awesome-fp-js/blob/master/https://frontendmasters.com/courses/functional-javascript/) – Learn to apply techniques from the forefront of computer science research to solve practical problems in Javascript. Discover functional programming and see it demonstrated step-by-step with how to build an example web app using abstract interfaces like Monads, Functors, Monoids and Applicatives. (https://github.com/stoeffel/awesome-fp-js/blob/master/_commercial_)
...
* [Learn Rx](https://github.com/stoeffel/awesome-fp-js/blob/master/http://reactivex.io/learnrx/) – A series of interactive exercises introducing five basic ingredients of functional (https://github.com/stoeffel/awesome-fp-js/blob/master/reactive) programming: the `map`, `filter`, `concatAll`, `reduce`, and `zip` functions.

## Community

### Related Lists

* [Awesome FRP JS](https://github.com/stoeffel/awesome-fp-js/blob/master/https://github.com/stoeffel/awesome-frp-js) – A curated list of awesome (https://github.com/stoeffel/awesome-fp-js/blob/master/functional) reactive programming stuff in JavaScript.

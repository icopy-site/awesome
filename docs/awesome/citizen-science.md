...
* Ethics in research are often overseen by federal agencies or institutional review boards (https://github.com/dylanrees/citizen-science/blob/master/IRBs). Is there a bottom-up, citizen-driven alternative to this?
 ...
 * **Not familiar with GitHub?** You can leave a comment on this page by clicking on the `Issues` tab on the right and adding a New Issue (https://github.com/dylanrees/citizen-science/blob/master/that's just like a comment). You'll need to create a GitHub account first.

...
* [Kanban Board in Elm](https://github.com/isRuslan/awesome-elm/blob/master/https://github.com/huytd/kanelm) - A kanban board (https://github.com/isRuslan/awesome-elm/blob/master/trello-alike) built with Elm and HTML5 Drag & Drop API
...
* [Elm Visual Studio Code Support](https://github.com/isRuslan/awesome-elm/blob/master/https://marketplace.visualstudio.com/items?itemName=sbrink.elm) - Syntax highlighting, Snippets, Function information, REPL, Reactor support (https://github.com/isRuslan/awesome-elm/blob/master/Webserver/Debugger) - Starting/Stopping
...
* [Discourse](https://github.com/isRuslan/awesome-elm/blob/master/https://discourse.elm-lang.org/) - Elm Discourse instance (https://github.com/isRuslan/awesome-elm/blob/master/official forum).

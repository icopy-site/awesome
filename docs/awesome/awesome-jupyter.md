...
- [nbtutor](https://github.com/markusschanta/awesome-jupyter/blob/master/https://github.com/lgpage/nbtutor) - Visualize Python code execution (https://github.com/markusschanta/awesome-jupyter/blob/master/line-by-line).
...
- [notedown](https://github.com/markusschanta/awesome-jupyter/blob/master/https://github.com/aaren/notedown/) - Convert Jupyter notebooks to markdown (https://github.com/markusschanta/awesome-jupyter/blob/master/and back).
...
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/adebar/awesome-jupyter/blob/master/CONTRIBUTING.md) first.utions are always welcome! Please take a look at the [contribution guidelines](https://github.com/adebar/awesome-jupyter/blob/master/CONTRIBUTING.md) first.
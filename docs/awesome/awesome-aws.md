...
* [littlstar/s3-lambda :fire::fire::fire::fire:](https://github.com/donnemartin/awesome-aws/blob/master/https://github.com/littlstar/s3-lambda) - Lambda functions over S3 objects with concurrency control (https://github.com/donnemartin/awesome-aws/blob/master/each, map, reduce, filter).
...
* [serverless/serverless :fire::fire::fire::fire::fire:](https://github.com/donnemartin/awesome-aws/blob/master/https://github.com/serverless/serverless) The Serverless Application Framework (https://github.com/donnemartin/awesome-aws/blob/master/formerly JAWS).
...
* [littlstar/s3renity :fire::fire::fire::fire:](https://github.com/donnemartin/awesome-aws/blob/master/https://github.com/littlstar/s3renity) - Batch functions with concurrency control (https://github.com/donnemartin/awesome-aws/blob/master/each, map, reduce, filter, join)
...
* [owocki/s3_disk_util :fire:](https://github.com/donnemartin/awesome-aws/blob/master/https://github.com/owocki/s3_disk_util) - S3 Disk usage (https://github.com/donnemartin/awesome-aws/blob/master/du) utility.
...
* [dtan4/terraforming :fire::fire::fire::fire::fire:](https://github.com/donnemartin/awesome-aws/blob/master/https://github.com/dtan4/terraforming) - Export existing resources to Terraform style (https://github.com/donnemartin/awesome-aws/blob/master/tf, tfstate).
...
* [Getting Started Tutorials](http://docs.aws.amazon.com/gettingstarted/latest/awsgsg-intro/gsg-aws-tutorials.html)
    ...
    * [Host a Website (https://github.com/donnemartin/awesome-aws/blob/master/Linux)](https://github.com/donnemartin/awesome-aws/blob/master/http://docs.aws.amazon.com/gettingstarted/latest/awsgsg-intro/gsg-aws-tutorials.html#d0e2836)
    * [Host a Website (https://github.com/donnemartin/awesome-aws/blob/master/Windows)](https://github.com/donnemartin/awesome-aws/blob/master/http://docs.aws.amazon.com/gettingstarted/latest/awsgsg-intro/gsg-aws-tutorials.html#d0e2908)
...
* [Amazon Web Services (https://github.com/donnemartin/awesome-aws/blob/master/AWS) for Business](https://github.com/donnemartin/awesome-aws/blob/master/https://www.linkedin.com/grps?gid=5122002)
...
* [EC2 Container Service (https://github.com/donnemartin/awesome-aws/blob/master/ECS)](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/ecs/) - Supports Docker containers on EC2 instances.
...
* [Elastic Compute Cloud (https://github.com/donnemartin/awesome-aws/blob/master/EC2)](https://github.com/donnemartin/awesome-aws/blob/master/http://aws.amazon.com/ec2/) - Provides scalable virtual private servers using Xen.
* [Elastic GPUs](https://aws.amazon.com/ec2/Elastic-GPUs/) - Attach low-cost GPUs to EC2 instances for graphics acceleration.
* [Elastic Load Balancing (https://github.com/donnemartin/awesome-aws/blob/master/ELB)](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/elasticloadbalancing/) - Automatically distributes incoming traffic across multiple EC2 instances.
...
* [Virtual Private Cloud (https://github.com/donnemartin/awesome-aws/blob/master/VPC)](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/vpc/) - Creates a logically isolated set of EC2 instances which can be connected to an existing network using a VPN connection.
...
* [Elastic Load Balancing (https://github.com/donnemartin/awesome-aws/blob/master/ELB)](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/elasticloadbalancing/) - Automatically distributes incoming traffic across multiple EC2 instances.
* [Route 53](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/route53/) - Provides a highly available and scalable Domain Name System (https://github.com/donnemartin/awesome-aws/blob/master/DNS) web service.
* [Virtual Private Cloud (https://github.com/donnemartin/awesome-aws/blob/master/VPC)](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/vpc/) - Creates a logically isolated set of EC2 instances which can be connected to an existing network using a VPN connection.
...
* [Workspaces Application Manager (https://github.com/donnemartin/awesome-aws/blob/master/WAM)](https://github.com/donnemartin/awesome-aws/blob/master/http://aws.amazon.com/workspaces/applicationmanager/) - Simplifies deployment and management of WorkSpaces.
...
* [Elastic MapReduce (https://github.com/donnemartin/awesome-aws/blob/master/EMR)](https://github.com/donnemartin/awesome-aws/blob/master/http://aws.amazon.com/elasticmapreduce/) - Hosts a Hadoop and Spark framework running on EC2 and S3.
* [Elasticsearch Service (https://github.com/donnemartin/awesome-aws/blob/master/ES)](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/elasticsearch-service/) - Managed Elasticsearch, a popular open-source search and analytics engine.
...
* [Management Console (https://github.com/donnemartin/awesome-aws/blob/master/AWS Console)](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/console/) - A web-based interface to manage all services.
...
* [CloudHSM](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/cloudhsm/) - Helps meet corporate, contractual and regulatory compliance requirements for data security by using dedicated Hardware Security Module (https://github.com/donnemartin/awesome-aws/blob/master/HSM) appliances within the AWS cloud.
...
* [Identity and Access Management (https://github.com/donnemartin/awesome-aws/blob/master/IAM)](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/iam/) - An implicit service, the authentication infrastructure used to authenticate access to the various services.
...
* [Key Management Service (https://github.com/donnemartin/awesome-aws/blob/master/KMS)](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/kms/) - A managed service that makes it easy for you to create and control the encryption keys used to encrypt your data.
...
* [IoT](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/iot/) - Enables secure, bi-directional communication between internet-connected things (https://github.com/donnemartin/awesome-aws/blob/master/such as sensors, actuators, embedded devices, or smart appliances) and the AWS cloud over MQTT and HTTP.
...
* [Elastic Block Store (https://github.com/donnemartin/awesome-aws/blob/master/EBS)](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/ebs/) - Provides persistent block-level storage volumes for EC2.
* [Elastic File System (https://github.com/donnemartin/awesome-aws/blob/master/EFS)](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/efs/) - A file storage service for EC2 instances.
...
* [Simple Storage Service (https://github.com/donnemartin/awesome-aws/blob/master/S3)](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/s3/) - Provides Web Service based storage.
...
* [ElastiCache](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/elasticache/) - Provides in-memory caching for web apps (https://github.com/donnemartin/awesome-aws/blob/master/Memcached, Redis).
* [Redshift](https://aws.amazon.com/redshift/) - Provides petabyte-scale data warehousing with columnar storage and multi-node compute.
...
*I am providing code and resources in this repository to you under an open source license.  Because this is my personal repository, the license you receive to my code and resources is from me and not my employer (https://github.com/donnemartin/awesome-aws/blob/master/Facebook).*
    ...
    http://creativecommons.org/licenses/by/4.0/ttps://github.com/donnemartin/awesome-aws/blob/master/APN)](https://github.com/donnemartin/awesome-aws/blob/master/https://aws.amazon.com/partners/) - Provides partners with the technical information and sales and marketing support to increase business opportunities.
* [Product Advertising API](http://docs.aws.amazon.com/AWSECommerceService/latest/GSG/Welcome.html) - Provides access to product data and electronic commerce functionality.

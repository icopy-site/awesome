...
***If you see a link here that is not (https://github.com/veggiemonk/awesome-docker/blob/master/any longer) a good fit, you can fix it by submitting a [pull request][editREADME] to improve this file. Thank you!***
...
- [docker-alpine](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/gliderlabs/docker-alpine) - A super small Docker base image *(https://github.com/veggiemonk/awesome-docker/blob/master/5MB)* using Alpine Linux by [@gliderlabs][gliderlabs]
...
- [Docker Caveats](https://github.com/veggiemonk/awesome-docker/blob/master/http://docker-saigon.github.io/post/Docker-Caveats/) What You Should Know About Running Docker In Production (https://github.com/veggiemonk/awesome-docker/blob/master/written 11 APRIL 2016) __MUST SEE__

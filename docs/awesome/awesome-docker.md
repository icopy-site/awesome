...
**_If you see a link here that is not (https://github.com/veggiemonk/awesome-docker/blob/master/any longer) a good fit, you can fix it by submitting a [pull request][editreadme] to improve this file. Thank you!_**
...
- [Learn Docker](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/dwyl/learn-docker): step-by-step tutorial and more resources (https://github.com/veggiemonk/awesome-docker/blob/master/video, articles, cheat sheets) by [@dwyl](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/dwyl)
...
- [Practical Introduction to Container Terminology](https://github.com/veggiemonk/awesome-docker/blob/master/https://developers.redhat.com/blog/2018/02/22/container-terminology-practical-introduction/) The landscape for container technologies is larger than just docker. Without a good handle on the terminology, It can be difficult to grasp the key differences between docker and (https://github.com/veggiemonk/awesome-docker/blob/master/pick your favorites, CRI-O, rkt, lxc/lxd) or understand what the Open Container Initiative is doing to standardize container technology.
- [Docker Tutorial for Beginners (https://github.com/veggiemonk/awesome-docker/blob/master/Updated 2019 version)](https://github.com/veggiemonk/awesome-docker/blob/master/https://hashnode.com/post/docker-tutorial-for-beginners-cjrj2hg5001s2ufs1nker9he2) — In this Docker tutorial, you'll learn all the basics and learn how you can containerize Node.js and Go applications. Even if you aren't familiar with these languages it should be easy for you to follow this tutorial and use any other language.

**Cheatsheets** by

- [@eon01](https://github.com/eon01/DockerCheatSheet)
- [@dimonomid](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/dimonomid/docker-quick-ref) (https://github.com/veggiemonk/awesome-docker/blob/master/PDF)
...
- [Docker Compose](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/docker/compose/) (https://github.com/veggiemonk/awesome-docker/blob/master/Define and run multi-container applications with Docker)
- [Docker Machine](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/docker/machine) (https://github.com/veggiemonk/awesome-docker/blob/master/Machine management for a container-centric world)
- [Docker Registry][distribution] (https://github.com/veggiemonk/awesome-docker/blob/master/The Docker toolset to pack, ship, store, and deliver content)
- [Docker Swarm](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/docker/swarm) (https://github.com/veggiemonk/awesome-docker/blob/master/Swarm: a Docker-native clustering system)
...
- [crowdr](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/polonskiy/crowdr) - Tool for managing multiple Docker containers (https://github.com/veggiemonk/awesome-docker/blob/master/`docker-compose` alternative) by [@polonskiy](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/polonskiy/)
...
- [rocker-compose](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/grammarly/rocker-compose) :skull: - Docker composition tool with idempotency features for deploying apps composed of multiple containers. By [@grammarly](https://github.com/veggiemonk/awesome-docker/blob/master/grammarly)
...
- [Stacker](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/stacker/stacker-cli) - Docker Compose Templates. Stacker provides an abstraction layer over Docker Compose and a better DX (https://github.com/veggiemonk/awesome-docker/blob/master/developer experience).
...
- [Longshoreman](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/longshoreman/longshoreman) :skull: - Longshoreman automates application deployment using Docker. Just create a Docker repository (https://github.com/veggiemonk/awesome-docker/blob/master/or use a service), configure the cluster using AWS or Digital Ocean (https://github.com/veggiemonk/awesome-docker/blob/master/or whatever you like) and deploy applications using a Heroku-like CLI tool. By [longshoreman](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/longshoreman)
...
- [LogJam](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/gocardless/logjam) - Logjam is a log forwarder designed to listen on a local port, receive log entries over UDP, and forward these messages on to a log collection server (https://github.com/veggiemonk/awesome-docker/blob/master/such as logstash) by [@gocardless](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/gocardless)
...
- [Out-of-the-box Host/Container Monitoring/Logging/Alerting Stack](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/uschtwill/docker_monitoring_logging_alerting) - Docker host and container monitoring, logging and alerting out of the box using cAdvisor, Prometheus, Grafana for monitoring, Elasticsearch, Kibana and Logstash for logging and elastalert and Alertmanager for alerting. Set up in 5 Minutes. Secure mode for production use with built-in [Automated Nginx Reverse Proxy (https://github.com/veggiemonk/awesome-docker/blob/master/jwilder's)][nginxproxy].
- [Zabbix Docker module](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/monitoringartist/Zabbix-Docker-Monitoring) - Zabbix module that provides discovery of running containers, CPU/memory/blk IO/net container metrics. Systemd Docker and LXC execution driver is also supported. It's a dynamically linked shared object library, so its performance is (https://github.com/veggiemonk/awesome-docker/blob/master/~10x) better, than any script solution.
...
- [Weave][weave] (https://github.com/veggiemonk/awesome-docker/blob/master/The Docker network) - Weave creates a virtual network that connects Docker containers deployed across multiple hosts.
...
- [caprover](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/caprover/caprover) - [previously known as CaptainDuckDuck] Automated Scalable Webserver Package (https://github.com/veggiemonk/awesome-docker/blob/master/automated Docker+nginx) - Heroku on Steroids
...
- [Dokku](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/dokku/dokku) - Docker powered mini-Heroku that helps you build and manage the lifecycle of applications (https://github.com/veggiemonk/awesome-docker/blob/master/originally by [@progrium][progrium])
- [Empire](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/remind101/empire) - A PaaS built on top of Amazon EC2 Container Service (https://github.com/veggiemonk/awesome-docker/blob/master/ECS)
...
- [fabio](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/fabiolb/fabio) - A fast, modern, zero-conf load balancing HTTP(https://github.com/veggiemonk/awesome-docker/blob/master/S) router for deploying microservices managed by consul. By [@magiconair](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/magiconair) (https://github.com/veggiemonk/awesome-docker/blob/master/Frank Schroeder)
...
- [etcd](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/etcd-io/etcd) - Distributed reliable key-value store for the most critical data of a distributed system by [@etcd-io](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/etcd-io) (https://github.com/veggiemonk/awesome-docker/blob/master/former part of CoreOS)
- [istio](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/istio/istio) - An open platform to connect, manage, and secure microservices by [@IstioMesh](https://github.com/veggiemonk/awesome-docker/blob/master/istio)
...
- [Local Persist](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/CWSpear/local-persist) Specify a mountpoint for your local volumes (https://github.com/veggiemonk/awesome-docker/blob/master/created via `docker volume create`) so that files will always persist and so you can mount to different directories in different containers.
...
- [REX-Ray](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/rexray/rexray) provides a vendor agnostic storage orchestration engine. The primary design goal is to provide persistent storage for Docker, Kubernetes, and Mesos. By[@thecodeteam](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/thecodeteam) (https://github.com/veggiemonk/awesome-docker/blob/master/DELL Technologies)
...
- [ctop (https://github.com/veggiemonk/awesome-docker/blob/master/1)](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/yadutaf/ctop) - A command line / text based Linux Containers monitoring tool that works just like you expect (https://github.com/veggiemonk/awesome-docker/blob/master/Python) by [@yadutaf](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/yadutaf)
- [ctop (https://github.com/veggiemonk/awesome-docker/blob/master/2)](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/bcicen/ctop) - Top-like interface for container metrics (https://github.com/veggiemonk/awesome-docker/blob/master/Golang) by [@bcicen](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/bcicen/)
...
- [docker-swarm-visualizer](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/dockersamples/docker-swarm-visualizer) - Visualizes Docker services on a Docker Swarm (https://github.com/veggiemonk/awesome-docker/blob/master/for running demos).
...
- [Portus](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/SUSE/Portus) - Authorization service and frontend for Docker registry (https://github.com/veggiemonk/awesome-docker/blob/master/v2) by [@SUSE](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/SUSE)
...
- [docker-alpine](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/gliderlabs/docker-alpine) - A super small Docker base image _(https://github.com/veggiemonk/awesome-docker/blob/master/5MB)_ using Alpine Linux by [@gliderlabs][gliderlabs]
...
- [GoSu](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/tianon/gosu) - Run this specific application as this specific user and get out of the pipeline (https://github.com/veggiemonk/awesome-docker/blob/master/entrypoint script tool) by [@tianon](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/tianon)
...
- [SkinnyWhale](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/djosephsen/skinnywhale) :skull: - Skinnywhale helps you make smaller (https://github.com/veggiemonk/awesome-docker/blob/master/as in megabytes) Docker containers.
...
- [werf](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/flant/werf) - Werf (https://github.com/veggiemonk/awesome-docker/blob/master/previously known as dapp) helps to implement and support Continuous Integration and Continuous Delivery by [@flant](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/flant)
...
- [Amazon EC2 Container Registry :heavy_dollar_sign:](https://github.com/veggiemonk/awesome-docker/blob/master/https://aws.amazon.com/ecr/) - Amazon EC2 Container Registry (https://github.com/veggiemonk/awesome-docker/blob/master/ECR) is a fully-managed Docker container registry that makes it easy for developers to store, manage, and deploy Docker container images.
...
- [Harbor](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/goharbor/harbor) An open source trusted cloud native registry project that stores, signs, and scans content. Supports replication, user management, access control and activity auditing. By [CNCF](https://github.com/veggiemonk/awesome-docker/blob/master/Sandbox) formerly [VMWare](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/vmware)
...
- [Quay.io :heavy_dollar_sign:](https://github.com/veggiemonk/awesome-docker/blob/master/https://quay.io/) (https://github.com/veggiemonk/awesome-docker/blob/master/part of CoreOS) - Secure hosting for private Docker repositories
- [Rescoyl](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/noteed/rescoyl) - Private Docker registry (https://github.com/veggiemonk/awesome-docker/blob/master/free and open source) by [@noteed](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/noteed)
...
- [Docker.DotNet](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/Microsoft/Docker.DotNet) - C#/.NET HTTP client for the Docker remote API by [@ahmetalpbalkan](https://github.com/veggiemonk/awesome-docker/blob/master/ahmetalpbalkan)
...
- [Binci](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/binci/binci) - Containerize your development workflow. (https://github.com/veggiemonk/awesome-docker/blob/master/formerly DevLab by [@TechnologyAdvice](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/TechnologyAdvice))
...
- [Docker-sync](https://github.com/veggiemonk/awesome-docker/blob/master/http://docker-sync.io/) - Drastically improves performance (https://github.com/veggiemonk/awesome-docker/blob/master/[50-70x](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/EugenMayer/docker-sync/wiki/4.-Performance)) when using Docker for development on Mac OS X/Windows and Linux while sharing code to the container. By [@EugenMayer](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/EugenMayer)
- [docker-vm](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/shyiko/docker-vm) - Simple and transparent alternative to boot2docker (https://github.com/veggiemonk/awesome-docker/blob/master/backed by Vagrant) by [@shyiko](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/shyiko)
...
- [IronFunctions](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/iron-io/functions) - The serverless microservices platform FaaS (https://github.com/veggiemonk/awesome-docker/blob/master/Funcitons as a Service) which uses Docker containers to run Any language or AWS Lambda functions
...
- [SCAR](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/grycap/scar) - Serverless Container-aware Architectures (https://github.com/veggiemonk/awesome-docker/blob/master/SCAR) is a serverless framework that allows easy deployment and execution of containers (https://github.com/veggiemonk/awesome-docker/blob/master/e.g. Docker) in Serverless environments (https://github.com/veggiemonk/awesome-docker/blob/master/e.g. Lambda) by [@grycap](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/grycap)
...
## Services based on Docker (https://github.com/veggiemonk/awesome-docker/blob/master/:heavy_dollar_sign:)
...
- [Awesome Selfhosted](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/Kickball/awesome-selfhosted) list of Free Software network services and web applications which can be hosted locally by running in a classical way (https://github.com/veggiemonk/awesome-docker/blob/master/setup local web server and run applications from there) or in a Docker container. By [@Kickball](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/Kickball)
...
- [Docker Caveats](https://github.com/veggiemonk/awesome-docker/blob/master/http://docker-saigon.github.io/post/Docker-Caveats/) What You Should Know About Running Docker In Production (https://github.com/veggiemonk/awesome-docker/blob/master/written 11 APRIL 2016) **MUST SEE**
...
- [Installing, running, using Docker on armhf (https://github.com/veggiemonk/awesome-docker/blob/master/ARMv7) devices](https://github.com/veggiemonk/awesome-docker/blob/master/https://github.com/umiddelb/armhf/wiki/Installing,-running,-using-docker-on-armhf-%28ARMv7%29-devices)
...
- [Software Engineering Radio interview of Docker Security Team Lead (https://github.com/veggiemonk/awesome-docker/blob/master/Diogo Mónica)](https://github.com/veggiemonk/awesome-docker/blob/master/http://www.se-radio.net/2017/05/se-radio-episode-290-diogo-monica-on-docker-security/)
- [Tuning Docker with the newest security enhancements](https://opensource.com/business/15/3/docker-security-tuning)
- [Understanding Docker security and best practices](https://github.com/veggiemonk/awesome-docker/blob/master/https://blog.docker.com/2015/05/understanding-docker-security-and-best-practices/) (https://github.com/veggiemonk/awesome-docker/blob/master/written 5 MAY 2015)

## Videos

- [Contributing to Docker by Andrew "Tianon" Page (https://github.com/veggiemonk/awesome-docker/blob/master/InfoSiftr)](https://github.com/veggiemonk/awesome-docker/blob/master/https://www.youtube.com/watch?v=1jwo8-1HYYg) (https://github.com/veggiemonk/awesome-docker/blob/master/34:31)
- [Deploying and scaling applications with Docker, Swarm, and a tiny bit of Python magic](https://github.com/veggiemonk/awesome-docker/blob/master/https://www.youtube.com/watch?v=GpHMTR7P2Ms) (https://github.com/veggiemonk/awesome-docker/blob/master/3:11:06) by [@jpetazzo][jpetazzo]
- [Docker and SELinux by Daniel Walsh from Red Hat](https://github.com/veggiemonk/awesome-docker/blob/master/https://www.youtube.com/watch?v=zWGFqMuEHdw) (https://github.com/veggiemonk/awesome-docker/blob/master/40:23)
- [Docker for Developers](https://github.com/veggiemonk/awesome-docker/blob/master/https://www.youtube.com/watch?v=FdkNAjjO5yQ) (https://github.com/veggiemonk/awesome-docker/blob/master/54:26) by [@jpetazzo][jpetazzo] <== Good introduction, context, demo
- [Docker in Production](https://github.com/veggiemonk/awesome-docker/blob/master/https://www.youtube.com/watch?v=Glk5d5WP6MI) by [@jpetazzo][jpetazzo] (https://github.com/veggiemonk/awesome-docker/blob/master/36:05)
- [Docker: How to Use Your Own Private Registry](https://github.com/veggiemonk/awesome-docker/blob/master/https://www.youtube.com/watch?v=CAewZCBT4PI) (https://github.com/veggiemonk/awesome-docker/blob/master/15:01)
- [Extending Docker with Plugins](https://github.com/veggiemonk/awesome-docker/blob/master/https://vimeo.com/110835013) (https://github.com/veggiemonk/awesome-docker/blob/master/15:21)
...
- [Immutable Infrastructure with Docker and EC2 by Michael Bryzek (https://github.com/veggiemonk/awesome-docker/blob/master/Gilt)](https://github.com/veggiemonk/awesome-docker/blob/master/https://www.youtube.com/watch?v=GaHzdqFithc) (https://github.com/veggiemonk/awesome-docker/blob/master/42:04)
- [Introduction to Docker and containers](https://github.com/veggiemonk/awesome-docker/blob/master/https://www.youtube.com/watch?v=ZVaRK10HBjo) (https://github.com/veggiemonk/awesome-docker/blob/master/3:09:00) by [@jpetazzo][jpetazzo]
- [Logging on Docker: What You Need to Know](https://github.com/veggiemonk/awesome-docker/blob/master/https://vimeo.com/123341629) (https://github.com/veggiemonk/awesome-docker/blob/master/51:27)
- [Performance Analysis of Docker - Jeremy Eder](https://github.com/veggiemonk/awesome-docker/blob/master/https://www.youtube.com/watch?v=6f2E6PKYb0w) (https://github.com/veggiemonk/awesome-docker/blob/master/1:36:58)

...
- [Azure Container Registry :heavy_dollar_sign:](https://azure.microsoft.com/services/container-registry/) - Manage a Docker private registry as a first-class Azure resource

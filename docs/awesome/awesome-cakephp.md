...
## I18n
*Plugins for I18n (https://github.com/friendsofcake/awesome-cakephp/blob/master/Internationalization) and L10n (https://github.com/friendsofcake/awesome-cakephp/blob/master/Localization).*
...
## Demo
*Web-based (https://github.com/friendsofcake/awesome-cakephp/blob/master/demo) applications and tools.*

 ...
 * [5 (https://github.com/unicodeveloper/awesome-nextjs/blob/master/of the Many Reasons) to love Zeit's Next.js](https://github.com/unicodeveloper/awesome-nextjs/blob/master/https://www.codementor.io/tgreco/5-of-the-many-things-to-love-about-zeit-s-next-js-bpszu99g1)
...
* [next-starter](https://github.com/unicodeveloper/awesome-nextjs/blob/master/https://github.com/YuriBrunetto/next-starter) - A full and simple boilerplate with `sass (https://github.com/unicodeveloper/awesome-nextjs/blob/master/.scss)` and `postcss`built in.
...
* [Oh My Fullstack](https://github.com/unicodeveloper/awesome-nextjs/blob/master/https://github.com/oh-my-c0de/oh-my-fullstack) - Full stack web application skeleton (https://github.com/unicodeveloper/awesome-nextjs/blob/master/Next.js, Redux, RxJS, Immutable, Express)
...
## Books
* [Hands On Next.js](https://github.com/unicodeveloper/awesome-nextjs/blob/master/https://www.honext.io/) - A practical fullstack book on universal (https://github.com/unicodeveloper/awesome-nextjs/blob/master/server) rendering for react applications.

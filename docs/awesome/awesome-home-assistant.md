...
- [Carlo Costanzo](https://github.com/CCOSTAN/Home-AssistantConfig#logo) - Probably the most documented configuration out there (5,191★).
- [DubhAd](https://github.com/DubhAd/Home-AssistantConfig) - Also known as Tinkerer, shares his configuration files (688★).
- [geekofweek](https://github.com/geekofweek/homeassistant) - Has 300+ automations (1,474★).
- [Alok Saboo](https://github.com/arsaboo/homeassistant-config) - Also known as arsaboo. Regularly updated (1,956★).
- [Franck Nijhof](https://github.com/frenck/home-assistant-config) - Home Assistant OS based, very different configuration structure compared to others (2,001★).
...
- [LLM Vision](https://github.com/valentinfrlch/ha-llmvision) - Add visual intelligence to your automations: caption camera snapshots, summarize what is happening, react to specific events (1,339★).
- [AI Automation Suggester](https://github.com/ITSpecialist111/ai_automation_suggester) - Scan your entities and ask an AI provider (OpenAI, Anthropic, Google, Groq, Ollama) for tailored automation suggestions, surfaced as notifications (729★).

### 💡 Lighting

_Effects, schedules, and behaviour layers that sit on top of your lights._

- [Circadian Lighting](https://github.com/claytonjn/hass-circadian_lighting) - Slowly synchronizes your color-changing lights with the naturally occurring color temperature of the sky throughout the day (885★).
- [Adaptive Lighting](https://github.com/basnijholt/adaptive-lighting) - Slowly adjust the brightness and color temperature of your lights based on the position of the sun (3,300★).
- [Govee](https://github.com/LaggAt/hacs-govee) - Local control of Govee Wi-Fi lights and bulbs, including effects and color modes (350★).

### 🌡️ Climate

_Smarter thermostats, comfort sensors, and HVAC integrations that go beyond what comes built in._

- [Better Thermostat](https://github.com/KartoffelToby/better_thermostat) - Smarter thermostat with window detection, heating curves, and per-room comfort profiles for thermostatic radiator valves (1,397★).
- [Versatile Thermostat](https://github.com/jmcollin78/versatile_thermostat) - Full-featured thermostat with presets, window detection, motion-based comfort, and presence (1,051★).
- [Midea Air Appliances LAN](https://github.com/nbogojevic/homeassistant-midea-air-appliances-lan) - Local control of Midea air conditioners, dehumidifiers, and other appliances over LAN (454★).
- [Smart Autotune Thermostat (SAT)](https://github.com/Alexwijn/SAT) - Self-tuning thermostat that talks to OpenTherm, ESPHome, or MQTT gateways and adapts the heating curve to your home over time (244★).
- [Dual Smart Thermostat](https://github.com/swingerman/ha-dual-smart-thermostat) - Enhanced version of the built-in generic thermostat, with separate heating and cooling, floor temperature limits, and humidity controls (223★).

### ⚡ Energy & solar

_Pull your solar inverter, smart meter, home battery, or utility tariff into Home Assistant and feed the energy dashboard._

- [Powercalc](https://github.com/bramstroker/homeassistant-powercalc) - Calculate estimated power consumption of lights and other devices, even those that don't report it themselves (1,482★).
- [Anker Solix](https://github.com/thomluther/ha-anker-solix) - Pull Anker Solix balcony solar systems, batteries, and power stations into the energy dashboard with live state, history, and charging control (983★).
- [Octopus Energy](https://github.com/BottlecapDave/HomeAssistant-OctopusEnergy) - Pull Octopus Energy tariffs, smart meter readings, intelligent dispatch slots, and saving sessions into your dashboard (927★).
- [Huawei Solar](https://github.com/wlcrs/huawei_solar) - Read and control Huawei solar inverters and home batteries over Modbus, including grid charge windows (888★).
- [SolaX Modbus](https://github.com/wills106/homeassistant-solax-modbus) - Talk to SolaX, Solinteg, Sofar, Growatt, and other inverters over Modbus, including read-only and inverter control modes (486★).
- [Solarman](https://github.com/davidrapan/ha-solarman) - Read Deye, Sofar, and other Solarman-branded inverters via the Solarman stick logger (470★).
- [OCPP](https://github.com/lbbrhzn/ocpp) - Bring electric vehicle chargers that speak OCPP into the energy dashboard, with start, stop, and per-session metering (365★).
- [Solcast PV Forecast](https://github.com/BJReplay/ha-solcast-solar) - Pulls Solcast solar production forecasts so you can see expected generation for the day, with up-to-the-hour confidence bands (408★).
- [EPEX Spot](https://github.com/mampfes/ha_epex_spot) - Brings hourly EPEX spot electricity prices into your dashboard so you can shift loads to the cheapest slots (305★).
...
- [SolarEdge Modbus Multi](https://github.com/WillCodeForCats/solaredge-modbus-multi) - Reads SolarEdge inverters, meters, and batteries locally over Modbus/TCP, with multi-inverter and three-phase support (300★).
- [FoxESS Modbus](https://github.com/nathanmarlor/foxess_modbus) - Connects directly to FoxESS solar inverters over Modbus, no cloud round-trips, for real-time status and control (295★).
- [Victron GX](https://github.com/sfstar/hass-victron) - Reads data from a Victron GX device over Modbus/TCP, exposing inverters, batteries, solar chargers, and AC inputs (316★).
- [Solis Sensor](https://github.com/hultenvp/solis-sensor) - Talks to the SolisCloud PV monitoring portal so you can pull Solis inverter generation, battery, and grid data into the energy dashboard (317★).
- [GoodWe Inverter](https://github.com/mletenay/home-assistant-goodwe-inverter) - Pulls live data from GoodWe solar inverters over the local network for use in the energy dashboard (210★).
- [Solar Optimizer](https://github.com/jmcollin78/solar_optimizer) - Starts and stops your appliances based on solar surplus production so you self-consume rather than export (225★).
- [Dynamic Energy Cost](https://github.com/martinarva/dynamic_energy_cost) - Tracks real-time and cumulative energy cost against a dynamic price feed like Nord Pool or EPEX (188★).
- [Energi Data Service](https://github.com/MTrab/energidataservice) - Fetches Danish electricity spot prices from the Energi Data Service API for use in price-aware automations (272★).

### 📹 Cameras & video

_Pair specific camera brands and video sources that Home Assistant does not support out of the box._

- [HASS Aarlo](https://github.com/twrecked/hass-aarlo) - Asynchronous Arlo integration. Similar to the Arlo web site; monitors events and states for all base stations, cameras and doorbells (468★).
- [WebRTC Camera](https://github.com/AlexxIT/WebRTC) - View RTSP streams from IP Cameras in real-time through WebRTC or MSE with Pan/Zoom controls (2,119★).
- [Frigate](https://github.com/blakeblackshear/frigate-hass-integration) - Integrate the Frigate NVR with local object detection into your dashboard, alerts, and snapshots (1,166★).
- [Eufy Security](https://github.com/fuatakgun/eufy_security) - Manage Eufy Security cameras, doorbells, and base stations with live streams and event notifications (1,323★).
- [Tapo Control](https://github.com/JurajNyiri/HomeAssistant-Tapo-Control) - Control TP-Link Tapo cameras with PTZ, motion events, and a live RTSP stream (1,879★).
- [Dahua](https://github.com/rroller/dahua) - Pair Dahua cameras and doorbells with motion events, snapshots, sirens, and PTZ controls (538★).

### 🚨 Security & alarm

_Turn Home Assistant into a fully-featured alarm system with arm and disarm flows, user codes, zones, and panic._

- [Alarmo](https://github.com/nielsfaber/alarmo) - Easy-to-use alarm system with arm/disarm flows, user codes, zones, and panic mode (2,130★).
- [Keymaster](https://github.com/FutureTense/keymaster) - Manages user codes on Z-Wave smart locks, including per-user schedules, one-time codes, and notifications (330★).
...
- [Spotcast](https://github.com/fondberg/spotcast) - Start Spotify playback on an idle Chromecast device as well as control Spotify connect devices (808★).
- [Alexa Media Player](https://github.com/alandtse/alexa_media_player) - Control Amazon Alexa devices: announce, play media, and pull device state into your automations (1,942★).
- [YandexStation](https://github.com/AlexxIT/YandexStation) - Control Yandex Station speakers and other smart-home devices through Alice (1,851★).
- [Yandex Smart Home](https://github.com/dext0r/yandex_smart_home) - Expose your devices to Yandex Alice and the Yandex smart-home app (1,052★).
- [View Assist Companion](https://github.com/msp1974/ViewAssist_Companion_App) - Companion Android app and integration that turns a tablet into a hands-free voice and dashboard satellite (357★).

### 🚗 Cars & EV charging

_Track your car's battery, location, and charging state, or control where and when it plugs in._

- [Kia Uvo & Hyundai Bluelink](https://github.com/Hyundai-Kia-Connect/kia_uvo) - Track and control Kia Connect (Uvo) and Hyundai Bluelink cars across EU, Canada, and USA, including charging, climate, and lock state (856★).
- [Tesla](https://github.com/alandtse/tesla) - Track Tesla cars and Powerwalls with charging, climate, location, and security state, using a refresh token from a third-party login app (732★).
- [Volkswagen Carnet](https://github.com/robinostlund/homeassistant-volkswagencarnet) - Track charging state, climate preconditioning, and remote lock and honk for Volkswagen cars on the Carnet platform (518★).
- [Audi Connect](https://github.com/audiconnect/audi_connect_ha) - Tracks Audi cars over the Audi Connect API, including charging state, range, lock, and climate preconditioning (331★).
- [Polestar](https://github.com/pypolestar/polestar_api) - Reads Polestar EVs through the Polestar app API, with range, charging, and location data (244★).
- [Stellantis Vehicles](https://github.com/andreadegiovine/homeassistant-stellantis-vehicles) - Adds Stellantis cars (Peugeot, Citroen, Fiat, Opel, Vauxhall, DS) over the manufacturer API for range, lock, and climate (226★).
- [evcc](https://github.com/marq24/ha-evcc) - Connects to an evcc instance to surface charge sessions, solar matching, and per-loadpoint state (406★).
...
- [EV Smart Charging](https://github.com/jonasbkarlsson/ev_smart_charging) - Plans an electric vehicle charging schedule across the cheapest hours of a dynamic tariff, working with most chargers and price sensors (294★).

### 📍 Presence & location

_Figure out who is home and where they are, often more accurately than the built-in device tracker._

- [iCloud3](https://github.com/gcobb321/icloud3) - Improved version of the iCloud device tracker component with a lot of capabilities (840★).
- [iPhone Detect](https://github.com/mudape/iphonedetect) - Detect iPhones (and other phones) on the local Wi-Fi without an app, by sending a UDP probe and watching for the reply (619★).
- [Flightradar24](https://github.com/AlexandrErohin/home-assistant-flightradar24) - Track aircraft flying over a configurable bounding box around your home using Flightradar24 (436★).
- [Places](https://github.com/custom-components/places) - Reverse-geocodes a device tracker location through OpenStreetMap so automations can react to "at the supermarket" rather than raw coordinates (185★).

### 🧹 Vacuums

_Control specific robot vacuums and surface their map data, beyond what comes built in._

- [Xiaomi Cloud Map Extractor](https://github.com/PiotrMachowski/Home-Assistant-custom-components-Xiaomi-Cloud-Map-Extractor) - Presents a live view of a map for Xiaomi (Roborock/Viomi/Roidmi/Dreame) vacuums without a need for rooting (1,396★).
- [Dreame Vacuum](https://github.com/Tasshack/dreame-vacuum) - Dreame robot vacuums with full map support, including no-go zones and selective room cleaning (1,955★).

### 🔵 Bluetooth & BLE

_Pull data from sensors that broadcast over Bluetooth, or use Bluetooth itself for room-level presence detection._

- [BLE Monitor](https://github.com/custom-components/ble_monitor) - Passively read sensor data from Xiaomi MiBeacon, Govee, ATC, Inkbird, Qingping, and many other BLE sensors (2,205★).
- [Bermuda](https://github.com/agittins/bermuda) - Room-level presence detection by triangulating BLE signals across multiple ESPHome receivers (1,772★).
- [BLE Battery Management Systems](https://github.com/patman15/BMS_BLE-HA) - Reads Bluetooth Low Energy battery management systems (BMS) from many vendors, exposing per-cell voltages, balancing, and SOC (323★).
- [EcoFlow BLE](https://github.com/rabits/ha-ef-ble) - Pulls EcoFlow power stations and accessories over Bluetooth Low Energy, no cloud account required (294★).

### 🔋 Battery monitoring

_Keep an eye on the batteries in all your devices and get warned before they run flat._

- [Battery Notes](https://github.com/andrew-codechimp/HA-Battery-Notes) - Annotate every device with its battery type and quantity, then track replacements, low-battery warnings, and history (1,089★).
...
- [SmartIR](https://github.com/smartHomeHub/SmartIR) - Integrates devices using Broadlink IR (2,711★).
- [Sonoff LAN](https://github.com/AlexxIT/SonoffLAN) - Control Sonoff devices with eWeLink (original) firmware over LAN and/or Cloud (3,239★).
- [Xiaomi MIoT](https://github.com/al-one/hass-xiaomi-miot) - Auto-integrate Xiaomi smart-home devices over Wi-Fi, BLE, and Zigbee using the MIoT-spec protocol (5,873★).
- [Xiaomi Gateway 3](https://github.com/AlexxIT/XiaomiGateway3) - Local control of Xiaomi Multimode Gateway and Aqara Hub E1 over LAN, no cloud round-trips (2,751★).
- [Midea AC LAN](https://github.com/wuwentao/midea_ac_lan) - Local control of Midea air conditioners, heat pumps, and other M-Smart devices (1,628★).
- [SmartThinQ Sensors](https://github.com/ollo69/ha-smartthinq-sensors) - LG appliances (washers, dryers, AC, fridges) wired up via SmartThinQ with rich state and remote start (1,300★).
- [Home Connect Alt](https://github.com/ekutner/home-connect-hass) - Alternative Home Connect integration for Bosch, Siemens, NEFF, and Gaggenau ovens, dishwashers, and washing machines, with richer state than the official one (959★).
- [Tapo Devices](https://github.com/petretiandrea/home-assistant-tapo-p100) - TP-Link Tapo plugs, switches, bulbs, and energy monitoring (P100, P105, P110, L510, L530, L900) over LAN (946★).
...
- [HomeMatic IP Local](https://github.com/SukramJ/homematicip_local) - Local control of HomeMatic and HomeMatic IP devices through OpenCCU or RaspberryMatic, no cloud round-trips (569★).
- [Nest Protect](https://github.com/iMicknl/ha-nest-protect) - Track Nest Protect smoke and CO alarms with battery state, recent events, and per-room safety status (461★).
- [Meross LAN](https://github.com/krahabb/meross_lan) - Local control of Meross plugs, switches, lights, and garage door openers, falling back to cloud only when needed (710★).
- [LocalTuya](https://github.com/rospogrigio/localtuya) - Local control of Tuya devices over the LAN, no cloud round-trips, supporting plugs, lights, climate, and covers (3,830★).
- [SamsungTV Smart](https://github.com/ollo69/ha-samsungtv-smart) - Improved Samsung TV integration with SmartThings support, source switching, app launching, and per-app icons (644★).
- [Dyson](https://github.com/libdyson-wg/ha-dyson) - Wi-Fi connected Dyson fans, purifiers, and humidifiers, with full per-mode control over the local network (414★).
- [PetKit](https://github.com/RobertD502/home-assistant-petkit) - Adds PetKit feeders, fountains, and litter boxes over the manufacturer cloud, with full state and feeding controls (336★).
- [Miele](https://github.com/astrandb/miele) - Pairs Miele washing machines, dryers, dishwashers, ovens, and coffee machines, with detailed program state (268★).
...
- [The Watchman](https://github.com/dummylabs/thewatchman) - Keep track of missing entities and services in your config files (642★).
- [Browser Mod](https://github.com/thomasloven/hass-browser_mod) - Turn each browser into a controllable entity: pop up cards, navigate views, play sounds, or detect who is looking at the dashboard (1,734★).
- [Pyscript](https://github.com/custom-components/pyscript) - Write automations and templates in Python instead of YAML (1,153★).
- [Spook](https://github.com/frenck/spook) - A toolbox of helpful sensors, services, and templates that surface things the UI normally hides (1,125★).
...
- [Node-RED Companion](https://github.com/zachowj/hass-node-red) - Companion component for the node-red-contrib-home-assistant-websocket project that exposes services, sensors, and binary sensors back to your dashboards (570★).
- [Magic Areas](https://github.com/jseidl/magic-areas) - Auto-build per-room presence, climate, and media area entities, with motion-triggered scenes and bright/dark detection (481★).
- [Auto Backup](https://github.com/jcwillox/hass-auto-backup) - Automate backups with custom schedules, retention rules, encryption, and uploads to remote storage (459★).
- [Multiscrape](https://github.com/danieldotnl/ha-multiscrape) - Scrape multiple values (HTML, XML, or JSON) from a page in one request and turn them into sensors (430★).
...
- [Mail and Packages](https://github.com/moralmunky/Home-Assistant-Mail-And-Packages) - Sensors for incoming and delivered packages plus USPS Informed Delivery preview images, all from your existing email account (834★).
- [Irrigation Unlimited](https://github.com/rgc99/irrigation_unlimited) - Multi-zone irrigation controller with schedules, sequences, weather adjustments, and manual run support (430★).
...
- [Smart Irrigation](https://github.com/jeroenterheerdt/HAsmartirrigation) - Calculates how long to run each irrigation zone based on evapotranspiration, recent rainfall, and weather forecasts (499★).
- [UK Bin Collection](https://github.com/robbrad/UKBinCollectionData) - Council bin collection schedules across UK local authorities, exposed as next-pickup sensors per waste stream (321★).

### 🔐 Network & authentication

_Sign in to Home Assistant with single sign-on, route through a tunnel, or pull network hardware into your dashboard._

- [OIDC Auth](https://github.com/christiaangoossens/hass-oidc-auth) - Sign in with single sign-on through any OpenID Connect provider, including Authelia, Authentik, Keycloak, and Pocket ID (917★).
- [OpenID Connect Auth](https://github.com/cavefire/hass-openid) - Sign in through any OpenID Connect provider, including Authelia, Keycloak, and Authentik (200★).
- [TP-Link Router](https://github.com/AlexandrErohin/home-assistant-tplink-router) - Manages TP-Link and Mercusys routers with sensors, reboot button, switches, and per-client device tracking (342★).
- [Mikrotik Router](https://github.com/tomaae/homeassistant-mikrotik_router) - Pulls Mikrotik routers and access points into your dashboard, with per-client traffic, DHCP leases, and PoE controls (447★).

### 🔗 Federation & multi-instance

_Link multiple Home Assistant instances together, share entities across homes, or relay between them._

- [Remote Home Assistant](https://github.com/custom-components/remote_homeassistant) - Link multiple instances together so entities, services, and events flow between them (1,221★).
...
- [TrueNAS](https://github.com/tomaae/homeassistant-truenas) - Pull TrueNAS Scale and Core stats, datasets, virtual machines, and apps into sensors and switches (366★).
- [Monitor Docker](https://github.com/ualex73/monitor_docker) - Watch CPU, memory, network, and uptime for every Docker container on a host, including remote ones, and start or stop them from automations (400★).
- [Unraid](https://github.com/ruaan-deysel/ha-unraid) - Monitors and controls an Unraid NAS, including CPU, memory, disks, virtual machines, and Docker containers (236★).
...
- [Mushroom](https://github.com/piitaya/lovelace-mushroom) - A complete card collection with a soft, mobile-first aesthetic that you can drop into existing dashboards (4,986★).
- [Bubble Card](https://github.com/Clooos/Bubble-Card) - Minimalist card collection with a pop-up touch and rich customization (4,254★).
- [Floorplan](https://github.com/ExperienceLovelace/ha-floorplan) - Map entities onto an SVG of your house and animate them based on state changes (1,530★).
- [UI Lovelace Minimalist](https://github.com/UI-Lovelace-Minimalist/UI) - Drop-in dashboard collection with a uniform minimalist look across all your views, including ready-made cards and a button card library (2,027★).

### 📐 Layout helpers

_Cards that change where and how other cards appear: stack, fold, show conditionally, restyle, or template._

- [Auto-Entities Card](https://github.com/thomasloven/lovelace-auto-entities) - Dynamically adds entities: 🔮 Magic (1,753★).
- [Card Modder](https://github.com/thomasloven/lovelace-card-mod) - Style your Lovelace cards (1,700★).
...
- [Button card](https://github.com/custom-cards/button-card) - Highly customizable button for your entities (2,443★).
...
- [Layout Card](https://github.com/thomasloven/lovelace-layout-card) - Get fine-grained control over how cards are placed on your dashboard, including masonry-style and grid layouts (1,242★).
...
- [State Switch](https://github.com/thomasloven/lovelace-state-switch) - Dynamically swap one card for another based on the state of an entity, the time of day, or the user viewing (459★).
- [Swipe Navigation](https://github.com/zanna-37/hass-swipe-navigation) - Switch between dashboard views with a swipe gesture on mobile (535★).
- [Custom Card Features](https://github.com/Nerwyn/custom-card-features) - Adds buttons, dropdowns, sliders, spinboxes, selectors, and toggles you can attach to tile cards to call any service (421★).
- [Custom Sidebar](https://github.com/elchininet/custom-sidebar) - Personalise the sidebar per user or device, hide pages, reorder them, or restyle the look (274★).
...
- [Streamline Card](https://github.com/brunosabot/streamline-card) - Define a card template once and reuse it across the dashboard with different entities, no copy-paste YAML (256★).

### 📈 Charts & graphs

_Visualise sensor data over time. Gauges, line graphs, bars, and Sankey diagrams._

- [Mini Graph Card](https://github.com/kalkih/mini-graph-card) - A minimalistic sensor graph card (3,818★).
...
- [ApexCharts Card](https://github.com/RomRider/apexcharts-card) - Advanced graphs and charts powered by ApexChartsJS with timelines, multi-axis, and event markers (1,781★).
- [Sankey Chart](https://github.com/MindFreeze/ha-sankey-chart) - Sankey-style flow diagram for visualising power, water, or any other flow across your home (655★).
...
- [Flex Table Card](https://github.com/custom-cards/flex-table-card) - Highly flexible table card with arbitrary columns, regex-matched entities, and per-row styling, useful for AppDaemon and templated content (267★).

### 📋 Status & info rows

_Compact rows that pack more information into entity-card style listings._

- [Slider Entity Row](https://github.com/thomasloven/lovelace-slider-entity-row) - Add a slider to adjust, e.g., the brightness of lights in lovelace entity cards (909★).
- [Battery State Card](https://github.com/maxwroc/battery-state-card) - List devices with their battery levels in a tidy card, sorted and color-coded (1,236★).
- [Scheduler Card](https://github.com/nielsfaber/scheduler-card) - Build and edit weekly schedules for any entity right from the dashboard (1,224★).
- [Entity Progress Card](https://github.com/francois-le-ko4la/lovelace-entity-progress-card) - Progress-bar card for any numeric entity, with thresholds, gradients, and templated icons (254★).
- [Vehicle Status Card](https://github.com/ngocjohn/vehicle-status-card) - Dashboard card showing fuel or charge level, range, doors, lock state, and a customizable image of the car (252★).
- [Timer Bar Card](https://github.com/rianadon/timer-bar-card) - Progress-bar card for any timer entity, with countdown, formatted remaining time, and configurable colors (575★).

### ☀️ Weather cards

_Weather widgets with the look you actually want._

- [Weather Chart Card](https://github.com/mlamberts78/weather-chart-card) - Weather card with a chart-style hourly forecast and customizable layout (436★).
- [Hourly Weather](https://github.com/decompil3d/lovelace-hourly-weather) - Show today's hourly forecast as a colored horizontal bar so you can see at a glance when conditions change (389★).
- [Weather Radar](https://github.com/Makin-Things/weather-radar-card) - Animated rain radar card using the public RainViewer tile service, with country-level and regional zoom (368★).
- [Clock Weather Card](https://github.com/pkissling/clock-weather-card) - Combined date, time, and weather forecast card with an iOS-inspired layout for the days ahead (829★).
- [Horizon Card](https://github.com/rejuvenate/lovelace-horizon-card) - Visualises the position of the Sun over the horizon throughout the day, with sunrise, sunset, and twilight markers (646★).
...
- [Mini Climate](https://github.com/artem-sedykh/mini-climate-card) - Compact climate card with current temperature, target, and per-mode controls, sized for small dashboards and mobile (319★).

### ⚡ Energy cards

_Visualise solar production, grid imports, battery state, and consumption flow._

- [Sunsynk Power Flow](https://github.com/slipx06/sunsynk-power-flow-card) - Visualise the live energy flow of Sunsynk and Deye inverters, mirroring the layout of the inverter screen (375★).

### 💡 Lighting cards

_Specialised controls for lights, color temperature, and effects._

- [RGB Light Card](https://github.com/bokub/rgb-light-card) - Colorful buttons to control your RGB Lights (559★).
- [Hue-Like Light Card](https://github.com/Gh61/lovelace-hue-like-light-card) - Light card styled and laid out like the Philips Hue app, with grouped scenes and per-bulb control (366★).
...
- [Advanced Camera Card](https://github.com/dermotduffy/advanced-camera-card) - Comprehensive camera card with timelines, galleries, snapshots, clips, and per-event playback (1,055★).

### 🧹 Vacuum cards

_Show vacuum status, room maps, and start/stop controls in your dashboard._

- [Vacuum Map Card](https://github.com/PiotrMachowski/lovelace-xiaomi-vacuum-map-card) - This card provides a user-friendly way to fully control Xiaomi (Roborock/Viomi/Dreame/Roidmi) and Neato (+ possibly other) vacuums (1,868★).
- [Vacuum Card](https://github.com/denysdovhan/vacuum-card) - A card for controlling a robot vacuum (1,202★).
- [Valetudo Map](https://github.com/Hypfer/lovelace-valetudo-map-card) - Display the live map from a robot vacuum running Valetudo (cloudless firmware) directly on a dashboard (303★).

### 📅 Calendar & feed

_Calendar views and rolling feeds of upcoming events._

- [Atomic Calendar Revive](https://github.com/totaldebug/atomic-calendar-revive) - Calendar card with advanced settings (621★).
- [Week Planner Card](https://github.com/FamousWolf/week-planner-card) - Responsive multi-day overview of upcoming events, alarms, and reminders (508★).
- [Trash Card](https://github.com/idaho/hassio-trash-card) - Show the next trash pickup type (paper, plastic, organic) based on a calendar entity, with color-coded icons (354★).
- [Calendar Card Pro](https://github.com/alexpfau/calendar-card-pro) - Customizable calendar card with event grouping, location indicators, and a clean modern look (1,107★).
...
- [HA Firemote](https://github.com/PRProd/HA-Firemote) - Virtual remote for Apple TV, Fire TV, Chromecast, Homatics, Shield, onn., Roku, Xiaomi, and more (971★).
- [Universal Remote Card](https://github.com/Nerwyn/universal-remote-card) - Fully customizable virtual remote for any media device, supporting custom buttons and haptics (555★).
...
- [Wall Panel](https://github.com/j-a-n/lovelace-wallpanel) - Wall-panel mode and photo-screensaver for tablets mounted on the wall (835★).
- [Kiosk Mode](https://github.com/NemesisRE/kiosk-mode) - Hide the header, sidebar, and overflow menu for a clean kiosk-style view (722★).

## Dashboards

_Frameworks that replace or extend the default Home Assistant dashboard with a different look and feel._

- [Dwains Dashboard](https://github.com/dwainscheeren/dwains-lovelace-dashboard) - A fully auto-generating dashboard for desktop, tablet and mobile (2,043★).
- [Mushroom Strategy](https://github.com/DigiLive/mushroom-strategy) - A strategy that automatically generates a dashboard using Mushroom cards (643★).
...
- [Synthwave](https://github.com/bbbenji/synthwave-hass) - A theme influenced by the cover artwork of modern Synthwave bands (198★).
- [Frosted Glass](https://github.com/wessamlauf/homeassistant-frosted-glass-themes) - Modern frosted-glass dark and light themes with translucent cards (885★).
- [iOS Themes](https://github.com/basnijholt/lovelace-ios-themes) - Themes inspired by iOS dark and light modes (864★).
- [LCARS](https://github.com/th3jesta/ha-lcars) - Star Trek LCARS-inspired theme for the bridge feel (529★).
- [Material You](https://github.com/Nerwyn/material-you-theme) - Material Design 3 theme that adapts to your accent color (447★).
- [Graphite](https://github.com/TilmanGriesel/graphite) - Calm and clean theme with a focused, low-contrast feel (436★).
- [Catppuccin](https://github.com/catppuccin/home-assistant) - Soothing pastel theme matching the popular Catppuccin palette across editors and apps (416★).
...
- [visionOS](https://github.com/Nezz/homeassistant-visionos-theme) - Theme inspired by Apple's visionOS (306★).
- [Nordic](https://github.com/coltondick/nordic-theme-main) - Light and dark themes in a Nordic palette, with several blue-tinted variants (42★).
...
- [SSH & Web Terminal](https://github.com/hassio-addons/app-ssh) - SSH and Web-based terminal with tons of pre-loaded useful tools (495★).
- [UniFi Controller](https://github.com/hassio-addons/app-unifi) - The UniFi Controller allows you to manage your UniFi network using a web browser (369★).
- [Node-RED](https://github.com/hassio-addons/app-node-red) - Flow-based programming for the Internet of Things (637★).
- [Plex Media Server](https://github.com/hassio-addons/app-plex) - Your recorded media beautifully organized and ready to stream (188★).
- [InfluxDB](https://github.com/hassio-addons/addon-influxdb) - Scalable datastore for metrics, events, and real-time analytics (196★).
- [Grafana](https://github.com/hassio-addons/addon-grafana) - Open platform for beautiful analytics and monitoring (278★).
- [Tor](https://github.com/hassio-addons/app-tor) - Protect your privacy and access your instance via Tor (62★).
- [Spotify Connect](https://github.com/hassio-addons/app-spotify-connect) - Stream music from Spotify directly to your Home Assistant device (251★).
- [zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt) - Zigbee to MQTT bridge, get rid of your proprietary Zigbee bridges (15,151★).
- [AppDaemon](https://github.com/AppDaemon/appdaemon) - A loosely coupled, multi-threaded, sandboxed Python execution environment for writing automation apps (957★).
- [TasmoAdmin](https://github.com/hassio-addons/addon-tasmoadmin) - Centrally manage all your Sonoff-Tasmota devices (255★).
- [Aircast](https://github.com/hassio-addons/app-aircast) - AirPlay capabilities for your Chromecast players (396★).
...
- [Glances](https://github.com/hassio-addons/app-glances) - A cross-platform system monitoring tool written in Python (185★).
- [AdGuard Home](https://github.com/hassio-addons/app-adguard-home) - A network-wide ad-and-tracker blocking DNS server with parental control (518★).
- [Traccar](https://github.com/hassio-addons/addon-traccar) - Modern GPS tracking platform (158★).
- [Hass.io Google Drive Backup](https://github.com/sabeechen/hassio-google-drive-backup) - A complete and easy-to-configure solution for backing up to Google Drive (3,544★).
- [Grocy](https://github.com/hassio-addons/app-grocy) - ERP beyond your fridge! A groceries & household management solution for your home (430★).
- [CrowdSec](https://github.com/crowdsecurity/home-assistant-addons) - A next-gen collaborative IPS/IDS to protect you from intrusion (95★).
...
- [Tasmota](https://github.com/arendst/Tasmota) - Firmware for ESP8266 boards and devices (24,414★).
- [Sonoff NSPanel](https://github.com/joBr99/nspanel-lovelace-ui) - Custom firmware for Sonoff NSPanel touchscreens with a Lovelace-style UI (987★).
...
- [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) - A flexible MQTT gateway for IR, RF, BLE, MiFlora, SMS, and many sensors (4,013★).
- [esp8266 Milight Hub](https://github.com/sidoh/esp8266_milight_hub) - Alternative hub for Milight/LimitlessLED devices that uses MQTT (1,031★).
...
- [HA-Dockermon](https://github.com/philhawthorne/ha-dockermon) - A Node.js service for RESTful switches to control Docker containers (290★).
...
- [Home Assistant](https://www.youtube.com/channel/UCbX3YkedQunLt7EQAdVxh7w) - Official channel for new launches and live streams (73.3K subs).
- [The Hook Up](https://www.youtube.com/channel/UC2gyzKcHbYfqoXA5xbyGXtQ) - Smart-home tutorials, gadget reviews, and home-automation experiments by Robert Tait (575K subs).
...
- [Smart Home Junkie](https://www.youtube.com/@smarthomejunkie) - How-to videos and tutorials for starters and advanced users by Ed de Tollenaer (85.2K subs).
- [digiblurDIY](https://www.youtube.com/channel/UC5ZdPKE2ckcBhljTc2R_qNA) - Hardware project tutorials and Tasmota automations (74K subs).
...
- [This Smart House](https://www.youtube.com/@thissmarthouse) - Beginner-friendly setup walkthroughs and product reviews by Ryan Holland (33.6K subs).
...
- [Michael Leen](https://www.youtube.com/@michaelsleen) - Smart-home tutorials and integration walkthroughs (26.5K subs).
...
- [Smart Home Australia](https://www.youtube.com/@smart_home_australia) - Australia-flavored smart-home reviews and tutorials by Paul Toner (20.5K subs).
- [CTech&Media](https://www.youtube.com/@CTechMedia) - Smart-home reviews and tutorials by Charly Schulte (17.8K subs).
...
- 🇸🇦 [Smart Tech Arabic](https://www.youtube.com/@SmartTechArabic) - Tutorials in Arabic by Shady Nafie (98.3K subs).
- 🇧🇷 [Descomplicando Tech](https://www.youtube.com/@DescomplicandoTech) - Smart-home guides by Fabricio Goncalves (15.8K subs).
- 🇫🇷 [AyLabs](https://www.youtube.com/@ay_labs) - Tutorials, integrations, and automation walkthroughs by Aymeric Le Feyer (11.9K subs).
- 🇩🇪 [simon42](https://www.youtube.com/@simon42) - Tutorials, automations, and dashboard guides by Simon Müller (194K subs).
...
- 🇩🇪 [SmartHome yourself](https://www.youtube.com/@Smarthomeyourself) - DIY smart-home builds and guides by Daniel Scheidler (34.7K subs).
...
- 🇮🇹 [DinamoTech](https://www.youtube.com/@DinamoTech) - Smart-home tutorials and reviews by Francesco Cova (77.5K subs).
- 🇮🇹 [Ipensieridellarchitetto](https://www.youtube.com/@ipensieridellarchitetto) - Domotics, technology, and AI walkthroughs (14.8K subs).
- 🇪🇸 [Home Assistant y Domótica Fácil](https://www.youtube.com/@HomeAssistantFacil) - Smart-home tutorials and automations by Luis del Valle (135K subs).
- 🇪🇸 [Tecnoyfoto](https://www.youtube.com/@Tecnoyfoto) - Tutorials and product reviews by Albert Barnosell (44.9K subs).
...
- [Domoticz](https://github.com/domoticz/domoticz) - A lightweight Home Automation System (3,757★).
- [Gladys](https://github.com/GladysAssistant/Gladys) - Open source program which runs on your Raspberry Pi (3,062★).
...
- [Homebridge](https://github.com/homebridge/homebridge) - Lightweight Node.js server that bridges non-HomeKit devices into Apple Home, with a large plugin ecosystem (25,351★).
- [Node-RED](https://github.com/node-red/node-red) - Flow-based visual programming tool for wiring together devices, APIs, and services, backed by the OpenJS Foundation (23,162★).
- [ioBroker](https://github.com/ioBroker/ioBroker) - Integration platform for IoT with hundreds of adapters and strong European protocol support for KNX and HomeMatic (1,367★).
...
- [awesome-iot](https://github.com/HQarroum/awesome-iot) - Curated list of awesome Internet of Things projects and resources (3,936★).
- [awesome-mqtt](https://github.com/awesome-mqtt/awesome-mqtt#readme) - Curated list of MQTT related stuff (2,336★).
- [awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) - Curated list of awesome self hosted software (294,442★).
...
See [https://github.com/frenck/awesome-home-assistant/blob/master/LICENSE.md](https://github.com/frenck/awesome-home-assistant/blob/master/LICENSE.md) for the full text.
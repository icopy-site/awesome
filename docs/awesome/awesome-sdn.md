...
- [beluganos](https://github.com/sdnds-tw/awesome-sdn/blob/master/https://github.com/beluganos/beluganos) - Beluganos is a new network OS designed for white-box switches (https://github.com/sdnds-tw/awesome-sdn/blob/master/OF-DPA), which can apply large-scale networks.
...
- [Ravel](https://github.com/sdnds-tw/awesome-sdn/blob/master/https://github.com/ravel-net/ravel) - A software-defined networking (https://github.com/sdnds-tw/awesome-sdn/blob/master/SDN) controller that uses a standard SQL database to represent the network.
...
- [SDN网络指南](https://github.com/sdnds-tw/awesome-sdn/blob/master/https://feisky.gitbooks.io/sdn/)(https://github.com/sdnds-tw/awesome-sdn/blob/master/OpenSource Book in Chinese by Pengfei Ni)

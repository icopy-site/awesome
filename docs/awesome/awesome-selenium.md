...
- [Karma](https://github.com/christian-bromann/awesome-selenium/blob/master/http://karma-runner.github.io/0.12/index.html) - Brings a productive testing environment to developers for unit testing (https://github.com/christian-bromann/awesome-selenium/blob/master/mostly AngularJS).
...
- [Serenity](https://github.com/christian-bromann/awesome-selenium/blob/master/http://www.thucydides.info/) - It is an open source library for writing better quality automated acceptance tests faster. (https://github.com/christian-bromann/awesome-selenium/blob/master/Formerly Thucydides).
- [seleniumQuery](https://github.com/christian-bromann/awesome-selenium/blob/master/https://github.com/seleniumQuery/seleniumQuery) - jQuery-like cross-driver interface in Java for WebDriver. Designed as a thin layer, it can be used alone or on top of your favorite framework just to make some cases (https://github.com/christian-bromann/awesome-selenium/blob/master/e.g. asserting/waiting) simpler when needed.
...
- [Strontium](https://github.com/christian-bromann/awesome-selenium/blob/master/https://github.com/jimevans/strontium) - A .NET implementation (https://github.com/christian-bromann/awesome-selenium/blob/master/but outdated) for Selenium/WebDriver (https://github.com/christian-bromann/awesome-selenium/blob/master/Remote) Server
...
- [WebdriverCSS](https://github.com/christian-bromann/awesome-selenium/blob/master/https://github.com/webdriverio/webdrivercss) - Regression testing tool for [WebdriverIO](https://github.com/christian-bromann/awesome-selenium/blob/master/http://webdriver.io) (https://github.com/christian-bromann/awesome-selenium/blob/master/currently deprecated, please use [wdio-screenshot](https://github.com/christian-bromann/awesome-selenium/blob/master/https://www.npmjs.com/package/wdio-screenshot) for the time being).
...
- [bravostudiodev/bravo-grid](https://github.com/christian-bromann/awesome-selenium/blob/master/https://github.com/bravostudiodev/bravo-grid) - Docker image/setup for Selenium Grid Extras (https://github.com/christian-bromann/awesome-selenium/blob/master/see under Selenium Grid section), for providing remote Sikuli test/automation execution and grid node file upload/download support.
...
#### Desktop (https://github.com/christian-bromann/awesome-selenium/blob/master/browsers)

- [Firefox](https://github.com/christian-bromann/awesome-selenium/blob/master/https://github.com/SeleniumHQ/selenium/wiki/FirefoxDriver) - Firefox driver (https://github.com/christian-bromann/awesome-selenium/blob/master/for FF < v48) is included in the selenium-server-standalone.jar available in the downloads.
- [Geckodriver](https://github.com/christian-bromann/awesome-selenium/blob/master/https://github.com/mozilla/geckodriver) - Firefox driver (https://github.com/christian-bromann/awesome-selenium/blob/master/for FF > v48), supported with Selenium >= v3
...
- [Safari](https://github.com/christian-bromann/awesome-selenium/blob/master/https://github.com/SeleniumHQ/selenium/wiki/SafariDriver) - The SafariDriver is implemented as a Safari browser extension. The driver inverts the traditional client/server relationship and communicates with the WebDriver client using WebSockets (https://github.com/christian-bromann/awesome-selenium/blob/master/only supported for Safari <= v9, all new Safari version comming with macOS Sierra come with an integrated SafariDriver that is closed source by Apple).
...
#### Mobile (https://github.com/christian-bromann/awesome-selenium/blob/master/browsers and apps)
...
#### Desktop GUI Automation (https://github.com/christian-bromann/awesome-selenium/blob/master/non-browser-centric)
...
- [Winium](https://github.com/christian-bromann/awesome-selenium/blob/master/https://github.com/2gis/Winium) - Automation framework for Windows platforms. It is free. It is opensource. It is Selenium-based. Supports: Windows Desktop (https://github.com/christian-bromann/awesome-selenium/blob/master/WPF, WinForms); Windows Store or Universal Apps for Windows Phone; Windows Phone Silverlight Apps.
- [QtWebDriver](https://github.com/cisco-open-source/qtwebdriver) - For using WebDriver to automate Qt-based GUI applications.
- [AutoItDriverServer](https://github.com/christian-bromann/awesome-selenium/blob/master/https://github.com/daluu/AutoItDriverServer) - Selenium server to control/drive AutoIt via (https://github.com/christian-bromann/awesome-selenium/blob/master/Remote)WebDriver API.
- [AutoPyDriverServer](https://github.com/christian-bromann/awesome-selenium/blob/master/https://github.com/daluu/AutoPyDriverServer) - Selenium server to control/drive AutoPy via (https://github.com/christian-bromann/awesome-selenium/blob/master/Remote)WebDriver API.
- [Appium for Mac](https://appium.io/docs/en/drivers/mac/) - Appium/WebDriver implementation for automating Mac OS X desktop.
- [SilkAppDriver](https://github.com/christian-bromann/awesome-selenium/blob/master/https://github.com/MicroFocus/SilkAppDriver) - Selenium server to control/drive the commercial SilkTest platform via (https://github.com/christian-bromann/awesome-selenium/blob/master/Remote)WebDriver API.
...
- [SeLion](https://github.com/christian-bromann/awesome-selenium/blob/master/https://github.com/paypal/SeLion) - A (https://github.com/christian-bromann/awesome-selenium/blob/master/Java) framework for running Selenium tests with additional features beyond the basic Selenium Grid functionality, particularly like stability improvements, etc.
...
- [Scrapy](https://github.com/christian-bromann/awesome-selenium/blob/master/http://scrapy.org) - **Python**, mainly a scraper/miner - fast, well documented and, can be linked with [Django Dynamic Scraper](https://github.com/christian-bromann/awesome-selenium/blob/master/http://django-dynamic-scraper.readthedocs.org/en/latest/) for nice mining deployments, or [Scrapy Cloud](https://github.com/christian-bromann/awesome-selenium/blob/master/http://scrapinghub.com/scrapy-cloud.html) for PaaS (https://github.com/christian-bromann/awesome-selenium/blob/master/server-less) deployment, works in terminal or an server stand-alone proces, can be used with **Celery**, built on top of **Twisted**.
...
To the extent possible under law, [Christian Bromann](http://www.christian-bromann.com/) has waived all copyright and related or neighboring rights to this work.ain/zero/1.0/)

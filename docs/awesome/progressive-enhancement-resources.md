...
* [Writing polyfills](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/https://addyosmani.com/blog/writing-polyfills/) - If your baseline is still too high for some browsers, consider [polyfills](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/https://remysharp.com/2010/10/08/what-is-a-polyfill) (https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/aka [Regressive Enhancement](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/https://twitter.com/SlexAxton/status/25600963629)).
...
* [CSS feature queries](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/https://www.sitepoint.com/an-introduction-to-css-supports-rule-feature-queries/) (https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/[`CSS.supports(https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/)`](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/https://developer.mozilla.org/en/docs/Web/API/CSS/supports) & [`@supports(https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/)`](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/https://developer.mozilla.org/en-US/docs/Web/CSS/@supports)) - Natively test if specific CSS feature is supported using JS method or CSS declaration.
...
* [Modernizr](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/https://modernizr.com/) - Extensive feature detection suite (https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/supports custom builds).
...
* [Font Family Reunion](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/http://fontfamily.io/) - Compatibility tables for default local (https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/system) fonts.
...
* [Webkit Platform Status](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/https://webkit.org/status/) (https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/Safari)
...
* [Lighthouse](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/https://github.com/GoogleChrome/lighthouse) - Audit and meassure performance of Progressive Web Apps (https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/via cli or [Chrome extension](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/https://chrome.google.com/webstore/detail/lighthouse/blipmdconlkpinefehnmjammfjpmpbjk)).
* [Progressive Enhancement checklist (https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/1st edition, HTML)](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/http://adaptivewebdesign.info/1st-edition/read/chapter-6.html#the-progressive-enhancement-checklist), [Checklist of 2nd edition (https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/PDF)](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/http://adaptivewebdesign.info/2nd-edition/checklist.pdf) - Actionable list to check you've applied Progressive Enhancement best practices. Part of [Adaptive Web Design book](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/http://adaptivewebdesign.info/).
...
* [Timeline](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/https://css-tricks.com/progressive-enhancement-data-visualizations/) - From definition list to SVG illustration (https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/article with demos).
* [Charts](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/https://www.filamentgroup.com/lab/update-to-jquery-visualize-accessible-charts-with-html5-from-designing-with.html) - From data table to themed charts using HTML5 canvas (https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/article and library).
...
* [Lazy Progressive Enhancement](https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/https://github.com/tvler/lazy-progressive-enhancement) - Lazy load images inside `<noscript>` tags. (https://github.com/jbmoelker/progressive-enhancement-resources/blob/master/note: Evergreen browsers only)

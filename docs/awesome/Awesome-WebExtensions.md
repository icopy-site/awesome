...
- [Chrome Webstore Upload](https://github.com/bfred-it/Awesome-WebExtensions/blob/master/https://github.com/DrewML/chrome-webstore-upload-cli) - Upload the extension to the Chrome Web Store via cli (https://github.com/bfred-it/Awesome-WebExtensions/blob/master/or on Travis, automatically).
...
- [unzip-crx](https://github.com/bfred-it/Awesome-WebExtensions/blob/master/https://github.com/peerigon/unzip-crx) - Unzips Google Chrome (https://github.com/bfred-it/Awesome-WebExtensions/blob/master/crx) files.

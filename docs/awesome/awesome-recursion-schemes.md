...
- [Recursion Schemes: A Field Guide (https://github.com/passy/awesome-recursion-schemes/blob/master/Redux)](https://github.com/passy/awesome-recursion-schemes/blob/master/http://comonad.com/reader/2009/recursion-schemes/) -
...
- [Correcting the Visitor pattern](https://github.com/passy/awesome-recursion-schemes/blob/master/http://logji.blogspot.co.uk/2012/02/correcting-visitor-pattern.html) - Showing that the Visitor pattern implements an f-algebra for use with a catamorphism (https://github.com/passy/awesome-recursion-schemes/blob/master/in Java).

...
- [Official Manual](https://github.com/felipebueno/awesome-PICO-8/blob/master/https://www.lexaloffle.com/pico-8.php?page=manual) - Placeholder dump of pico-8.txt! (https://github.com/felipebueno/awesome-PICO-8/blob/master/Proper manual coming soon).
...
- [Cheat Sheet (https://github.com/felipebueno/awesome-PICO-8/blob/master/printable)](https://github.com/felipebueno/awesome-PICO-8/blob/master/https://ztiromoritz.github.io/pico-8-spick/) - A reduced cheat sheet in a printable format. German and Englisch version available.
- [Cheat Sheet (https://github.com/felipebueno/awesome-PICO-8/blob/master/wallpaper)](https://github.com/felipebueno/awesome-PICO-8/blob/master/https://www.lexaloffle.com/bbs/?tid=28207) - An enhancement of the printable cheat sheet for use as a desktop wallpaper.
...
- [Tweetjam, BBS thread](https://github.com/felipebueno/awesome-PICO-8/blob/master/https://www.lexaloffle.com/bbs/?tid=3726) - cards which code fits in a tweet (https://github.com/felipebueno/awesome-PICO-8/blob/master/really useful to learn some fun techniques).
...
- [p8dl - Carts Downloader - Python](https://github.com/felipebueno/awesome-PICO-8/blob/master/https://github.com/franciscod/p8dl) - Downloads cartridges into the correct folder (https://github.com/felipebueno/awesome-PICO-8/blob/master/looks at your config.txt).
- [Pico-8 Carts Downloader - Bash ](https://github.com/felipebueno/awesome-PICO-8/blob/master/https://github.com/kikookoubis/pico-8-carts-bash-downloader) - Downloads cartridge from the BBS (https://github.com/felipebueno/awesome-PICO-8/blob/master/single cart, whole index or dump your favourited entries) & rename them according to their metadata.
...
- [P8Coder](https://github.com/felipebueno/awesome-PICO-8/blob/master/https://github.com/movAX13h/P8Coder) - A programming tool that replaces the lua code in pico-8 cartridges (https://github.com/felipebueno/awesome-PICO-8/blob/master/p8) with the code you write in P8Coder.
...
- [picoDeploy](https://github.com/felipebueno/awesome-PICO-8/blob/master/https://github.com/torch2424/picoDeploy) - Deploy Pico-8 carts as standalone applications on desktop (https://github.com/felipebueno/awesome-PICO-8/blob/master/Electron) and mobile (https://github.com/felipebueno/awesome-PICO-8/blob/master/Ionic).
...
- [p8](https://github.com/felipebueno/awesome-PICO-8/blob/master/https://github.com/jozanza/p8) - A dependency manager and build tool. Lets you share code/sprites, `require(https://github.com/felipebueno/awesome-PICO-8/blob/master/)` dependencies, and auto-reload carts on save. Works with any external code editor and supports [MoonScript](https://github.com/felipebueno/awesome-PICO-8/blob/master/https://moonscript.org/).
...
- Sublime: [Sublime PICO-8](https://github.com/felipebueno/awesome-PICO-8/blob/master/https://packagecontrol.io/packages/PICO-8) - PICO-8 plugin for the Sublime Text editor (https://github.com/felipebueno/awesome-PICO-8/blob/master/color scheme, font, build system, code completion, snippets...).
- Vim: [vim-pico8-syntax](https://github.com/justinj/vim-pico8-syntax)

### Programming Fonts

You might be interested to install [pico-8 programming fonts](https://github.com/felipebueno/awesome-PICO-8/blob/master/https://github.com/juanitogan/p8-programming-fonts) they support the pico-8 custom characters as well as various fonts (https://github.com/felipebueno/awesome-PICO-8/blob/master/bitmap and regular anti-aliased fonts). Check the [BBS thread here](https://github.com/felipebueno/awesome-PICO-8/blob/master/https://www.lexaloffle.com/bbs/?tid=28975).
...
- [Mouse](https://github.com/felipebueno/awesome-PICO-8/blob/master/https://www.lexaloffle.com/bbs/?tid=3549) - How to retrieve mouse coordinates (https://github.com/felipebueno/awesome-PICO-8/blob/master/with demo).
...
- [SFX Modifications](https://github.com/felipebueno/awesome-PICO-8/blob/master/https://www.lexaloffle.com/bbs/?tid=3561) - Four effects that can only be applied by modifying memory (https://github.com/felipebueno/awesome-PICO-8/blob/master/with demo).
...
- [PX8](https://github.com/felipebueno/awesome-PICO-8/blob/master/https://github.com/Gigoteur/PX8) - Open Source Fantasy Console (https://github.com/felipebueno/awesome-PICO-8/blob/master/128x128 pixels) in Rust (https://github.com/felipebueno/awesome-PICO-8/blob/master/with Python/LUA code support).
